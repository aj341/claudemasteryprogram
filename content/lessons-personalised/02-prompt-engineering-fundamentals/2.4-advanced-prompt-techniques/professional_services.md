...
This technique earns its place on complex, multi-variable tasks. Think: deciding which subcontractor to use on a client engagement based on rate, availability, and prior delivery quality. Reviewing a contract clause that has several possible interpretations. Evaluating whether to take on a client based on budget, scope, and fit. These are tasks where the answer is not obvious, where several factors pull in different directions, and where you want to see the working — not just the output.
...
```
I'm deciding between two associate consultants to bring in on a six-month engagement. Here are the key facts:

Associate A: $180/hour, 48-hour turnaround on drafts, 3 years independent, two prior engagements with not-for-profit clients.
Associate B: $210/hour, same-day turnaround on drafts, 8 years independent, specialist in not-for-profit governance.

Think through this step by step — consider rate, responsiveness, sector experience, and what matters most for a not-for-profit board engagement — then give me a clear recommendation with a one-line reason.
```
...
This technique is especially useful when you have a distinctive voice or format that's difficult to specify through instructions alone. Writing your own outreach emails in a particular style. Describing services in a way that's specific to your firm. Writing internal updates that match a tone your team already knows. If you spend thirty minutes trying to describe the style in words — and Claude still doesn't quite get it — try showing it two examples instead.
...
```
Here are two examples of how I write proposal follow-up emails for my HR consultancy:

Example 1:
Hi Sarah, just checking in on the proposal I sent through last Thursday for the manager development programme. Happy to answer any questions or adjust the scope if the budget needs to work differently. Let me know either way — no pressure.

Example 2:
Hi Marcus, following up on the policy review proposal from last week. If the timing doesn't suit you right now, that's completely fine — just let me know and I can put it on hold until you're ready to move forward.

Now write a follow-up for this situation: I sent a proposal to a client called James three weeks ago for a full HR systems audit — around $8,500. I haven't heard anything. Same tone and style as the examples above.
```
...
Weak: "You are a consulting expert."
Stronger: "You are the engagement lead for a 12-person management consulting firm. You're reviewing a draft scope of work for a regional council client where the prior engagement ran 20% over budget."
...
- A specific professional reviewing a specific type of document ("You are a commercial solicitor reviewing a subcontractor agreement for a small consulting firm")
- A specific client type responding to a specific piece of communication ("You are a 58-year-old not-for-profit board chair who has just received this engagement summary — read it and tell me what stands out, what confuses you, and what you'd expect to hear next")
- A specific internal voice evaluating a decision ("You are the practice manager for a 15-person business advisory firm reviewing a proposed software change")
...
When you ask Claude to write a proposal, it will produce a proposal. But whose proposal format? One that reflects whatever proposal conventions are most common in its training data — which may or may not match how your firm or your industry structures proposals. If you already know what a good output looks like for your context, the fastest way to get it is to provide the skeleton and ask Claude to fill it in.

This is the difference between:

"Write an engagement closure summary for a completed consulting project."

And:

```
Complete this engagement closure summary using the information I'll give you. Use exactly this structure:
...
If the task is simple, the best prompt is usually simple. "Summarise this client email in three bullet points." "Rewrite this paragraph in plain English." "Give me five subject line options for this newsletter." None of these benefit from chain-of-thought, few-shot examples, a detailed role, or a structural scaffold. They benefit from being clear about the task, the audience, and the format. That's it.

Ask yourself before adding a technique, {{firstName}}: what specific problem is this technique solving? If you can't answer that question directly — "I'm using few-shot because my voice is hard to describe in abstract terms" or "I'm using chain-of-thought because I need to see the trade-off reasoning before I decide" — don't use it. A technique used without a reason is just noise in the prompt.

The trap is complexity for its own sake. More elaborate prompts do not reliably produce better outputs. They sometimes produce worse ones, and they always produce slower workflows. The fundamentals from Lessons 2.1 through 2.3 handle most tasks well at {{businessName}}. Advanced techniques handle the edge cases. Know which one you're in before you reach for the toolkit.
