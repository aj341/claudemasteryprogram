...
This technique earns its place on complex, multi-variable tasks. Think: deciding which orthotic supplier to use based on price, lead time, and quality track record. Reviewing a corporate-wellness contract clause that has several possible interpretations. Evaluating whether to take on a complex multi-disciplinary case based on time, scope, and clinical fit. These are tasks where the answer is not obvious, where several factors pull in different directions, and where you want to see the working — not just the output.
...
```
I'm {{firstName}}, and I'm deciding between two commercial laundry suppliers for {{businessName}} (a 4-treatment-room physio clinic). Here are the key facts:

Supplier A: $380/month, 48-hour turnaround on towels and linen, 3 years in business, two existing clients in allied health.
Supplier B: $420/month, same-day turnaround, 8 years in business, specialist in clinical and aged-care environments.

Think through this step by step — consider cost, reliability, infection-control track record, and what matters most for a clinic environment — then give me a clear recommendation with a one-line reason.
```
...
```
Here are two examples of how I write follow-up emails for my allied health clinic:

Example 1:
Hi Sarah, just checking in after our initial assessment last Thursday. Happy to answer any questions about the home exercises, or adjust the plan if anything isn't working for you. Let me know either way — no pressure to book in if the timing isn't right.

Example 2:
Hi Marcus, following up on the treatment plan we discussed last week. If a 6-session course isn't right for you at the moment, that's completely fine — just let me know and I can put your file on hold until you're ready to start.

Now write a follow-up for this situation: I assessed a client called James three weeks ago and recommended a 4-session rehab program — around $480 in gap fees after rebates. I haven't heard back. Same tone and style as the examples above.
```
...
Stronger: "You are the practice manager for a 12-clinician multi-disciplinary allied health practice. You're reviewing a profit-and-loss statement at the end of a quarter where consumables and orthotic-supply costs came in 15% over budget."
...
- A specific professional reviewing a specific type of document ("You are a private health insurer's claims assessor reviewing an extended-treatment plan for a 6-week neck-and-shoulder rehab program")
- A specific customer type responding to a specific piece of communication ("You are a 58-year-old patient who has just received this clinic newsletter — read it and tell me what stands out, what confuses you, and what you'd expect to hear next")
- A specific internal voice evaluating a decision ("You are the senior physiotherapist at a 6-clinician practice reviewing a proposed change to our intake-form template")
...
"Write a discharge summary for a completed course of physiotherapy."

And:

```
Complete this discharge summary using the information I'll give you. Use exactly this structure:

DISCHARGE SUMMARY — {{businessName}}

Episode of care:
Client (initials only):
Discharge date:
Treatment delivered: [2–3 sentences on what was provided across the episode]
Items outstanding: [bullet list — if none, write "None"]
Client sign-off notes: [one sentence on how the final review went, any conditions]
Self-management plan period: [one sentence]
Next scheduled review: [date or "not applicable"]

Here is the case information: [paste details]
```
...
Output scaffolding is particularly useful for: recurring clinical documents with a standard format (discharge summaries, case-conference notes, treatment-plan summaries), client-facing templates that have to match your brand's structure, and any task where you already know what a good output looks like — you just need the content generated.
