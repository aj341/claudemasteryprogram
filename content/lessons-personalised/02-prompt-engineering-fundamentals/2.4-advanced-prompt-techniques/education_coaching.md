...
```
I'm deciding between two booking-and-billing platforms for {{businessName}}, my tutoring service. Here are the key facts:

Platform A: $79/month, 48-hour response on support tickets, 3 years in business, two existing clients in tutoring.
Platform B: $115/month, same-day response on support tickets, 8 years in business, specialist in education and training providers.

Think through this step by step — consider cost, reliability, industry experience, and what matters most for a six-tutor service — then give me a clear recommendation with a one-line reason.
```
...
```
Here are two examples of how I write enrolment follow-up emails for my tutoring service:

Example 1:
Hi Sarah, just checking in on the Term 2 enrolment form I sent through last Thursday for Lily. Happy to answer any questions or adjust the timetable if the days need to work differently. Let me know either way — no pressure.

Example 2:
Hi Marcus, following up on the maths assessment slot from last week for Jaden. If the timing doesn't suit you right now, that's completely fine — just let me know and I can hold the spot until you're ready to confirm.

Now write a follow-up for this situation: I sent an enrolment proposal to a parent called James three weeks ago for a full Year 11 methods program — around $4,500 over the year. I haven't heard anything. Same tone and style as the examples above.
```
...
Stronger: "You are the operations lead for a 12-tutor education service. You're reviewing a profit-and-loss statement at the end of a quarter where casual tutor wages came in 15% over budget."
...
- A specific professional reviewing a specific type of document ("You are an education lawyer reviewing a casual tutor contract for a small AU tutoring service")
- A specific parent type responding to a specific piece of communication ("You are a working mum of a Year 9 student who has just received this term newsletter — read it and tell me what stands out, what confuses you, and what you'd expect to hear next")
- A specific internal voice evaluating a decision ("You are the operations lead for a 12-tutor service reviewing a proposed booking-platform change")
...
"Write a course handover summary for a completed term."

And:

```
Complete this course handover summary using the information I'll give you. Use exactly this structure:

TERM HANDOVER SUMMARY

Course or program name:
Student or family:
Completion date:
Scope delivered: [2–3 sentences on what was taught or covered]
Items outstanding: [bullet list — if none, write "None"]
Family sign-off notes: [one sentence on how the wrap-up call went, any conditions]
Re-enrolment window and terms: [one sentence]
Next scheduled contact: [date or "not applicable"]

Here is the term information: [paste details]
```
