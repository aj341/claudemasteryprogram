...
This is your role, your firm, and the relevant parts of your professional situation. It tells Claude which world you operate in.

A generic prompt says: "Write an engagement follow-up email."

A prompt with who-you-are context says: "I run a 5-person HR consultancy in Auckland. Most of our clients are in trades or hospitality with 10-40 staff. We send proposals after a discovery call, and our typical engagement is $4,000-$12,000 per project."

Claude now knows the industry, the firm size, the client base, and the price bracket. Every word in the response can be calibrated to that reality instead of written for a generic business in a generic context.
...
"I need to email a long-term client — we've worked with them for three years — to let them know we're increasing our day rate by 15%, effective the next engagement. We've absorbed rising costs for two years and can't hold the line. The increase is fair and I don't want to lose this client. They're a good payer and easy to work with." That's the situation. Now Claude can actually help.
...
The same information written for a 60-year-old tradesperson who's never engaged a consultant should read completely differently from the same information written for a procurement manager who reviews proposals weekly. Claude can calibrate for either — but only if you say who's on the receiving end.

Audience context doesn't have to be long. "For a client who's not comfortable with HR terminology" or "for my business partner who has a finance background and wants the short version" — one sentence is often enough to shift the entire register of the response.
...
Claude will produce something generic. It may have good bones — an intro, a scope section, a fee summary, a close. But it won't sound like you. It won't address this client's specific situation. It will be usable as a template, not as a deliverable.

**Specific:**

```
I run a management consulting practice in Perth with two consultants.
We've just had a discovery call with a regional accounting firm that
wants help restructuring how their team is organised — partner workload,
client allocation, and a refreshed service menu. They mentioned they're
"strategy-literate" but cost-conscious, and the managing partner asked
twice about timelines.

Write a proposal introduction and scope section. The tone should be
...
Don't include fees in this section — that comes later in the document.
```

That prompt produces a usable first draft. Every element of it — the practice size, the client type, the client's stated concerns, the tone instruction, the format instruction, the explicit scope exclusion (no fees) — narrows Claude's response from the possible range to the useful range.
...
Good exclusions are specific. "Don't include a firm-history section." "Avoid any phrase like 'we are pleased to offer' or 'we look forward to working with you' — I hate that language." "No bullet points — this should read as prose." "Don't make assumptions about the client's budget."
...
There is a point of diminishing returns. You don't need to write three paragraphs of background for a task that needs one sentence. You don't need to explain your whole firm history before asking Claude to summarise a document. Over-contextualised prompts are rare — most people err in the opposite direction — but they do happen, and they waste your time.
...
For short tasks — quick email replies, brief summaries, simple conversions — two or three sentences of context is usually enough. For complex outputs — proposals, scopes of work, client-facing reports — you might write ten sentences of context, and that's fine. The length isn't the issue. Whether every sentence is doing useful work is.

Here is a rough guide. Ask yourself three questions before sending:

- **Has Claude got enough to know who I am for this task?** If you're a sole consultant in a specific niche, say so. If you're a project lead writing for the managing director, say so.
...
```
I'm {{firstName}}, owner of a 3-person business advisory practice called
{{businessName}} in Brisbane. We've just launched a new service: a
half-day "growth diagnostic" for small businesses (under 20 staff) who
feel stuck and need an outside set of eyes on their numbers, team, and
pipeline. It costs $895.

Write a LinkedIn post announcing this service. The audience is small
business owners — not other consultants. They're frustrated but don't
know exactly what's slowing them down. Write it in plain language. One
paragraph, no bullet points. Lead with the problem the business owner
has, not with us. Don't write "Excited to announce" — I want it to sound
like an actual person wrote it.
```

The second prompt takes about 90 seconds to write. The output is ready to post with at most one edit pass. The difference is not the length — it's that every sentence gives Claude something specific to work with: the firm size, the service details, the price, the audience mindset, the format, and an explicit "don't" that prevents the most common lazy opener.
