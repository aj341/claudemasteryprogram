...
A prompt with who-you-are context says: "I run a 6-tutor maths and English service in Auckland. Most of our students are Year 7–10. We confirm enrolments after a 15-minute parent call, and our typical engagement is $400–$800 per term per student."

Claude now knows the industry, the business size, the student base, and the price bracket. Every word in the response can be calibrated to that reality instead of written for a generic business in a generic context.
...
The same information written for a parent who's never touched the secondary syllabus should read completely differently from the same information written for a school head of department who reads NAPLAN reports daily. Claude can calibrate for either — but only if you say who's on the receiving end.

Audience context doesn't have to be long. "For a parent who's not comfortable with curriculum terminology" or "for my lead tutor who has a teaching background and wants the short version" — one sentence is often enough to shift the entire register of the response.
...
```
I run a solo executive coaching practice in Perth. We've just had
a discovery call with a professional services firm that wants leadership
development for their three new GMs — coaching, a structured roundtable, and a board-presentation skills module. They mentioned they're
"coaching-literate" but cost-conscious, and the partner asked twice about
timelines.
...
```
I run a 3-tutor maths service in Brisbane. We've just launched a new
service: a 90-minute Year 11 methods diagnostic session for students
(and their parents) who want to check whether their current revision
approach, problem-solving habits, and assessment technique are on track
before mid-year exams. It costs $185.

Write a LinkedIn post announcing this service. The audience is parents —
not maths teachers. They're worried about exam results but don't know
where to start. Write it in plain language. One paragraph, no bullet points.
Lead with the problem the parent has, not with us. Don't write "Excited
