...
When you sit down with a capable casual on the floor and explain a task, you're doing something you don't notice: you're filling in context. You mention which customer it's for. You reference the order they placed last week. You say "keep it warm — this is a regular." All of that happens in a few seconds, without effort.

Claude doesn't get that. It has no memory of {{businessName}}, your customers, your tone, or your history unless you write it down. Every prompt starts with a blank sheet. Claude is highly capable at following instructions, drawing on information, and producing structured output — but it can only work with what you give it. Nothing more.
...
Context is the single biggest lever you have on prompt quality. It outranks clever phrasing, fancy structures, and any prompt "hack" you've seen on TikTok. A well-contextualised prompt in plain English will beat a framework-compliant prompt with no context, every single time.
...
This is your role, your business, and the relevant parts of your retail situation. It tells Claude which world you operate in.

A generic prompt says: "Write a quote follow-up email."

A prompt with who-you-are context says: "I run a 4-person bricks-and-mortar gift shop in Hobart that also sells online. Most of our wholesale enquiries come from boutique stockists wanting to test 4–6 of our top-selling SKUs. Typical first wholesale order is $500–$1,200."

Claude now knows the format, the business size, the customer base, and the order bracket. Every word in the response can be calibrated to that reality instead of written for a generic business in a generic context.
...
"I need to email a long-standing wholesale stockist — we've worked with them for three years — to let them know we're increasing our wholesale prices by 12%, effective from the next order. We've absorbed rising freight and clay costs for two years and can't hold the line. The increase is fair and I don't want to lose this stockist. They reorder reliably every six weeks and pay on time." That's the situation. Now Claude can actually help.

The situation context is the part people most often skip. They name the task ("write a wholesale pitch," "summarise this returns thread," "draft a response to a damaged-order complaint") but don't say anything about the circumstances that make this specific instance worth thinking about. Those circumstances are where all the nuance lives.
...
The same information written for a 65-year-old customer who placed her first online order should read completely differently from the same information written for a buyer at a David Jones-style department store. Claude can calibrate for either — but only if you say who's on the receiving end.

Audience context doesn't have to be long. "For a customer who's not used to online ordering and has never seen a tracking link" or "for a wholesale buyer who reviews 30 brand pitches a week and wants the short version" — one sentence is often enough to shift the entire register of the response.

When you're drafting anything that's going to a customer or a stockist, always include at least a one-line audience note. It is one of the highest-value lines you can add.
...
```
Write a wholesale pitch email.
```

Claude will produce something generic. It may have good bones — an intro, a brand summary, a range overview, a close. But it won't sound like you. It won't address this stockist's specific situation. It will be usable as a template, not as a deliverable.

**Specific:**

```
I run a small homewares brand on Shopify, based in regional Victoria, doing about
$400k a year direct plus 15 wholesale stockists. We've just been DM'd by the
buyer at a Sydney homewares boutique — they've opened their second location,
follow our Instagram, and want to know our wholesale terms.

Write a first-reply email. Introduce us briefly, attach a digital line sheet
(I'll add the PDF separately), state our standard wholesale terms (50% RRP, 6-piece
minimum per SKU, 14-day payment), and ask one specific question — whether they
want me to send a sample box of three SKUs before they commit. Tone: warm and
confident, not salesy. Under 200 words. No "exclusive offer" or "delighted" language.
```

That prompt produces a usable first draft. Every element of it — the brand size, the stockist's behaviour, their specific situation, the tone instruction, the format instruction, the explicit constraint on language — narrows Claude's response from the possible range to the useful range.
...
Most retailers write prompts that describe what they want. Fewer write prompts that describe what they don't want. Both matter.

"Write a wholesale email" tells Claude what to produce. It doesn't tell Claude what to avoid. So Claude might write an opening that starts with "We are delighted to introduce..." which you hate. Or it might use marketing jargon that your buyer would find off-putting. Or it might include a brand-history paragraph that you never put in first-reply emails.
...
Good exclusions are specific. "Don't include a brand-history section." "Avoid any phrase like 'we are pleased to offer' or 'we look forward to partnering' — I hate that language." "No bullet points — this should read as warm prose." "Don't quote a specific reorder lead time — I'll add that after I've checked with my supplier."

A vague exclusion ("don't make it too formal") is better than no exclusion at all, but it leaves Claude guessing about where the line is. A specific exclusion ("avoid words like 'curated,' 'elevated,' or 'thoughtfully designed'") removes all the guessing.
...
There is a point of diminishing returns. You don't need to write three paragraphs of background for a task that needs one sentence. You don't need to explain your whole brand story before asking Claude to summarise a customer-service thread. Over-contextualised prompts are rare — most retailers err in the opposite direction — but they do happen, and they waste your time.
...
For short tasks — quick "where's my order" replies, brief restock-alert subject lines, simple SKU title rewrites — two or three sentences of context is usually enough. For complex outputs — wholesale pitches, brand-launch emails, returns-policy rewrites — you might write ten sentences of context, and that's fine. The length isn't the issue. Whether every sentence is doing useful work is.

Here is a rough guide. Ask yourself three questions before sending:

- **Has Claude got enough to know who I am for this task?** If you're a Shopify-only brand or a multi-channel retailer, say so. If you're writing as the founder or as a customer-service casual, say so.
...
- **Has Claude got enough to write for the right audience?** Name the customer or buyer who'll receive this, and what matters to them.

If the answer to all three is yes, you have minimum viable context. Send it.

### Common mistake → better approach

**Mistake:** "Write me a social media post about our new product."

This prompt is almost information-free. Claude knows you want a social media post and that you have a new product. That's it. The output will be something like: "Excited to announce our latest drop! [Product] is now live. Shop now via the link in bio." Postable. Worthless.

**Better approach:**

```
I run a 3-person homewares brand on Shopify, based in regional NSW. We've just
launched a new product: a small-batch, hand-poured beeswax candle in three
seasonal scents — eucalyptus, banksia, lemon myrtle. $34 each, 60-hour burn time.
We make them ourselves, 80 per scent per batch.

Write a LinkedIn post announcing this candle. The audience is independent retail
buyers — boutique store owners who follow us for wholesale, not retail customers.
They care about provenance, margin, and supply consistency. Write it in plain
language. One paragraph, no bullet points. Lead with the small-batch story
(80 per scent), not with us. Don't write "Excited to announce" — I want it to
sound like an actual person wrote it.
```

The second prompt takes about 90 seconds to write. The output is ready to post with at most one edit pass. The difference is not the length — it's that every sentence gives Claude something specific to work with: the brand size, the product details, the price, the audience mindset, the format, and an explicit "don't" that prevents the most common lazy opener.
