...
A prompt with who-you-are context says: "I'm {{firstName}}, and I run a 6-practitioner psychology practice called {{businessName}} in Auckland. Most of our clients are referred via GPs under Mental Health Care Plans. Our typical engagement is 6–10 sessions, with a $90 gap fee after the Medicare rebate."
...
"I need to email a long-term client — we've treated her on and off for three years — to let her know our gap fee is increasing by $10 per session, effective next quarter. We've absorbed rising room-rental and software costs for two years and can't hold the line. The increase is fair and I don't want to lose her. She attends consistently and refers her colleagues." That's the situation. Now Claude can actually help.
...
The same information written for a 70-year-old client who has never used a patient portal should read completely differently from the same information written for a referring sports doctor who reads handover reports daily. Claude can calibrate for either — but only if you say who's on the receiving end.

Audience context doesn't have to be long. "For a client who's not comfortable with clinical terminology" or "for my referring GP who reads dozens of handovers a week and wants the short version" — one sentence is often enough to shift the entire register of the response.
...
```
I'm {{firstName}}, running a small osteopathy clinic in Perth with two practitioners.
We've just had an initial chat with a corporate wellness manager who wants
on-site assessment days at three of their office locations — posture screens,
desk-set-up reviews, and a short follow-up program. They mentioned they're
"already working with another provider" but cost-conscious, and the manager
asked twice about scheduling around shift patterns.

Write a proposal introduction and scope section. The tone should be confident
but not salesy — I want them to feel like they're engaging a specialist, not
...
```
I'm {{firstName}}, running a 3-clinician occupational therapy practice called
{{businessName}} in Brisbane. We've just launched a new service: a 90-minute
home-safety review for older adults living alone — covering bathroom risks,
trip hazards, and lighting — with a written report their family can use. It
costs $295.

Write a LinkedIn post announcing this service. The audience is adult children
of older parents — not OTs or aged-care professionals. They're worried about a
parent's safety but don't know where to start. Write it in plain language.
One paragraph, no bullet points. Lead with the problem the family has, not
with us. Don't write "Excited to announce" — I want it to sound like an actual
person wrote it.
```
