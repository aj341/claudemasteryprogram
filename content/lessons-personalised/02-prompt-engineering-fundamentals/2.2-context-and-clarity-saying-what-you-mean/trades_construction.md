...
When you sit down with a capable apprentice or office staffer and explain a job, you're doing something you don't notice: you're filling in context. You mention who the customer is. You reference the email the builder sent last week. You say "keep it simple — this homeowner doesn't like trade jargon." All of that happens in a few seconds, without effort.
...
This is your role, your business, and the relevant parts of your trade situation. It tells Claude which world you operate in.

A generic prompt says: "Write a quote follow-up email."

A prompt with who-you-are context says: "I run a 6-person residential electrical business in outer Brisbane. Most of our work is rewires, switchboard upgrades, and ceiling-fan installs for homeowners. We send quotes after a free site visit, and our typical job is $1,500–$8,000."

Claude now knows the trade, the business size, the customer base, and the price bracket. Every word in the response can be calibrated to that reality instead of written for a generic business in a generic context.
...
"I need to email a long-term builder we sub for — we've worked his sites for three years — to let him know we're putting our hourly rate up by 15%, effective next quarter. We've absorbed material price rises for two years and can't keep wearing it. The increase is fair and I don't want to lose his work. He's a good payer and a straight-shooter on site." That's the situation. Now Claude can actually help.

The situation context is the part people most often skip. They name the task ("write a quote follow-up," "summarise this scope," "draft a response") but don't say anything about the circumstances that make this specific instance worth thinking about. Those circumstances are where all the nuance lives.
...
The same information written for a 60-year-old homeowner who's never had electrical work done before should read completely differently from the same information written for a builder who reads scopes daily. Claude can calibrate for either — but only if you say who's on the receiving end.

Audience context doesn't have to be long. "For a homeowner who's not comfortable with electrical terms" or "for a builder I've worked with for years and who wants the short version" — one sentence is often enough to shift the entire register of the response.
...
```
Write a quote for a new customer.
```

Claude will produce something generic. It may have good bones — an intro, a scope section, pricing, a close. But it won't sound like you. It won't address this customer's specific situation. It will be usable as a template, not as a deliverable you can send.

**Specific:**

```
I run a residential plumbing business on the Sunshine Coast with two
plumbers and one apprentice. We've just done a site visit for a homeowner
who wants a full bathroom re-fit — new pan, vanity, mixer, and shower
re-tile prep — in a 90s Queenslander. She mentioned her last plumber went
quiet halfway through the kitchen job last year, and she asked twice about
how we communicate during a job.

Write a quote introduction and scope section. The tone should be confident
but not salesy — I want her to feel like she's hiring someone reliable, not
being pitched to. Keep the scope section to dot points. Don't include
pricing in this section — that comes in a separate table later.
```

That prompt produces a usable first draft. Every element of it — the team size, the customer type, her stated concerns, the tone instruction, the format instruction, the explicit scope exclusion (no pricing) — narrows Claude's response from the possible range to the useful range.
...
"Write a quote introduction" tells Claude what to produce. It doesn't tell Claude what to avoid. So Claude might write an opening that starts with "We are delighted to present..." which you hate. Or it might use trade jargon that your homeowner wouldn't understand. Or it might include a company history paragraph that you never put in quotes.
...
Good exclusions are specific. "Don't include a company history section." "Avoid any phrase like 'we are pleased to offer' or 'we look forward to working with you' — I hate that language." "No bullet points — this should read as prose." "Don't make assumptions about the customer's budget."
...
There is a point of diminishing returns. You don't need to write three paragraphs of background for a task that needs one sentence. You don't need to explain your whole business history before asking Claude to summarise a scope. Over-contextualised prompts are rare — most people err in the opposite direction — but they do happen, and they waste your time.
...
For short tasks — quick SMS replies, brief summaries, simple conversions — two or three sentences of context is usually enough. For complex outputs — quotes, variations, customer-facing letters — you might write ten sentences of context, and that's fine. The length isn't the issue. Whether every sentence is doing useful work is.

Here is a rough guide. Ask yourself three questions before sending:

- **Has Claude got enough to know who I am for this task?** If you're a sole-trader sparkie or a builder running multiple sites, say so. If you're the office manager writing on behalf of the owner, say so.
...
```
I run a 3-person HVAC business in Western Sydney. We've just launched a new
service: a pre-summer system health check for residential customers — a
$249 visit that covers gas pressure, refrigerant, filter clean, and a
written report on whether the unit will get through summer without a
breakdown.

Write a Facebook post announcing this service. The audience is local
homeowners — not strata managers or builders. They're worried about a
breakdown on the first 38-degree day but don't know what a service
actually involves. Write it in plain language. One paragraph, no bullet
points. Lead with the problem the homeowner has, not with us. Don't write
"Excited to announce" — I want it to sound like an actual person wrote it.
```
