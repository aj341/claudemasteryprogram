...
Context is the single biggest lever you have on prompt quality. It outranks clever phrasing, fancy structures, and any prompt "hack" you've seen on a SaaS Twitter thread. A well-contextualised prompt in plain English will beat a framework-compliant prompt with no context, every single time.
...
This is your role, your product, and the relevant parts of your business situation. It tells Claude which world you operate in.

A generic prompt says: "Write a renewal email."

A prompt with who-you-are context says: "I run a 6-person micro-SaaS in Auckland. We sell a recurring-billing tool to indie consultancies and freelancers. Annual plans renew on the customer's signup anniversary, and our typical account pays $39–$99/month."

Claude now knows the category, the team size, the customer base, and the price bracket. Every word in the response can be calibrated to that reality instead of written for a generic SaaS in a generic context.

You don't need to write your full deck. Two or three sentences that situate you clearly is enough for most tasks. The goal is for Claude to understand whose problem it's solving.
...
"I need to email a long-time customer — they've been on our $79/month Pro plan for 26 months — to let them know we're moving from flat pricing to per-seat pricing. Their account has 8 active users, so under the new pricing they'd pay $232/month. I'm offering them a 12-month grandfather window. They're a strong reference customer and I don't want to lose them. Their CEO replies to every email within an hour." That's the situation. Now Claude can actually help.

The situation context is the part people most often skip. They name the task ("write a churn email," "summarise this Gong call," "draft a release note") but don't say anything about the circumstances that make this specific instance worth thinking about. Those circumstances are where all the nuance lives.
...
The same information written for a non-technical owner-operator who's never opened a Stripe dashboard should read completely differently from the same information written for a CTO who reviews payment integrations weekly. Claude can calibrate for either — but only if you say who's on the receiving end.

Audience context doesn't have to be long. "For a customer who's not comfortable with billing terminology" or "for my technical co-founder who reads RFC drafts for fun and wants the short version" — one sentence is often enough to shift the entire register of the response.
...
Claude will produce something generic. It may have good bones — an intro, a scope section, pricing, a close. But it won't sound like {{businessName}}. It won't address this customer's specific situation. It will be usable as a template, not as a deliverable.

**Specific:**

```
I run a 7-person vertical SaaS in Perth that sells a roster-and-payroll
helper to AU/NZ allied-health clinics. We've just had a discovery call
with a 14-clinic physio group that wants to roll us out in 6 weeks.
They mentioned they're "comfortable with software" but cost-conscious,
and the COO asked twice about onboarding speed.

Write the introduction and scope section of the proposal. The tone should
be direct and confident — not salesy — I want them to feel like they're
hiring specialists, not being pitched to. Keep the scope section to dot
points. Don't include pricing in this section — that comes later in the
document.
```

That prompt produces a usable first draft. Every element of it — the team size, the customer profile, the customer's stated concerns, the tone instruction, the format instruction, the explicit scope exclusion (no pricing) — narrows Claude's response from the possible range to the useful range.
...
"Write a proposal introduction" tells Claude what to produce. It doesn't tell Claude what to avoid. So Claude might write an opening that starts with "We're thrilled to partner with..." which you hate. Or it might use SaaS jargon that your prospect wouldn't recognise. Or it might include a company-history paragraph that you never put in proposals.
...
Good exclusions are specific. "Don't include a company-history section." "Avoid any phrase like 'we're excited to partner' or 'we look forward to a long relationship' — I hate that language." "No bullet points — this should read as prose." "Don't make assumptions about the customer's budget."

A vague exclusion ("don't make it too formal") is better than no exclusion at all, but it leaves Claude guessing about where the line is. A specific exclusion ("avoid words like 'leverage,' 'best-in-class,' or 'transform'") removes all the guessing.
...
There is a point of diminishing returns. You don't need to write three paragraphs of background for a task that needs one sentence. You don't need to explain your whole product history before asking Claude to summarise a Gong call. Over-contextualised prompts are rare — most founders err in the opposite direction — but they do happen, and they waste your time.
...
For short tasks — quick support replies, brief summaries, simple conversions — two or three sentences of context is usually enough. For complex outputs — proposals, policies, customer-facing announcements — you might write ten sentences of context, and that's fine. The length isn't the issue. Whether every sentence is doing useful work is.

Here is a rough guide, {{firstName}}. Ask yourself three questions before sending:

- **Has Claude got enough to know who I am for this task?** If you're a founder in a specific SaaS category, say so. If you're a CS lead writing for an account, say so.
...
- **Has Claude got enough to write for the right audience?** Name the person or team who'll receive this, and what matters to them.

If the answer to all three is yes, you have minimum viable context. Send it.

### Common mistake → better approach

**Mistake:** "Write me a social media post about our new feature."

This prompt is almost information-free. Claude knows you want a social media post and that you have a new feature. That's it. The output will be something like: "We're thrilled to announce our latest offering! [Feature] is now live. Sign up today!" Publishable. Worthless.

**Better approach:**

```
I'm the founder of a 9-person micro-SaaS in Sydney. We sell a Stripe-billing
helper to AU indie makers and small consultancies — about 470 paying
customers. We've just shipped automated dunning with smart retry timing.
On a $30/month account it typically saves one churn-to-failed-card per
month, which is $360 in retained ARR per save.

Write a LinkedIn post announcing this. The audience is indie SaaS makers
and small B2B founders — not enterprise revenue teams. They're losing
real MRR to failed cards but haven't got around to fixing it. Write it
in plain language. One paragraph, no bullet points. Lead with the problem
they have, not with us. Don't write "We're thrilled to announce" — I want
it to sound like an actual person wrote it.
```

The second prompt takes about 90 seconds to write. The output is ready to post with at most one edit pass. The difference is not the length — it's that every sentence gives Claude something specific to work with: the team size, the product details, the price point, the audience mindset, the format, and an explicit "don't" that prevents the most common lazy opener.
