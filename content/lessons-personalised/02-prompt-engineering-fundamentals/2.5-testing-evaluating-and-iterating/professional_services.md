...
**Checkpoint 1: Did Claude address the right task?** Sometimes a vague task instruction produces a response to the task Claude inferred rather than the task you meant. If you asked Claude to "review this scope of work," did it give editorial feedback, or did it summarise the scope instead?
...
**Checkpoint 3: Is the scope right?** Did Claude go narrower than you needed — covering half the engagement? Or broader — adding sections and caveats and considerations you didn't ask for? Scope drift in both directions is common.

**Checkpoint 4: Is the content accurate and relevant?** Did Claude invent information you didn't provide? Did it make assumptions about your firm, your clients, or your situation that aren't true? Accuracy problems are usually a missing-context failure in disguise.
...
The response is reasonable, but it doesn't know enough about your situation to be useful. The language doesn't match your voice. The suggestions are generic rather than specific to your sector. The advice ignores something about your practice that would have changed the answer completely. Claude isn't wrong — it just didn't have enough information to be right for you.
...
The content of the response is actually correct, but the shape is wrong. You needed bullet points, you got paragraphs. You needed a 100-word recap, you got 400 words. You needed a table, you got a list. You needed a professional document, you got something that reads like a chat message.
...
Not every task needs a perfect output. A draft internal email to a team of three at {{businessName}}, a quick summary of a supplier's terms for your own reference, a rough agenda for a client meeting tomorrow — these tasks do not require four rounds of iteration. They require a result that's good enough to serve the purpose. Once you have that, stop.
...
the one I described — a new client who hasn't signed an engagement letter
yet. Remove the sections on existing clients and renewals entirely.
