...
```
I'm the operations lead at a 6-tutor maths and English service in Auckland.
We're wrapping up Term 1 across our Year 5 to Year 12 timetable.
We're on track, but mid-year exam prep enrolments for Year 11 are two
weeks behind. Write a short internal status update for my tutor team,
under 150 words, professional tone, no jargon.
```
...
```
I'm the operations lead at [BUSINESS NAME], a [TEAM SIZE]-tutor [SERVICE TYPE]
in [CITY]. I'm writing a weekly internal status update for the
[TERM OR PROGRAM NAME] timetable.
...
Common candidates in AU/NZ education and coaching businesses: parent update emails, term enrolment confirmations, follow-up emails after a discovery call or assessment, social media captions for a recurring content type, internal tutor briefings, onboarding messages for new students or clients, supplier inquiry emails, monthly reports to a business partner or board.
