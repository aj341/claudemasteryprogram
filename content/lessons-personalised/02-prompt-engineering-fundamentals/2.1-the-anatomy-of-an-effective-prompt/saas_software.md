...
Prompt engineering is just the practice of writing clear, specific instructions. That's it. Every founder and operator already does a version of this in their daily work — a brief to a contractor, a ticket to an engineer, a request to a new support hire. The principles are the same. You're telling Claude who you are, what you need, and how you want it delivered.
...
**Role:** Tell Claude who it is for this task, or who you are. This shapes the perspective it takes and the expertise level it brings to the response. "You are an experienced customer success lead at a B2B SaaS" produces a different response than leaving Claude to guess. "I'm the non-technical co-founder of an indie SaaS in healthtech" gives Claude the context to calibrate its language and assumptions.

**Context:** Give Claude the situation. What's the background? What's already happened? What's the environment this is happening in? Context is where most weak prompts fail — people jump straight to the task without giving Claude any of the surrounding information it needs to produce something relevant. Without context, Claude fills the gaps with generic SaaS assumptions. Those generic assumptions produce generic output.

**Task:** State clearly what you want Claude to do. Use a verb. "Write," "summarise," "analyse," "draft," "compare," "extract," "review." Vague task descriptions produce vague results. "Help me with this customer email" is a task description, but it's doing almost no work. "Draft a reply to this churn-risk email, declining the requested 50% discount but proposing a free month while we ship the integration they're waiting on" is a task description that tells Claude exactly what success looks like.

**Format:** Specify the shape of the output you want. Length, structure, tone, what to include, what to exclude. If you want a bullet list, say so. If you want 200 words, say 200 words. If you want a release note, say release note. If you want the output to avoid SaaS jargon because it's going to a non-technical buyer, say that explicitly. Format is the component most people forget, and it's why they get back a 600-word essay when they wanted a three-sentence Slack message.
...
```
You are an experienced product marketing lead at a small B2B SaaS. [Role]

I run a 14-person vertical SaaS in Brisbane. We sell a job-management
tool to AU/NZ commercial cleaning operators — about 280 paying customers.
We've just shipped Xero export, our most-requested feature for 18 months.
Right now we have nothing on the changelog page or in customers' inboxes
about it. [Context]

Write a one-page launch announcement we'd send by email to our existing
paying customers. [Task]

Keep it practical and plain — no marketing fluff, no "we're thrilled to
announce." Use short paragraphs. 280 words maximum. [Format]
```

Compare that to: "Write me something about our Xero integration." Both are prompts. Only one is useful.
...
Think about how you read a Linear ticket, a customer email, or a feature spec. If the first sentence gives you the essential context, everything else lands in the right frame. If the first sentence is ambiguous or buried in background noise, you're guessing at what matters as you read.
...
Now flip the order. Lead with the Task first — "Write a churn-prevention email" — then add context and role at the end. Claude has already begun generating a response in a particular direction. The context you add later may or may not fully override the initial assumptions it made. You'll often get an output that's half generic (from the first read) and half personalised (from the late context). It's patchwork.

The rule is simple: set the stage before you issue the instruction. Role and Context first. Task second. Format last.

There's one exception worth knowing: if the context is very long — for example, you're pasting in a full Gong transcript for Claude to analyse — put the task instruction first, then the transcript. This tells Claude what to look for as it reads. But for most everyday prompts, the standard order holds.
...
```
You are a social media copywriter who works with small B2B SaaS teams.

I'm the founder of an indie SaaS called QuoteRail, based in Hobart. We
sell a quoting tool to AU plumbers and electricians — about 540 paying
customers. We've just shipped two-way Xero invoice sync, the feature
plumbers and sparkies have asked for since day one. It saves them from
manually re-keying every accepted quote into Xero.

Write one LinkedIn post promoting the launch. Target audience is the
business owners and ops managers at small trade-services SaaS companies
who follow us. The tone should be direct and a little dry — not corporate,
not hype. End with a single sentence inviting them to reply if they want
a quick walkthrough.

180 words maximum. No hashtags in the post itself.
```
...
- Names the actual product, its category, and the new feature
...
The weak prompt has none of that. Claude has to guess the product type, the audience, the tone, the length, and what "new feature" means. Every guess it makes is a coin flip. You're not directing it — you're asking it to operate blind.
...
"Can you improve this onboarding email?" Claude will make changes — but its definition of improvement might mean making it longer, adding more formal language, or restructuring it in a way you didn't want. Without knowing what you consider improvement, Claude fills in the gap.

**Better approach:** Be specific about what you want changed and why.

"This onboarding email is currently 320 words and too formal in tone. The recipients are owner-operators of small trade businesses, not enterprise procurement teams. Rewrite it to sound more like a founder writing to a tradie who's just signed up — warm but direct. Aim for under 180 words. Don't change the core ask in the final paragraph (book a 15-minute setup call)."
...
**Was the output too generic?** Context was missing. You didn't give Claude enough background about your product, your customer, or the situation. It made generic assumptions and produced a generic result.
