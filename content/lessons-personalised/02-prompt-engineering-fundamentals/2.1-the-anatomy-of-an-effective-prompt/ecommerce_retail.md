...
Prompt engineering is just the practice of writing clear, specific instructions. That's it. Every good retailer already does a version of this in their daily work — a brief to a designer for new packaging, a scope to a freight forwarder, a request to a new casual on the floor. The principles are the same. You're telling Claude who you are, what you need, and how you want it delivered.
...
The good news: you already have most of what you need. Module 1 gave you the foundational mental model — Claude takes you at face value, reads only what you write, and has no context beyond what you give it. Prompt engineering is just the systematic application of that mental model. It gives you a repeatable structure so you're not starting from scratch every time you sit down to write a campaign email or a product description for {{businessName}}.
...
**Role:** Tell Claude who it is for this task, or who you are. This shapes the perspective it takes and the expertise level it brings to the response. "You are an experienced ecommerce copywriter" produces a different response than leaving Claude to guess. "I'm the owner of a Shopify homewares store" gives Claude the context to calibrate its language and assumptions.

**Context:** Give Claude the situation. What's the background? What's already happened? What's the environment this is happening in? Context is where most weak prompts fail — people jump straight to the task without giving Claude any of the surrounding information it needs to produce something relevant. Without context, Claude fills the gaps with generic assumptions. Those generic assumptions produce generic, beige product copy.

**Task:** State clearly what you want Claude to do. Use a verb. "Write," "summarise," "analyse," "draft," "compare," "extract," "review." Vague task descriptions produce vague results. "Help me with this customer email" is a task description, but it's doing almost no work. "Draft a reply to this customer email, declining the refund request but offering a 25% discount on their next order as a gesture" is a task description that tells Claude exactly what success looks like.

**Format:** Specify the shape of the output you want. Length, structure, tone, what to include, what to exclude. If you want a bullet list, say so. If you want 200 words, say 200 words. If you want warm and chatty, say warm and chatty. If you want the output to avoid retail jargon because it's going to a customer who isn't familiar with terms like "MOQ" or "RRP," say that explicitly. Format is the component most people forget, and it's why they get back a 600-word essay when they wanted a three-sentence post-purchase thank-you.
...
```
You are an experienced ecommerce operations lead. [Role]

I run a 4-person bricks-and-mortar gift shop in Hobart that also sells through a small Shopify store. We've just signed our first wholesale account — a Sydney homewares boutique that will stock six of our SKUs. The problem is that our current stock-on-hand tracking is split between the POS and a spreadsheet, and we've already had one near-miss where we promised stock to both retail and wholesale. [Context]

Write a one-page overview of a simple stock-tracking habit we could implement in the next 30 days using what we already have (Lightspeed POS, Google Sheets, and Shopify). [Task]

Keep it practical and plain — no software jargon, no recommendations that need a dev or a paid app. Use short paragraphs. 300 words maximum. [Format]
```

Compare that to: "Write me something about stock management for retailers." Both are prompts. Only one is useful.
...
Think about how you read a buyer's brief, a supplier email, or a freight quote. If the first sentence gives you the essential context, everything else lands in the right frame. If the first sentence is ambiguous or buried in background noise, you're guessing at what matters as you read.
...
Now flip the order. Lead with the Task first — "Write a customer apology email" — then add context and role at the end. Claude has already begun generating a response in a particular direction. The context you add later may or may not fully override the initial assumptions it made. You'll often get an output that's half generic (from the first read) and half personalised (from the late context). It's patchwork.

The rule is simple: set the stage before you issue the instruction. Role and Context first. Task second. Format last.

There's one exception worth knowing: if the context is very long — for example, you're pasting in a full supplier contract or three months of customer-service emails for Claude to analyse — put the task instruction first, then the document. This tells Claude what to look for as it reads. But for most everyday prompts, the standard order holds.
...
```
You are a social media copywriter who specialises in independent retail brands.

I own a small homewares brand called Saltbush & Co based in regional Victoria. We've just launched a new ceramic teapot — hand-thrown, $89, three colourways, made in a small studio in the Macedon Ranges. It's the first new product we've launched in eight months.

Write one Instagram caption announcing this teapot. Target audience is our existing customers — mostly women 35–55 who've already bought our mugs. The tone should be warm and direct — not corporate, not hyped. Use a soft call to action that points to the link in bio.

130 words maximum. No hashtags in the caption itself. No emojis.
```
...
- Names the actual brand, its location, and the product
...
The weak prompt has none of that. Claude has to guess the brand type, the audience, the tone, the length, and what "new product" means. Every guess it makes is a coin flip. You're not directing it — you're asking it to operate blind.
...
**Mistake:** Asking Claude to "improve" a piece of copy without saying what improvement means.

"Can you improve this product description?" Claude will make changes — but its definition of improvement might mean making it longer, adding adjective stacks, or restructuring it in a way you didn't want. Without knowing what you consider improvement, Claude fills in the gap.

**Better approach:** Be specific about what you want changed and why.

"This product description is currently 220 words and reads like a department-store catalogue. The customer is buying a hand-thrown ceramic mug as a gift for someone they care about. Rewrite it to feel personal and tactile — like a friend describing why they love the mug. Aim for under 120 words. Keep the dimensions and care instructions unchanged at the bottom."
...
Here's a quick diagnostic you can run on any unsatisfactory output, {{firstName}}:

**Was the output too generic?** Context was missing. You didn't give Claude enough background about your brand, your customer, or the situation. It made generic assumptions and produced a generic result.
...
**Did the response sound like it came from the wrong person?** Role was missing. Claude had no expertise signal to anchor to, so it defaulted to a neutral, middle-of-the-road voice that doesn't serve any retail brand well.
