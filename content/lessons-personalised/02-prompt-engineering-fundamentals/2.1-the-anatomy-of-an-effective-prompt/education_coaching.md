...
I run a 6-tutor maths and English service in Brisbane. We've just taken on our largest term yet — 130 students enrolled across the timetable, up from 90 last term. The problem is that our session tracking is done on paper and it's already creating errors with parent invoicing. [Context]

Write a one-page overview of a simple digital session-tracking system we could implement in the next 30 days. [Task]
...
Compare that to: "Write me something about tracking systems for tutoring." Both are prompts. Only one is useful.
...
I run an executive coaching practice called Anchor Coaching based in Wollongong. We've just launched a 90-day "First 100 Days" program aimed at managers stepping into their first GM role. The program includes weekly coaching, a structured framework for the early decisions, and a board-ready 30-day review.

Write one Instagram caption promoting this new program. Target audience is mid-career managers aged 30–45. The tone should be warm and direct — not corporate. Use a call to action that sends them to our link in bio.
...
"This email is currently 300 words and too formal in tone. The recipient is a parent, not a corporate contact. Rewrite it to sound more like a direct conversation — warm but professional. Aim for under 180 words. Don't change the core message or the ask in the final paragraph."
