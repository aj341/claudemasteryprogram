...
Think about the writing you do in a typical retail week. Not the creative work, not the big strategic documents — the everyday stuff. The follow-up email after a wholesale meeting. The product description for the new SKU you're listing on Thursday. The post-purchase email that needs to go out before the parcel lands. The SOP for the returns process your casual staff get wrong every few weeks. The customer apology after a damaged-stock complaint.

These are the tasks you do constantly, often at the end of a long day at {{businessName}}, often under some pressure. They're not hard. But they take time, they require care, and starting from a blank page has a real drag to it.

This is exactly where Claude earns its place. These tasks have something in common: they follow a pattern. A wholesale pitch has a structure. A post-purchase email has a tone. An SOP follows a format. Claude has seen enough of this writing to produce a very solid starting point — if you tell it what you actually need.

The key phrase there is "if you tell it." This lesson is about how to do that well.

### The drafting workflow: brief, draft, edit

The most effective way to use Claude for writing has three steps. It sounds obvious, but most retailers skip step one.

**Step one: Brief Claude.**

Before you ask for a draft, give Claude the context it needs. Who is this for? What's the purpose? What tone fits this customer or stockist relationship? How long should it be? What should it avoid?

A brief doesn't have to be long. It can be three sentences. But without it, Claude fills the gaps with assumptions — and those assumptions are usually wrong for your specific store.
...
This is the step most retailers get wrong. They read Claude's draft, decide it doesn't sound like the brand, and write a new version from scratch. That wastes the draft.

Your edit should fix what's wrong, not replace everything that's different. Change the phrases that sound off. Cut the sentences you'd never say. Add the detail Claude couldn't know — the actual SKU, the actual stockist's name, the specific freight carrier. Move things around if the structure's not quite right. But start from Claude's draft, not a blank page.

By the end of step three, you have something that sounds like your brand — because you edited it. That's the goal.

### Tone matching: getting Claude closer to your voice

The most common complaint about Claude's writing is that it doesn't sound like the brand that asked. This is not Claude's fault. Claude writes to the middle: reasonably professional, reasonably clear, reasonably structured. If your voice is warmer than that, or more direct, or more casual, or more poetic about the materials and the makers, Claude won't know unless you say so.

Here's how to close that gap.

**Describe your voice in concrete terms.** Not "professional" — that's too broad. Try: "Direct and warm, like a friend writing back about an order." Or: "Spare and considered — we're a small studio brand and we let the product do the talking." Or: "Casual and chatty — we're a Hobart gift shop and our customers expect us to sound like a friendly local."

**Tell Claude what to avoid.** If you hate department-store filler phrases, say so. "No phrases like 'we are pleased to announce' or 'your business means the world to us'." If you want short sentences, say so. If you never use bullet points in customer emails, say that. Claude responds to negative constraints as readily as positive ones.

**Share an example.** This is the single most effective thing you can do. Copy a paragraph from a back-in-stock email or a product description you were happy with. Paste it in. Say: "Write in the same style as this." Claude will calibrate to your example better than it will to any description of a voice.

**Name the relationship.** The tone you use with a brand-new Shopify customer is different from the tone you use with a wholesale stockist who's been reordering for two years. Tell Claude which this is. "This stockist has carried us for two years and we have an easy, informal relationship" gives Claude something real to work from.
...
**Too long.** Claude tends to expand unless you constrain it. A request for "a customer apology email" might produce something 400 words long that would strike your customer as overdone for a simple delayed parcel. Fix: set a word count or a sentence count upfront. "Keep this to 120 words" is a perfectly reasonable instruction. So is "three short paragraphs."

**Too formal.** Claude's default tone errs toward professional in a way that can feel stiff, especially for small AU brands with close customer relationships. Fix: describe what formal means for your context and be specific about where it should be warmer or more direct. The word "professional" is less useful than "the kind of email you'd send a customer who's bought from you four times before."

**Too generic.** Claude doesn't know your brand. It doesn't know your hand-thrown ceramics, your linen sourcing story, the specific scent in your candles, or the thing that makes your store different from every other Etsy seller. So when it drafts a product description, it fills in the universal description — which sounds like everyone else. Fix: give it the specifics. Tell it what's distinctive. "We're different from other homewares brands because every mug is hand-thrown in a small studio in regional Victoria — mention that." Generic output is usually a sign of a generic brief.

All three problems share a root cause: Claude doesn't have enough to work with. Give it more, and the output improves.

### Common mistake → better approach

**Mistake:** "Write me a wholesale pitch for a new stockist."

Claude produces something three pages long, in formal business language, with generic descriptions of "premium homewares" that could apply to any brand.

**Better approach:**

```
I run a small homewares brand called Saltbush & Co, based in regional Victoria. I'm writing a wholesale pitch to a residential gift boutique in Sydney — they have one shop in Paddington, owner-operator, average gift price point $50–$120. Already follows us on Instagram.

Write a wholesale pitch email (180–220 words) that:
- Introduces us in plain, warm language (we're not corporate)
- Names three of our top sellers — our hand-thrown mugs, linen tea towels, beeswax candles
- States our wholesale terms clearly (50% RRP, 6 pieces minimum per SKU, 14-day payment)
- Ends with a sentence that offers a sample box of three SKUs before they commit

Do not use the words "curated" or "thoughtfully designed" — we've banned those from our pitches.
```

The better prompt does five things: names the context, describes the stockist, sets a word count, gives specific content requirements, and adds a constraint about language. That's a brief. Claude can work with that.
...
- The writing follows a recognisable retail pattern (customer email, product description, restock alert, wholesale pitch, SOP)
...
- You need multiple versions (different lengths, different tones, different customer types)

**Write it yourself first when:**
- The message is sensitive — a difficult email to a long-time wholesale stockist, bad news about a discontinued range, or anything where the exact phrasing matters more than speed
...
- The voice is highly specific to you, {{firstName}} — something only you would say, drawing on a shared history with that customer or a private context

**The honest part:** Claude is for drafts. You are for final judgement. That split doesn't change regardless of how good the draft is. You know things Claude doesn't: the history of the relationship, the subtext, what was said last week in DMs, what this particular customer responds well to. The draft gets you 70–80% of the way there. The last 20–30% is yours.
...
You need to write three things this week: a quote follow-up to a wholesale buyer who went quiet after receiving your line sheet, a short Instagram caption about a product you just restocked, and an onboarding SOP for a new casual joining the floor.

Start with the wholesale follow-up. Brief Claude with the context — who the buyer is, how long the line sheet has been sitting, what you want to achieve (re-engage without pressure). Set the length and tone. Review the draft. Make two or three edits. Done.

Do the same for the Instagram caption — brief it properly with the product detail, the restock story, the length you want. Review, edit for your voice, done.

The SOP is slightly different. You'll probably write the content yourself — you know the steps for processing a return on Lightspeed and Shopify — and use Claude to structure and format it, or to turn your rough notes into clear step-by-step instructions. That's a different kind of drafting but the same principle: you bring the knowledge, Claude brings the structure.
