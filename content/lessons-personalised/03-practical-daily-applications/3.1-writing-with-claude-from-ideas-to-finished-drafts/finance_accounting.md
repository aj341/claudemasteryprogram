...
Think about the writing you do in a typical week at {{businessName}}. Not the technical work, not the big tax-position memos — the everyday stuff. The follow-up email after a client review meeting. The fee-proposal section explaining your process. The LinkedIn post that needs to go out on Thursday but you haven't started yet. The SOP for a BAS-prep step the junior bookkeeper gets wrong every few weeks. The client update after a lodgement is filed.

These are the tasks you do constantly, often at the end of a long day, often during a lodgement crunch. They're not hard. But they take time, they require care, and starting from a blank page has a real drag to it.

This is exactly where Claude earns its place. These tasks have something in common: they follow a pattern. A fee proposal has a structure. A client update has a tone. An SOP follows a format. Claude has seen enough of this writing to produce a very solid starting point — if you tell it what you actually need.
...
The most effective way to use Claude for writing has three steps. It sounds obvious, but most accountants skip step one.
...
A brief doesn't have to be long. It can be three sentences. But without it, Claude fills the gaps with assumptions — and those assumptions are usually wrong for your specific context (and often US-flavoured, with IRS instead of ATO).
...
Your edit should fix what's wrong, not replace everything that's different. Change the phrases that sound off. Cut the sentences you'd never say. Add the detail Claude couldn't know — the client's industry, the lodgement date, the specific outstanding item. Move things around if the structure's not quite right. But start from Claude's draft, not a blank page.
...
The most common complaint about Claude's writing is that it doesn't sound like the practitioner who asked. This is not Claude's fault. Claude writes to the middle: reasonably professional, reasonably clear, reasonably structured. If your voice is warmer than that, or more direct, or more casual, or more technical, Claude won't know unless you say so.

Here's how to close that gap.

**Describe your voice in concrete terms.** Not "professional" — that's too broad. Try: "Direct and warm, like talking to a small business owner I know well." Or: "Formal but never stiff — we're a registered tax-agent practice but we write in plain English." Or: "Casual and conversational — we're a sole-trader bookkeeping practice and our clients are tradies, not corporates."
...
**Name the relationship.** The tone you use with a new client is different from the tone you use with someone you've prepared seven years of tax returns for. Tell Claude which this is. "This client has been with us for two years and we have an easy, informal relationship" gives Claude something real to work from.
...
**Too long.** Claude tends to expand unless you constrain it. A request for "a client update email" might produce something 400 words long that would strike your time-poor cafe-owner client as unusual and slightly odd. Fix: set a word count or a sentence count upfront. "Keep this to 150 words" is a perfectly reasonable instruction. So is "three short paragraphs."

**Too formal.** Claude's default tone errs toward professional in a way that can feel stiff, especially for small AU practices with close client relationships. Fix: describe what formal means for your context and be specific about where it should be warmer or more direct. The word "professional" is less useful than "the kind of email you'd send to a client you know and like — not a Big-4 audit memo."

**Too generic.** Claude doesn't know your practice. It doesn't know your fee structure, your service philosophy, your quirks, or the specific thing that makes your work different. So when it drafts a fee proposal, it fills in the universal description — which sounds like every other accountant. Fix: give it the specifics. Tell it what's distinctive. "We're different from other accounting firms in that we do a 30-minute live quarterly review call — mention that." Generic output is usually a sign of a generic brief.

All three problems share a root cause: Claude doesn't have enough to work with. Give it more, and the output improves.

### Common mistake → better approach

**Mistake:** "Write me a fee proposal for a new client."

Claude produces something three pages long, in formal business language, with generic descriptions of services that could apply to any practice — and probably uses the word "audit" in places where AU accountants wouldn't.

**Better approach:**

```
I run a small accounting practice in Brisbane. I'm writing a fee proposal
for a new residential property investor — they want full-service compliance
across a small SMSF and three personally held investment properties. Annual
fees approximately $4,500. They're a professional couple in their 40s,
relaxed and collaborative.

Write a fee proposal introduction (100–150 words) that:
- Explains our process in plain, warm language (we're not corporate)
- Mentions that we handle everything from quarterly compliance through to
  end-of-FY tax returns — they won't be chasing multiple advisers
...
- The writing follows a recognisable pattern (BAS reminder, fee proposal, scope letter, SOP)
...
- You need multiple versions (different lengths, different tones for different client segments)

**Write it yourself first when:**
- The message is sensitive — a difficult conversation about a missed lodgement, a fee dispute, or anything where the exact phrasing matters more than speed
...
- The voice is highly specific to you — something only you would say, drawing on a shared history or private context (an inside joke with a long-term client, a reference to last quarter's planning conversation)

**The honest part:** Claude is for drafts. You are for final judgement. That split doesn't change regardless of how good the draft is. You know things Claude doesn't: the history of the relationship, the subtext, what was said last week at the planning meeting, what this particular client responds well to. The draft gets you 70–80% of the way there. The last 20–30% is yours.
...
You need to write three things this week: a fee-proposal follow-up to a client who went quiet after receiving pricing, a short LinkedIn post about a complex restructure you just helped a client through, and an onboarding SOP for a new part-time bookkeeping junior.
