...
Think about the writing you do in a typical week at {{businessName}}. Not the strategy memos, not the long product specs — the everyday stuff. The follow-up email after a customer demo. The proposal section explaining your onboarding process. The LinkedIn post that needs to go out on Thursday but you haven't started yet. The internal doc for a workflow your support team gets wrong every few weeks. The customer update after a feature ships.
...
This is exactly where Claude earns its place. These tasks have something in common: they follow a pattern. A proposal has a structure. A customer update has a tone. An internal doc follows a format. Claude has seen enough of this writing to produce a very solid starting point — if you tell it what you actually need.

The key phrase there is "if you tell it." This lesson is about how to do that well.

### The drafting workflow: brief, draft, edit

The most effective way to use Claude for writing has three steps. It sounds obvious, but most founders skip step one.

**Step one: Brief Claude.**

Before you ask for a draft, give Claude the context it needs. Who is this for? What's the purpose? What tone fits this account and relationship? How long should it be? What should it avoid?
...
Claude produces the draft. At this point, your job is not to judge it as if it were a finished, customer-ready piece. Read it as a starting point. Ask: does this have the right structure? Is the key message in there? Is the tone close?
...
Your edit should fix what's wrong, not replace everything that's different. Change the phrases that sound off. Cut the sentences you'd never say. Add the detail Claude couldn't know — the customer's last support thread, the integration they care about, the thing your CTO mentioned in last week's standup. Move things around if the structure's not quite right. But start from Claude's draft, not a blank page.
...
**Describe your voice in concrete terms.** Not "professional" — that's too broad. Try: "Direct and warm, like a founder writing to a customer who already knows us." Or: "Plain English, no SaaS jargon — our buyers are non-technical owner-operators." Or: "Casual and a bit dry — we're an indie maker brand and our customers are other indie devs."

**Tell Claude what to avoid.** If you hate corporate filler phrases, say so. "No phrases like 'we're thrilled to announce' or 'please don't hesitate to reach out'." If you want short sentences, say so. If you never use bullet points in customer emails, say that. Claude responds to negative constraints as readily as positive ones.
...
**Name the relationship.** The tone you use with a brand-new trial signup is different from the tone you use with a strategic account on year three. Tell Claude which this is. "This account has been with us for 22 months and the ops manager replies with one-line emails — we have an easy relationship" gives Claude something real to work from.
...
**Too long.** Claude tends to expand unless you constrain it. A request for "a customer update email" might produce something 400 words long that would strike your customer as unusual and slightly odd. Fix: set a word count or a sentence count upfront. "Keep this to 150 words" is a perfectly reasonable instruction. So is "three short paragraphs."

**Too formal.** Claude's default tone errs toward professional in a way that can feel stiff, especially for small SaaS teams with close customer relationships. Fix: describe what formal means for your context and be specific about where it should be warmer or more direct. The word "professional" is less useful than "the kind of email you'd send to a customer you know and like."

**Too generic.** Claude doesn't know your product. It doesn't know your pricing tiers, your support philosophy, your quirks, or the specific thing that makes your tool different. So when it drafts a proposal, it fills in the universal description — which sounds like every other SaaS pitch on the internet. Fix: give it the specifics. Tell it what's distinctive. "We're different from other rostering tools in that we do a live 30-minute weekly success call in the first month — mention that." Generic output is usually a sign of a generic brief.

All three problems share a root cause: Claude doesn't have enough to work with. Give it more, and the output improves.

### Common mistake → better approach

**Mistake:** "Write me a proposal for a new customer."

Claude produces something three pages long, in formal SaaS language, with generic descriptions of features that could apply to any vendor.

**Better approach:**

```
I run a 9-person vertical SaaS in Brisbane. I'm writing a proposal for a customer — they're a 14-clinic physio group looking to roll out our rostering and timesheet tool across all sites. Annual plan would be ~$28,000. Their COO is direct, time-poor, and has used three other rostering tools that didn't stick.

Write a proposal introduction (100–150 words) that:
- Explains our onboarding approach in plain, warm language (we're not corporate)
- Mentions that we handle the data import from their existing tool — they won't be chasing exports
- Ends with a sentence that makes them feel confident about going to a 14-site rollout

Do not use the words "best-in-class" or "transform" — we've banned those from our proposals.
```
...
- The writing follows a recognisable pattern (email, release note, proposal, social post, internal doc)
...
- The message is sensitive — an outage post-mortem, a churn-save email, a refund situation, or anything where the exact phrasing matters more than speed
...
**The honest part:** Claude is for drafts. You are for final judgement. That split doesn't change regardless of how good the draft is. You know things Claude doesn't: the history of the account, the subtext, what was said last week in a Gong call, what this particular customer responds well to. The draft gets you 70–80% of the way there. The last 20–30% is yours.
...
You need to write three things this week: a quote follow-up email to a prospect who went quiet after receiving pricing, a short LinkedIn post about a feature you just shipped, and an internal SOP for the new support hire who's starting Monday.

Start with the email. Brief Claude with the context — who the prospect is, how long the quote has been sitting, what you want to achieve (re-engage without pressure). Set the length and tone. Review the draft. Make two or three edits. Done.

Do the same for the LinkedIn post — brief it properly with the feature detail, the customer-pain point you want to land, the length you want. Review, edit for your voice, done.

The SOP is slightly different. You'll probably write the content yourself — you know the steps — and use Claude to structure and format it, or to turn your rough Loom-script notes into clear step-by-step instructions. That's a different kind of drafting but the same principle: you bring the knowledge, Claude brings the structure.
