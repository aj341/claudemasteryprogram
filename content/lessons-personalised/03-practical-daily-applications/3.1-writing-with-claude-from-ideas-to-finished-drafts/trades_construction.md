...
Think about the writing you do in a typical week, {{firstName}}. Not the big proposal for that head contractor, not the tender response — the everyday stuff. The follow-up email after a quote. The variation summary you need to send to a homeowner before the work goes ahead. The Facebook post about a job you just finished. The induction note for a new apprentice. The end-of-job wrap-up to a builder you sub-contract to.

These are the tasks you do constantly, often at the kitchen table at 8pm after a long day on site, often with one eye on tomorrow's first job. They're not hard. But they take time, they require care, and starting from a blank page has a real drag to it.

This is exactly where Claude earns its place. These tasks have something in common: they follow a pattern. A variation has a structure. A customer update has a tone. An induction note follows a format. Claude has seen enough of this writing to produce a very solid starting point — if you tell it what you actually need.
...
Before you ask for a draft, give Claude the context it needs. Who is this for? What's the purpose? What tone fits this customer and relationship? How long should it be? What should it avoid?

A brief doesn't have to be long. It can be three sentences. But without it, Claude fills the gaps with assumptions — and those assumptions are usually wrong for your specific job.
...
Your edit should fix what's wrong, not replace everything that's different. Change the phrases that sound off. Cut the sentences you'd never say to a homeowner. Add the detail Claude couldn't know — the kid's name, the dog that bit your apprentice, the spot you agreed to leave the materials. Move things around if the structure's not quite right. But start from Claude's draft, not a blank page.
...
The most common complaint about Claude's writing is that it doesn't sound like the tradie who asked. This is not Claude's fault. Claude writes to the middle: reasonably professional, reasonably clear, reasonably structured. If your voice is warmer than that, or more direct, or more casual, or more technical, Claude won't know unless you say so.

Here's how to close that gap.

**Describe your voice in concrete terms.** Not "professional" — that's too broad. Try: "Direct and warm, like talking to a customer I've worked with twice before." Or: "Plain English, no electrical jargon — we're a residential sparkie business and our customers are homeowners, not engineers." Or: "Casual but not sloppy — we're an outer-suburbs plumber and most clients call us by first name."

**Tell Claude what to avoid.** If you hate corporate filler phrases, say so. "No phrases like 'I hope this email finds you well' or 'please don't hesitate to reach out'." If you want short sentences, say so. If you never use bullet points in customer emails, say that. Claude responds to negative constraints as readily as positive ones.

**Share an example.** This is the single most effective thing you can do. Copy a paragraph from an email you've sent that you were happy with — a quote follow-up, an end-of-job wrap, whatever. Paste it in. Say: "Write in the same style as this." Claude will calibrate to your example better than it will to any description of a voice.

**Name the relationship.** The tone you use with a new homeowner is different from the tone you use with a builder you've worked with for three years. Tell Claude which this is. "This builder has been sub-contracting work to me for two years and we have an easy, informal relationship" gives Claude something real to work from.
...
**Too long.** Claude tends to expand unless you constrain it. A request for "a customer update email" might produce something 400 words long that would strike a homeowner as unusual and slightly odd. Fix: set a word count or a sentence count upfront. "Keep this to 150 words" is a perfectly reasonable instruction. So is "three short paragraphs."

**Too formal.** Claude's default tone errs toward professional in a way that can feel stiff, especially for trades businesses where customers expect to hear from a real person, not a corporate template. Fix: describe what formal means for your context and be specific about where it should be warmer or more direct. The word "professional" is less useful than "the kind of email you'd send to a homeowner you've already done two jobs for and like."

**Too generic.** Claude doesn't know {{businessName}}. It doesn't know your pricing approach, your approach to call-backs, your quirks, or the specific thing that makes your work different. So when it drafts a quote letter, it fills in the universal description — which sounds like every other sparkie or chippy on the street. Fix: give it the specifics. Tell it what's distinctive. "We're different from other electrical businesses around here because we always send a same-day photo of the completed work — mention that." Generic output is usually a sign of a generic brief.

All three problems share a root cause: Claude doesn't have enough to work with. Give it more, and the output improves.

### Common mistake → better approach

**Mistake:** "Write me a quote letter for a new customer."

Claude produces something three pages long, in formal business language, with generic descriptions of services that could apply to any trades business.

**Better approach:**

```
I run a 4-person residential electrical business in outer Brisbane. I'm writing a quote cover letter for a homeowner — they want a switchboard upgrade and 12 downlights swapped to LED across the living areas. Quote total is $4,800 plus GST. They're a young couple, first home, relaxed and easy to deal with.

Write a quote cover letter (100–150 words) that:
- Explains how we'll run the job in plain, warm language (we're not corporate)
- Mentions that the compliance certificate is included and we always send photos when the job's done — they won't be left wondering
- Ends with a sentence that makes them feel confident about saying yes

Do not use the words "premium" or "tailored" — we've banned those from our quotes.
```

The better prompt does five things: names the context, describes the customer, sets a word count, gives specific content requirements, and adds a constraint about language. That's a brief. Claude can work with that.
...
- The writing follows a recognisable pattern (quote follow-up, customer update, social post, induction note)
...
- You need multiple versions (different lengths, different tones, different audiences — homeowner vs builder vs strata manager)

**Write it yourself first when:**
- The message is sensitive — a defect liability conversation, a rejected variation, bad news on a delay, or anything where the exact phrasing matters more than speed
...
- The voice is highly specific to you — something only you would say, drawing on a shared history with this customer or builder

**The honest part:** Claude is for drafts. You are for final judgement. That split doesn't change regardless of how good the draft is. You know things Claude doesn't: the history with this customer, the dodgy variation request the builder tried last month, what was said on site Tuesday, what this particular homeowner responds well to. The draft gets you 70–80% of the way there. The last 20–30% is yours.
...
You need to write three things this week: a quote follow-up email to a homeowner who went quiet after receiving pricing, a short Facebook post about a re-wire job you just finished, and an induction note for the apprentice starting Monday.

Start with the email. Brief Claude with the context — who the homeowner is, how long the quote has been sitting, what you want to achieve (re-engage without pressure). Set the length and tone. Review the draft. Make two or three edits. Done.

Do the same for the Facebook post — brief it properly with the project detail, the point you want to make, the length you want. Review, edit for your voice, done.

The induction note is slightly different. You'll probably write the content yourself — you know the steps, the safety basics, where the gear lives — and use Claude to structure and format it, or to turn your rough notes into clear step-by-step instructions. That's a different kind of drafting but the same principle: you bring the knowledge, Claude brings the structure.

Three pieces of writing, probably 45 minutes total if you're working efficiently. Without Claude and this workflow, that's three separate blank-page starts across your week, each with its own drag — and most of it landing at 9pm when you'd rather be on the couch.
