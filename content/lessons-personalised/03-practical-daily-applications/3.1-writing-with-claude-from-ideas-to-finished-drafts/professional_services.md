...
Think about the writing you do in a typical week at {{businessName}}. Not the deep technical work, not the big strategic memos — the everyday stuff. The follow-up email after a client discovery meeting. The proposal section explaining your engagement approach. The LinkedIn post that needs to go out on Thursday but you haven't started yet. The SOP for a status-update step a junior consultant gets wrong every few weeks. The client update after a deliverable is signed off.

These are the tasks you do constantly, often at the end of a long billable day, often during a tight project crunch. They're not hard. But they take time, they require care, and starting from a blank page has a real drag to it.

This is exactly where Claude earns its place. These tasks have something in common: they follow a pattern. A scope of work has a structure. A client update has a tone. An SOP follows a format. Claude has seen enough of this writing to produce a very solid starting point — if you tell it what you actually need.
...
The most effective way to use Claude for writing has three steps. It sounds obvious, but most consultants skip step one.

**Step one: Brief Claude.**

Before you ask for a draft, give Claude the context it needs. Who is this for? What's the purpose? What tone fits this client and relationship? How long should it be? What should it avoid?

A brief doesn't have to be long. It can be three sentences. But without it, Claude fills the gaps with assumptions — and those assumptions are usually wrong for your specific context (and often Big-4-flavoured, with workstream owners and practice leadership).
...
Your edit should fix what's wrong, not replace everything that's different. Change the phrases that sound off. Cut the sentences you'd never say. Add the detail Claude couldn't know — the client's industry, the deliverable date, the specific outstanding action. Move things around if the structure's not quite right. But start from Claude's draft, not a blank page.
...
The most common complaint about Claude's writing is that it doesn't sound like the consultant who asked. This is not Claude's fault. Claude writes to the middle: reasonably professional, reasonably clear, reasonably structured. If your voice is warmer than that, or more direct, or more casual, or more technical, Claude won't know unless you say so.

Here's how to close that gap.

**Describe your voice in concrete terms.** Not "professional" — that's too broad. Try: "Direct and warm, like talking to an operations manager I've worked with for years." Or: "Formal but never stiff — we're a management consultancy but we write in plain English." Or: "Casual and conversational — we're a small IT support firm and our clients are time-poor business owners, not CIOs."

**Tell Claude what to avoid.** If you hate corporate filler phrases, say so. "No phrases like 'I hope this email finds you well' or 'please don't hesitate to reach out'." If you want short sentences, say so. If you never use bullet points in client emails, say that. Claude responds to negative constraints as readily as positive ones.

**Share an example.** This is the single most effective thing you can do. Copy a paragraph from an email you've sent to a client that you were happy with. Paste it in. Say: "Write in the same style as this." Claude will calibrate to your example better than it will to any description of a voice.

**Name the relationship.** The tone you use with a new client is different from the tone you use with someone you've delivered five engagements for. Tell Claude which this is. "This client has been with us for two years and we have an easy, informal relationship" gives Claude something real to work from.
...
**Too long.** Claude tends to expand unless you constrain it. A request for "a client update email" might produce something 400 words long that would strike your time-poor operations director as unusual and slightly odd. Fix: set a word count or a sentence count upfront. "Keep this to 150 words" is a perfectly reasonable instruction. So is "three short paragraphs."

**Too formal.** Claude's default tone errs toward professional in a way that can feel stiff, especially for small AU/NZ consultancies with close client relationships. Fix: describe what formal means for your context and be specific about where it should be warmer or more direct. The word "professional" is less useful than "the kind of email you'd send to a client you know and like — not a Big-4 board paper."

**Too generic.** Claude doesn't know your firm. It doesn't know your engagement model, your delivery philosophy, your quirks, or the specific thing that makes your work different. So when it drafts a scope of work, it fills in the universal description — which sounds like every other consultant. Fix: give it the specifics. Tell it what's distinctive. "We're different from other HR consultancies in that we run a 30-minute fortnightly check-in with the GM throughout the engagement — mention that." Generic output is usually a sign of a generic brief.

All three problems share a root cause: Claude doesn't have enough to work with. Give it more, and the output improves.

### Common mistake → better approach

**Mistake:** "Write me a scope of work for a new client."

Claude produces something three pages long, in formal business language, with generic descriptions of services that could apply to any firm — and probably uses Big-4 phrasing like "workstream lead" in places where a small AU consultancy wouldn't.

**Better approach:**

```
I run a small management consultancy in Brisbane. I'm writing a scope of
work for a new mid-sized logistics client — they want help redesigning
their warehouse operations process. Engagement fee approximately $28,000
across eight weeks. The decision-makers are the GM and the operations
director — practical, time-poor, not corporate.

Write a scope of work introduction (100–150 words) that:
- Explains our approach in plain, warm language (we're not corporate)
- Mentions that we run the discovery, design and rollout ourselves —
  they won't be handed off to a junior team
- Ends with a sentence that makes them feel confident about engaging us
...
- The writing follows a recognisable pattern (status update, scope of work, engagement letter, SOP)
...
- You need multiple versions (different lengths, different tones for different client stakeholders)

**Write it yourself first when:**
- The message is sensitive — a difficult conversation about a missed deliverable, a fee dispute, or anything where the exact phrasing matters more than speed
...
- The voice is highly specific to you — something only you would say, drawing on a shared history or private context (a running reference with a long-term client, a callback to a steering committee conversation)

**The honest part:** Claude is for drafts. You are for final judgement. That split doesn't change regardless of how good the draft is. You know things Claude doesn't: the history of the relationship, the subtext, what was said last week at the project meeting, what this particular client responds well to. The draft gets you 70–80% of the way there. The last 20–30% is yours.
...
You need to write three things this week: a quote follow-up to a client who went quiet after receiving an engagement proposal, a short LinkedIn post about a process redesign you just delivered, and an onboarding SOP for a new part-time analyst.

Start with the email. Brief Claude with the context — who the client is, how long the proposal has been sitting, what you want to achieve (re-engage without pressure). Set the length and tone. Review the draft. Make two or three edits. Done.

Do the same for the LinkedIn post — brief it properly with the engagement detail (anonymised), the point you want to make, the length you want. Review, edit for your voice, done.

The SOP is slightly different. You'll probably write the content yourself — you know the steps — and use Claude to structure and format it, or to turn your rough notes into clear step-by-step instructions. That's a different kind of drafting but the same principle: you bring the firm knowledge, Claude brings the structure.
