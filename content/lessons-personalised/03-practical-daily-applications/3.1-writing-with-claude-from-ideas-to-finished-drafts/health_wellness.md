...
```
I'm {{firstName}}, and I run a small allied health clinic in Brisbane called {{businessName}}. I'm writing a treatment-plan summary for a self-funded client — they want a structured 6-week plan to address recurring lower-back pain that flares with desk work. Indicative gap fees are around $480 across the program. They're a professional couple in their 40s, busy and collaborative.

Write a treatment-plan introduction (100–150 words) that:
- Explains our assessment-and-progress process in plain, warm language (we're not clinical-textbook)
- Mentions that we handle everything from initial screen through to a 30-day self-management review — they won't be chasing different providers
- Ends with a sentence that makes them feel confident about starting

Do not use the words "bespoke" or "holistic wellness journey" — we've banned those from our plans.
```
...
{{firstName}} needs to write three things this week: a follow-up email to a client who went quiet after receiving a treatment-plan estimate, a short LinkedIn post about a recent rehab case, and an onboarding SOP for a new part-time front-desk staff member.
