...
Think about the writing you do in a typical week at {{businessName}}. Not the auction speeches, not the strategic vendor presentations — the everyday stuff. The vendor update after a Saturday open home. The proposal section explaining your campaign approach. The social tile for the Thursday boost that you haven't started yet. The SOP for a leasing task your PMs get wrong every few weeks. The owner update after a settlement.

These are the tasks you do constantly, often after a long day of OFIs and listing presentations, often under some pressure. They are not hard. But they take time, they require care, and starting from a blank page has a real drag to it.

This is exactly where Claude earns its place. These tasks have something in common: they follow a pattern. A vendor report has a structure. A tenant arrears letter has a tone. A leasing SOP follows a format. Claude has seen enough of this kind of writing to produce a very solid starting point — if you tell it what you actually need.

The key phrase there is "if you tell it." This lesson is about how to do that well, {{firstName}}.

### The drafting workflow: brief, draft, edit

The most effective way to use Claude for writing has three steps. It sounds obvious, but most agents skip step one.

**Step one: Brief Claude.**

Before you ask for a draft, give Claude the context it needs. Who is this for — a vendor, a tenant, a buyer, an owner? What's the purpose? What tone fits this person and relationship? How long should it be? What should it avoid?
...
Claude produces the draft. At this point, your job is not to judge it as if it were the final email going to your top vendor. Read it as a starting point. Ask: does this have the right structure? Is the key message in there — the open home numbers, the offer position, the buyer feedback? Is the tone close?
...
Your edit should fix what's wrong, not replace everything that's different. Change the phrases that sound off. Cut the sentences you'd never say. Add the detail Claude couldn't know — the buyer who asked for a second inspection, the price guide you discussed with the vendor on Friday. Move things around if the structure isn't quite right. But start from Claude's draft, not a blank page.
...
The most common complaint from agents is that Claude's writing doesn't sound like them. That's not Claude's fault. Claude writes to the middle: reasonably professional, reasonably clear, reasonably structured. If your voice is warmer than that, or more direct, or more casual than your average corporate franchise, Claude won't know unless you say so.

Here's how to close that gap.

**Describe your voice in concrete terms.** Not "professional" — that's too broad. Try: "Direct and warm, like talking to a vendor I've known for two campaigns." Or: "Plain English — we're a regional agency, not a Sydney CBD office, and our owners are local tradies and retirees." Or: "Confident but never pushy — we're a buyer's agency and our clients are paying us to filter the noise."

**Tell Claude what to avoid.** If you hate property cliches, say so. "No phrases like 'don't miss this opportunity' or 'priced to sell'." If you want short sentences in vendor updates, say so. If you never use bullet points in tenant correspondence, say that. Claude responds to negative constraints as readily as positive ones.

**Share an example.** This is the single most effective thing you can do. Copy a paragraph from a vendor update you sent that you were happy with. Paste it in. Say: "Write in the same style as this." Claude will calibrate to your example better than it will to any description of voice.

**Name the relationship.** The tone you use with a new vendor on a fresh listing is different from the tone you use with an owner whose third investment property you've leased. Tell Claude which this is. "This vendor has been with us through two campaigns and we have an easy, informal relationship" gives Claude something real to work from.

### The "too long, too formal, too generic" trap

If you've used Claude for property writing before and felt underwhelmed, there's a good chance you hit one of three patterns. They're common enough to name.

**Too long.** Claude tends to expand unless you constrain it. A request for "a vendor update after the first open home" might produce something 400 words long that would strike your vendor as unusual and slightly odd. Fix: set a word count or a sentence count upfront. "Keep this to 150 words" is a perfectly reasonable instruction. So is "three short paragraphs."

**Too formal.** Claude's default tone errs toward professional in a way that can feel stiff, especially for agencies with close vendor relationships. Fix: describe what formal means for your context and be specific about where it should be warmer or more direct. The word "professional" is less useful than "the kind of update you'd send to a vendor you know and like."

**Too generic.** Claude doesn't know your agency. It doesn't know your fee structure, your auction philosophy, your area, or the specific thing that makes your service different. So when it drafts a listing presentation paragraph, it fills in the universal description — which sounds like every other agency in the suburb. Fix: give it the specifics. Tell it what's distinctive. "We're different from other agencies in this area in that we hold mid-week twilight inspections for working buyers — mention that." Generic output is usually a sign of a generic brief.

All three problems share a root cause: Claude doesn't have enough to work with. Give it more, and the output improves.

### Common mistake → better approach

**Mistake:** "Write me a listing presentation intro for a new vendor."

Claude produces something three pages long, in formal corporate language, with generic descriptions of services that could apply to any agency in Australia.

**Better approach:**

```
I run a 10-person regional NSW agency. I'm writing a listing presentation
intro for a vendor — a retired couple selling the family home of 28
years on a 1,200sqm block in a sought-after street. Likely price range
$1.4M–$1.55M, recommending an auction campaign with a 4-week lead-up.

Write a presentation intro (100–150 words) that:
- Acknowledges this isn't just a transaction — it's the home they raised
  their kids in, and we get that
- Mentions our local database of 800+ buyers actively looking in this
  pocket — they won't be relying on portal traffic alone
- Ends with a sentence that makes them feel confident we'll get the
  campaign right

Do not use the words "bespoke" or "tailored" — we've banned those from
all our listing presentations.
```

The better prompt does five things: names the context, describes the vendor, sets a word count, gives specific content requirements, and adds a constraint about language. That is a brief. Claude can work with that.
...
- The writing follows a recognisable pattern (vendor update, owner report, listing copy, prospecting email, lease renewal letter)
...
- The stakes are moderate — a good draft you review and edit is sufficient
- You need multiple versions (different lengths for vendor versus owner, different tones for an investor versus an owner-occupier)

**Write it yourself first when:**
- The message is sensitive — a difficult conversation about an unrealistic price expectation, a tenant being given notice, a campaign that hasn't performed and the vendor needs to hear it straight
...
- The voice is highly specific to you — a private joke with a long-term vendor, a reference to a previous deal only the two of you remember

**The honest part:** Claude is for drafts. You are for final judgement. That split doesn't change regardless of how good the draft is. You know things Claude doesn't: the history with that vendor, the subtext, what was said at the appraisal last month, what this particular owner responds well to. The draft gets you 70 to 80 per cent of the way there. The last 20 to 30 per cent is yours.
...
You need to write three things this week: a follow-up email to a vendor whose campaign feedback has been quiet since the price reduction conversation, a short LinkedIn post about a result you just achieved, and an onboarding SOP for a new BDM joining the rent roll team.

Start with the vendor email. Brief Claude with the context — who the vendor is, the campaign so far, what you want to achieve (re-engage and frame this week's strategy without sounding defensive). Set the length and tone. Review the draft. Make two or three edits. Done.

Do the same for the LinkedIn post — brief it properly with the property detail, the result, the angle you want to make. Review, edit for your voice, done.

The SOP is slightly different. You'll probably write the content yourself — you know the steps a BDM takes from listing a rental through to first inspection — and use Claude to structure and format it, or to turn your rough notes into clear step-by-step instructions. That's a different kind of drafting but the same principle: you bring the knowledge, Claude brings the structure.
