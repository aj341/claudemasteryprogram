...
Most of the time, learning something for your retail business is inconvenient. You need to understand a clause in a wholesale exclusivity agreement before you sign it. You need to know what "30 days net" really means before you accept a supplier's payment terms. You need to understand how the ATO's GST rules apply to imported stock before your accountant calls. But the accountant is booked until Thursday, the lawyer charges by the hour, and Google gives you seventeen tabs of partially relevant content that each lead to three more tabs.
...
This is not a small thing. For small retailers in particular, the gaps between what you know and what you need to know to make a decision are constant. Claude doesn't close all of them — but it closes far more than most retailers realise, because they haven't thought about it as a learning tool yet.

This lesson is about that. Specifically: how to get explanations that are actually calibrated to you, how to follow up in a way that turns explanation into understanding, and how to use Claude for the highest-value learning task most retailers never think to try — understanding documents you need to act on.
...
"Simply" is relative. To a primary school teacher, "simply" means stripping out all the technical vocabulary. To an experienced Etsy seller asking about superannuation laws, "simply" might mean assuming basic financial literacy. To a homewares brand owner asking about trademark law, "simply" might mean explaining what a trademark actually is before getting to anything else. Claude can't read your mind. "Simply" gives it no anchor.
...
For example: "Explain this to me like I'm a smart non-expert in this area. I understand basic Shopify accounting and how my POS reports tally with my Xero, but I've never read a commercial retail lease before." Or: "Explain this to me like I'm a smart non-expert in this area. I understand how Meta Ads work broadly, but I've never set up a catalogue sales campaign for a Shopify product feed before."
...
This is a phrase worth saving, {{firstName}}. It works across almost every learning context.
...
Explanations work in the abstract. Examples show you what something actually looks like in practice. If Claude explains what a "minimum order quantity" clause is in a wholesale agreement, ask it to show you what one looks like, how it typically gets enforced, and what a small brand should watch for. If Claude explains what "tariff classification" means for your imported stock, ask it to show you the numbers on a specific SKU you import. Abstract understanding doesn't survive contact with reality unless you've tested it with an example first.

**"What's the part people get wrong about this?"**

This question does something most explanations don't do on their own: it tells you where the traps are. Every concept has a common misunderstanding attached to it — a way that retailers who've half-learned it tend to apply it incorrectly. If you know the common mistake upfront, you can avoid it. You can also check whether you've been making it already.
...
"Can you explain GST to me?" Claude produces a comprehensive explanation starting from scratch — what GST is, how it works in Australia, how to register. You already know all of that. What you needed was an explanation of how GST applies to the imported homewares stock you're about to land at port.

**Better approach:** Anchor the explanation to what you already know and what you need.

"I understand how GST works for standard Shopify sales — we charge it, BAS picks it up. What I'm not clear on is how it applies when I'm importing stock from a Vietnamese supplier — specifically, GST on the landed value at the border versus GST when I sell the finished product. Can you explain how a small importer should think about GST on imported stock and what shows up on which side of the BAS?"
...
This is the use case most retailers don't think of until someone suggests it — and then they use it constantly.

You receive documents all the time that you need to understand before you can act on them. Commercial retail leases. Wholesale agreements. Distribution contracts. ATO correspondence. Public liability insurance policies. Council compliance notices. Freight carrier contracts. These documents are written for lawyers or regulators, not for retail owners. They contain specific terms, clauses, and cross-references that are impenetrable if you don't already know the field.
...
```
I'm a [your retail type] in [location]. I've received [type of document] and need to understand it before I [sign it / respond to it / meet with my accountant about it].
...
This prompt pattern is repeatable. You can use it for any document. Paste the section you don't understand — not the whole document — and ask for those four things. You don't need to understand the whole lease before you can ask a good question. You just need to know which part is confusing you.
...
For example: "I need to understand this well enough to complete the merchant fees section of my BAS. Please focus only on what's relevant to that — don't give me background on the broader tax system."

Or: "I need to understand this well enough to decide whether to sign a personal guarantee clause in a five-year retail lease for our second store. Please focus on the practical implications and the questions I should ask my lawyer — not the general law around guarantees."

The action frame does three things. It tells Claude what level of detail you need. It tells Claude what to exclude. And it gives Claude a test it can apply: does this information help the retailer take the specific action? If not, leave it out.
