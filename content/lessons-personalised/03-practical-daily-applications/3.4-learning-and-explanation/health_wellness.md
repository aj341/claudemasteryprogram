...
For example: "Explain this to me like I'm a smart non-expert in this area. I understand basic clinical practice, but I've never read a commercial lease for a treatment-room space before." Or: "Explain this to me like I'm a smart non-expert in this area. I understand how Medicare EPC referrals work broadly, but I've never looked at the chronic-disease item-number rules before."
...
"Can you explain GST to me?" Claude produces a comprehensive explanation starting from scratch — what GST is, how it works in Australia, how to register. {{firstName}} already knows all of that. What you needed was an explanation of how GST applies to the mixed-supply transaction in your current corporate-wellness contract.

**Better approach:** Anchor the explanation to what you already know and what you need.

"I understand how GST works for standard service fees. What I'm not clear on is how it applies when a contract includes a mix of GST-free health services and taxable consumables — specifically, I'm looking at a corporate-wellness contract that includes both physiotherapy assessments and resold ergonomic equipment. Can you explain how a practice should calculate and report GST on a mixed-supply transaction like this?"
...
For example: "I need to understand this well enough to complete the business income section of {{businessName}}'s tax return. Please focus only on what's relevant to that — don't give me background on the broader tax system."

Or: "I need to understand this well enough to decide whether to sign a personal guarantee clause in a commercial lease for new clinic rooms. Please focus on the practical implications and the questions I should ask my lawyer — not the general law around guarantees."
