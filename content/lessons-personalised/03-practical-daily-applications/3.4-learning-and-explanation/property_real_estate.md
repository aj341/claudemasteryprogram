...
Most of the time, learning something for your agency is inconvenient. You need to understand a special condition in a contract before you advise the vendor to sign. You need to know what "joint and several liability" means before you accept a co-tenancy application. You need to understand how the latest NSW residential tenancies amendments apply to your existing leases before your principal asks. But the conveyancer is in court until Thursday, the lawyer charges by the hour, and Google gives you seventeen tabs of partially relevant content that each lead to three more tabs.

Claude is available right now. It will answer your question at the level you need, without charging by the hour, without making you feel like you should already know this, and without giving you a 900-word REIA article when you needed a two-minute answer.

This is not a small thing. For agency principals and PMs in particular, the gaps between what you know and what you need to know to make a decision are constant. Claude doesn't close all of them — but it closes far more than most people realise, because they haven't thought about it as a learning tool yet.

This lesson is about that. Specifically: how to get explanations that are actually calibrated to you, how to follow up in a way that turns explanation into understanding, and how to use Claude for the highest-value learning task most agency owners never think to try — understanding documents you need to act on.
...
"Simply" is relative. To a primary school teacher, "simply" means stripping out all the technical vocabulary. To a seasoned auctioneer asking about strata insurance, "simply" might mean assuming a reasonable property baseline. To a new BDM asking about NCAT bond claim processes, "simply" might mean explaining what NCAT actually is before getting to anything else. Claude can't read your mind. "Simply" gives it no anchor.
...
For example: "Explain this to me like I'm a smart non-expert in this area. I understand residential sales contracts, but I've never read a commercial lease before." Or: "Explain this to me like I'm a smart non-expert in this area. I understand how a standard strata levy works, but I've never looked at a special levy proposal in detail."

That phrase — "smart non-expert" — does specific work. It tells Claude not to explain what a property is, or what a vendor is, or what a dollar is. You're not a beginner at life. You're a beginner at this specific topic. Claude should pitch the explanation accordingly: no condescension, no assumption that you know the jargon, but also no padding that assumes you can't handle a real explanation.

This is a phrase worth saving. It works across almost every learning context.

### The follow-up question habit

The first explanation Claude gives you is the start, not the end. A good first explanation gives you the framework. The follow-up questions are what turn that framework into something you can actually use, {{firstName}}.
...
Explanations work in the abstract. Examples show you what something actually looks like in practice. If Claude explains what a "subject to finance" condition is in a sale contract, ask it to show you what one typically looks like, how it gets activated, and what a vendor's agent should watch for. If Claude explains what "diminution of value" means in a tenant damage claim, ask it to show you the figures on a hypothetical kitchen damage scenario. Abstract understanding doesn't survive contact with reality unless you've tested it with an example first.

**"What's the part people get wrong about this?"**

This question does something most explanations don't do on their own: it tells you where the traps are. Every concept has a common misunderstanding attached to it — a way that people who've half-learned it tend to apply it incorrectly. If you know the common mistake upfront, you can avoid it. You can also check whether you've been making it already in how you explain things to vendors or owners.
...
"Can you explain GST on commercial property to me?" Claude produces a comprehensive explanation starting from scratch — what GST is, how it works in Australia, how to register. You already know all of that. What you needed was an explanation of how GST applies to the mixed-use property settlement in your current contract.

**Better approach:** Anchor the explanation to what you already know and what you need.

"I understand how GST works on standard commercial sales — that the going concern exemption applies if specific tests are met. What I'm not clear on is how GST applies when a property has a mixed use — partly leased to a commercial tenant and partly owner-occupied as a residential dwelling. Can you explain how GST should be calculated and reported on a mixed-use settlement like this?"
...
This is the use case most agency principals don't think of until someone suggests it — and then they use it constantly.

You receive documents all the time that you need to understand before you can act on them. Sale contracts with negotiated special conditions. Lease agreements drafted by a tenant's solicitor. Strata reports for properties you're pitching. Building inspection reports. Owners corp minutes. Body corporate notices. Council DA correspondence on a development site. These documents are written for lawyers and town planners, not for agents. They contain specific terms, clauses, and cross-references that are impenetrable if you don't already know the field.

Claude can read them and explain them to you. Not replace your conveyancer or your agency's legal panel — that's not the claim here. But explain what a clause means, flag what questions you should be asking your lawyer or the other side, and tell you what the key terms are before you walk into a negotiation about it.

The prompt pattern for document understanding looks like this:

```
I'm a [your agency type] in [location]. I've received [type of document] and need to understand it before I [advise the vendor / respond to the buyer's solicitor / sit down with the owner].

I'm going to paste the relevant section below. Please:
1. Explain what this section means in plain language
2. Tell me what obligations or risks it places on my client specifically
3. Flag anything that seems unusual, restrictive, or worth getting professional advice on
4. Tell me what questions I should be asking before this is agreed to

[paste the clause or section]
```

This prompt pattern is repeatable. You can use it for any document. Paste the section you don't understand — not the whole contract — and ask for those four things. You don't need to understand the entire document before you can ask a good question. You just need to know which part is confusing you.

One important note: Claude's explanation is a starting point, not legal advice. Use it to get literate enough to have a better conversation with your conveyancer or solicitor. Use it to know which questions to ask. Do not use it as a substitute for professional advice on anything a client is about to sign.
...
Learning for interest is open-ended. You want to understand how something works, broadly. The answer can be comprehensive, exploratory, even a little discursive. Reading about how foreign investment review board approvals affect the Australian housing market over the long run is interesting reading.

Learning for action is specific. You need to understand exactly what you need to know to make a decision, complete a form, have a conversation, or take a step. Nothing more than that. Extra information isn't neutral — it uses up your attention and makes the thing you actually need to know harder to find.
...
For example: "I need to understand this well enough to fill in the disclosure section of a Section 32 vendor statement in Victoria. Please focus only on what's relevant to that — don't give me background on the broader sale of land legislation."

Or: "I need to understand this well enough to advise an owner about whether to sign a personal guarantee on the bank's loan for an investment property purchase. Please focus on the practical implications and the questions I should suggest they raise with their broker — not the general law around guarantees."

The action frame does three things. It tells Claude what level of detail you need. It tells Claude what to exclude. And it gives Claude a test it can apply: does this information help the agent take the specific action? If not, leave it out.

This makes a meaningful difference in the output. Focused explanations are faster to read and more likely to stick. You're not learning a subject — you're learning what you need to do the next thing for {{businessName}}.
...
This is not a formula you have to follow rigidly. It's a checklist for the components that make learning conversations with Claude actually useful. Level, prior knowledge, action orientation, example, common mistake. Cover those five and you'll get explanations that are worth more than most paid CPD courses on the same topic.
