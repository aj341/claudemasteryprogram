...
Most of the time, learning something for your practice is inconvenient. You need to understand a Div 7A nuance before you advise the client on Tuesday. You need to know what "ipso facto" means before you read the next clause of a client's lease. You need to understand how the ATO's Single Touch Payroll Phase 2 rules apply to closely held employees before your meeting tomorrow. But the senior tax partner is in a planning workshop, the firm's external lawyer charges by the six-minute unit, and Google gives you seventeen tabs of partially relevant content that each lead to three more tabs.
...
This is not a small thing. For accountants and bookkeepers in particular, the gaps between what you know and what you need to know to advise a client are constant. Claude doesn't close all of them — but it closes far more than most practitioners realise, because they haven't thought about it as a learning tool yet.

This lesson is about that, {{firstName}}. Specifically: how to get explanations that are actually calibrated to you, how to follow up in a way that turns explanation into understanding, and how to use Claude for the highest-value learning task most accountants never think to try — understanding documents your clients hand you.
...
"Simply" is relative. To a secondary school teacher, "simply" means stripping out all the technical vocabulary. To an experienced bookkeeper asking about superannuation guarantee laws, "simply" might mean assuming basic compliance literacy. To a registered tax agent asking about the latest IFRS standard, "simply" might mean explaining what a recognition criterion actually is before getting to anything else. Claude can't read your mind. "Simply" gives it no anchor.

The fix is one sentence. Use this instead:

```
Explain this to me like I'm a smart non-expert in this area. I understand
[one thing you do know], but I haven't [the thing you haven't done or studied].
```

For example: "Explain this to me like I'm a smart non-expert in this area. I understand basic Div 7A loans, but I've never advised on a UPE (unpaid present entitlement) before." Or: "Explain this to me like I'm a smart non-expert in this area. I understand standard payroll, but I've never set up STP Phase 2 for a closely held payee."

That phrase — "smart non-expert" — does specific work. It tells Claude not to explain what an ABN is, or what a tax return is, or what a dollar is. You're not a beginner at life. You're a beginner at this specific topic. Claude should pitch the explanation accordingly: no condescension, no assumption that you know the jargon, but also no padding that assumes you can't handle a real explanation.

This is a phrase worth saving. It works across almost every learning context.

### The follow-up question habit

The first explanation Claude gives you is the start, not the end. A good first explanation gives you the framework. The follow-up questions are what turn that framework into something you can actually use with a client.
...
Explanations work in the abstract. Examples show you what something actually looks like in practice. If Claude explains what a "small business CGT concession" looks like, ask it to show you what a worked example looks like with sample numbers, how the active asset test typically gets applied, and what a tax agent should watch for. If Claude explains what "permanent vs temporary differences" means in deferred tax, ask it to show you the numbers on a specific provision. Abstract understanding doesn't survive contact with a client file unless you've tested it with an example first.

**"What's the part people get wrong about this?"**

This question does something most explanations don't do on their own: it tells you where the traps are. Every tax or accounting concept has a common misunderstanding attached to it — a way that practitioners who've half-learned it tend to apply it incorrectly. If you know the common mistake upfront, you can avoid it. You can also check whether you've been making it already on existing client files.

These two questions can turn a four-minute explanation into a ten-minute one. That's a good trade. You're not just collecting information — you're testing your understanding and pre-empting the errors before they show up in a working paper.

### Common mistake → better approach

**Mistake:** Asking Claude to explain something without telling it what you already know.

"Can you explain GST to me?" Claude produces a comprehensive explanation starting from scratch — what GST is, how it works in Australia, how to register. You already know all of that — you process BAS every quarter. What you needed was an explanation of how GST applies to the mixed-supply transaction in the catering client's contract.

**Better approach:** Anchor the explanation to what you already know and what you need.

"I'm a registered BAS agent. I understand how GST works for standard product sales and standard service supplies. What I'm not clear on is how it applies when a contract includes a mix of taxable and GST-free items — specifically, I'm looking at a catering client's contract that includes both prepared food (taxable) and basic unprocessed ingredients (GST-free). Can you explain how the supplier should calculate and report GST on a mixed-supply transaction like this?"

Now Claude starts at the right level. It skips the basics you've already got and goes directly to the thing you actually need to understand for the client file.

### Using Claude to understand documents you need to act on

This is the use case most accountants don't think of until someone suggests it — and then they use it constantly.

Clients send you documents all the time that you need to understand before you can advise them. Commercial leases. Loan agreements. Shareholder agreements. ATO position papers. Business insurance schedules. Trust deeds. Contractor agreements. These documents are written for lawyers or regulators, not for accountants. They contain specific terms, clauses, and cross-references that are impenetrable if you don't already know the legal field they sit in.

Claude can read them and explain them to you. Not replace your firm's external lawyer — that's not the claim here. But explain what a clause means, flag what questions you should be asking the lawyer or the client, and tell you what the key terms are before you walk into a meeting about it.

The prompt pattern for document understanding looks like this:

```
I'm a [your role — accountant / BAS agent / financial planner / mortgage broker]
in [location]. A client has handed me [type of document] and I need to understand
it before I [advise them / write the file note / draft the engagement extension].

I'm going to paste the relevant section below. Please:
1. Explain what this section means in plain language
2. Tell me what obligations it places on the client specifically
3. Flag anything that seems unusual, restrictive, or worth getting legal advice on
4. Tell me what questions I should be asking before I advise

[paste the clause or section]
```

This prompt pattern is repeatable. You can use it for any document. Paste the section you don't understand — not the whole document — and ask for those four things. You don't need to understand the whole trust deed before you can ask a good question. You just need to know which part is confusing you.

One important note: Claude's explanation is a starting point, not a legal opinion. Use it to get literate enough to have a better conversation with the client and the firm's lawyer. Use it to know which questions to ask. Do not use it as a substitute for professional advice on anything that's about to be lodged or signed.
...
Learning for action is specific. You need to understand exactly what you need to know to make a decision, complete a working paper, have a client conversation, or lodge a return. Nothing more than that. Extra information isn't neutral — it uses up your attention and makes the thing you actually need to know harder to find.

When you're learning for action, tell Claude that explicitly. Add this to your prompt:

```
I need to understand this well enough to [specific action]. Please focus
only on what's relevant to that — don't give me background I don't need.
```

For example: "I need to understand this well enough to complete the trust distribution section of a discretionary trust's tax return where there's a UPE owed to a corporate beneficiary. Please focus only on what's relevant to that — don't give me background on the broader trust law system."

Or: "I need to understand this well enough to advise a client whether to sign a personal guarantee clause in a commercial lease. Please focus on the practical tax and commercial implications and the questions I should ask the firm's lawyer — not the general law around guarantees."

The action frame does three things. It tells Claude what level of detail you need. It tells Claude what to exclude. And it gives Claude a test it can apply: does this information help me take the specific action? If not, leave it out.

This makes a meaningful difference in the output. Focused explanations are faster to read and more likely to stick. You're not learning a subject — you're learning what you need to do the next thing on the file.
...
- Give me one concrete worked example of how this works in practice
- Tell me what practitioners commonly get wrong about this

[Paste any relevant document or section here if applicable]
```

This is not a formula you have to follow rigidly. It's a checklist for the components that make learning conversations with Claude actually useful. Level, prior knowledge, action orientation, example, common mistake. Cover those five and you'll get explanations that are worth more than most CPD modules on the same topic.
