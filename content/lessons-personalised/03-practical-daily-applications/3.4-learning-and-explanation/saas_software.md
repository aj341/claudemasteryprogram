...
Most of the time, learning something for your SaaS is inconvenient. You need to understand a clause in a customer's DPA before you sign it. You need to know what "PCI SAQ-A" means before you accept a payment-processor proposal. You need to understand how the OAIC's Notifiable Data Breach scheme applies to a near-miss before your security adviser calls. But the security adviser is booked until Thursday, the lawyer charges by the hour, and Google gives you seventeen tabs of partially relevant content that each lead to three more tabs.
...
This is not a small thing. For founders and operators in particular, the gaps between what you know and what you need to know to make a decision are constant. Claude doesn't close all of them — but it closes far more than most people realise, because they haven't thought about it as a learning tool yet.

This lesson is about that. Specifically: how to get explanations that are actually calibrated to you, how to follow up in a way that turns explanation into understanding, and how to use Claude for the highest-value learning task most founders never think to try — understanding documents you need to act on.
...
"Simply" is relative. To a non-technical co-founder, "simply" means stripping out engineering vocabulary. To an experienced backend engineer asking about superannuation, "simply" might mean assuming basic financial literacy. To a designer asking about trademark law, "simply" might mean explaining what a trademark actually is before getting to anything else. Claude can't read your mind. "Simply" gives it no anchor.
...
For example: "Explain this to me like I'm a smart non-expert in this area. I understand basic SaaS unit economics, but I've never read a SOC 2 readiness assessment before." Or: "Explain this to me like I'm a smart non-expert in this area. I understand how Stripe billing works broadly, but I've never looked at how chargebacks flow through to my reconciled-revenue numbers."

That phrase — "smart non-expert" — does specific work. It tells Claude not to explain what a SaaS is, or what a webhook is, or what a dollar is. You're not a beginner at life. You're a beginner at this topic. Claude should pitch the explanation accordingly: no condescension, no assumption that you know the jargon, but also no padding that assumes you can't handle a real explanation.
...
Explanations work in the abstract. Examples show you what something actually looks like in practice. If Claude explains what a "limitation of liability" clause is in a vendor contract, ask it to show you what one looks like, how it typically gets triggered, and what a small SaaS founder should watch for. If Claude explains what "ARR retention" means, ask it to show you the numbers on a specific customer set like {{businessName}}'s. Abstract understanding doesn't survive contact with reality unless you've tested it with an example first.
...
"Can you explain GST to me?" Claude produces a comprehensive explanation starting from scratch — what GST is, how it works in Australia, how to register. You already know all of that. What you needed was an explanation of how GST applies to the mixed cross-border SaaS subscription you're invoicing.

**Better approach:** Anchor the explanation to what you already know and what you need.

"I understand how GST works for AU-domestic SaaS sales — we charge it on monthly subscriptions to AU customers. What I'm not clear on is how it applies when a customer is registered in NZ but uses the product from a team based partly in AU. Can you explain how a small SaaS should treat GST for a mixed AU/NZ customer like this?"
...
This is the use case most founders don't think of until someone suggests it — and then they use it constantly.

You receive documents all the time that you need to understand before you can act on them. Customer DPAs. Master service agreements. Investor SAFE notes. Cloud-vendor contracts. Insurance policies. Tax notices. Security questionnaires from a buyer's procurement team. These documents are written for lawyers or compliance teams, not for founders. They contain specific terms, clauses, and cross-references that are impenetrable if you don't already know the field.
...
```
I'm the founder of a [size] SaaS in [location]. I've received [type of
document] and need to understand it before I [sign it / respond to it /
meet with my lawyer about it].
...
3. Flag anything that seems unusual, restrictive, or worth getting
...
For example: "I need to understand this well enough to complete the SaaS revenue section of my BAS. Please focus only on what's relevant to that — don't give me background on the broader tax system."

Or: "I need to understand this well enough to decide whether to sign an uncapped indemnity clause in our first enterprise customer contract. Please focus on the practical implications and the questions I should ask my lawyer — not the general law around indemnities."

The action frame does three things. It tells Claude what level of detail you need. It tells Claude what to exclude. And it gives Claude a test it can apply: does this information help the founder take the specific action? If not, leave it out.
...
I already understand [what you know]. I haven't [what you haven't
studied or done].
