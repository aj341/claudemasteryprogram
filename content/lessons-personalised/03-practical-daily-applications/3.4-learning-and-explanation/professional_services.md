...
Most of the time, learning something for your practice is inconvenient. You need to understand a clause in a partnership agreement before you sign it. You need to know what "net 60 terms" means before you accept a sub-contractor proposal. You need to understand how the ATO's single touch payroll rules apply to your casual analyst before your accountant calls. But the accountant is booked until Thursday, the lawyer charges by the hour, and Google gives you seventeen tabs of partially relevant content that each lead to three more tabs.
...
This is not a small thing. For consultants and small-firm owners in particular, the gaps between what you know and what you need to know to make a decision are constant. Claude doesn't close all of them — but it closes far more than most people realise, because they haven't thought about it as a learning tool yet.

This lesson is about that, {{firstName}}. Specifically: how to get explanations that are actually calibrated to you, how to follow up in a way that turns explanation into understanding, and how to use Claude for the highest-value learning task most consultants never think to try — understanding documents you need to act on.
...
"Simply" is relative. To a secondary school teacher, "simply" means stripping out all the technical vocabulary. To an experienced HR consultant asking about superannuation laws, "simply" might mean assuming basic financial literacy. To an IT support firm owner asking about trademark law, "simply" might mean explaining what a trademark actually is before getting to anything else. Claude can't read your mind. "Simply" gives it no anchor.
...
For example: "Explain this to me like I'm a smart non-expert in this area. I understand basic engagement-letter structure, but I've never read a sub-consultant agreement before." Or: "Explain this to me like I'm a smart non-expert in this area. I understand how Xero invoicing works broadly, but I've never looked at the project-billing matching rules before."
...
Explanations work in the abstract. Examples show you what something actually looks like in practice. If Claude explains what a "limitation of liability" clause is in a consulting contract, ask it to show you what one looks like, how it typically gets triggered, and what a consultant should watch for. If Claude explains what "WIP recognition" means in your engagement accounting, ask it to show you the numbers on a specific project you're running. Abstract understanding doesn't survive contact with reality unless you've tested it with an example first.
...
"Can you explain GST to me?" Claude produces a comprehensive explanation starting from scratch — what GST is, how it works in Australia, how to register. You already know all of that. What you needed was an explanation of how GST applies to the mixed-supply engagement in your current contract.

**Better approach:** Anchor the explanation to what you already know and what you need.

"I understand how GST works on a standard consulting fee. What I'm not clear on is how it applies when an engagement bundles taxable advisory work with a pass-through cost — specifically, I'm looking at a project that includes my fees plus a re-billed survey-platform subscription. Can you explain how the firm should calculate and report GST on a mixed-supply engagement like this?"
...
This is the use case most consultants don't think of until someone suggests it — and then they use it constantly.

You receive documents all the time that you need to understand before you can act on them. Sub-contractor agreements. Client master services agreements. Office leases. ATO correspondence. Professional indemnity policies. Council compliance notices. Capability deeds from larger consultancies. These documents are written for lawyers or regulators, not for small-firm owners. They contain specific terms, clauses, and cross-references that are impenetrable if you don't already know the field.
...
```
I run [your firm type] in [location]. I've received [type of document] and need to understand it before I [sign it / respond to it / meet with my accountant about it].
...
Or: "I need to understand this well enough to decide whether to sign a personal guarantee clause in an office lease. Please focus on the practical implications and the questions I should ask my lawyer — not the general law around guarantees."

The action frame does three things. It tells Claude what level of detail you need. It tells Claude what to exclude. And it gives Claude a test it can apply: does this information help the user take the specific action? If not, leave it out.
