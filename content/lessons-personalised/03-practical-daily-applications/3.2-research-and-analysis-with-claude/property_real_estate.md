...
Most agents hear "research" and think: go out and find information. That's one kind of research. It's not what Claude is for.

Claude is a text processor, not a search engine. It doesn't browse realestate.com.au, doesn't check live RP Data, and doesn't know what sold last weekend. If you ask Claude to research current Sydney median prices, find today's auction clearance rate, or tell you what a comparable listing on the next street is asking — you'll get either a refusal or, worse, a confident-sounding answer that's out of date.

But there's a second kind of research that Claude handles extremely well: analysing material you already have.

You have three contractor quotes for re-painting an investment property. You have a special condition in a contract you don't fully understand. You have fifty rental applications for a single property. You have a 40-page strata report. You have your notes from a listing presentation. Any of these can go into Claude, and Claude can work with all of them — compare them, summarise them, extract patterns, flag risks, and tell you what they mean for a decision you need to make.

That's the pattern this lesson teaches. Not "ask Claude to find things." Ask Claude to analyse things you bring to it, {{firstName}}.
...
**Synthesising information you provide.** Paste in multiple documents, emails, or property files and ask Claude to draw them together into a coherent picture. Claude holds everything in the conversation in working memory and can cross-reference it. This is where its large context window earns its keep — particularly useful for sorting through buyer feedback across an open home campaign.

**Comparing options against criteria.** Give Claude a shortlist — three trades quotes for a kitchen renovation, two property management software options, four candidate responses to a tenant complaint — along with the criteria that matter to you, and ask it to compare them. Claude produces structured comparisons consistently when you give it structured inputs.

**Analysing documents you paste in.** Sales contracts, lease agreements, building reports, strata reports, owners corp minutes, condition reports. Ask Claude to read and work with the document — extract key terms, flag unusual clauses, summarise the main obligations, note anything missing relative to what you'd expect to see.

**Summarising long material.** A long email thread with a vendor solicitor, a 60-page pre-purchase building report, an annual report from a body corporate. Paste it in and ask for a summary shaped around what you need from it — the decisions, the risks, the action items. Claude reads the whole thing and produces what you ask for.

**Asking analytical questions about material you provide.** "Given the buyer feedback I've pasted in, what's the strongest argument for adjusting the price guide?" "What's missing from this strata report relative to what we'd want to see before recommending the property to a buyer?" "What does this tenant correspondence pattern suggest about the relationship at {{businessName}}?" These are questions Claude handles well — because the material is in front of it and it can reason across it.

### What Claude is not good at for research and analysis

This matters as much as the previous section, so read it carefully.

**Finding live information.** Claude cannot check current sale results, verify whether a vendor's expected price aligns with this week's market, look up today's auction clearance rate, or confirm that a stamp duty threshold is still current. If you ask and Claude answers, it's drawing on training data — which has a cutoff date. Anything time-sensitive needs a current source.

**Knowing your specific market's current pricing or conditions.** "What should a 3-bed unit in Newtown rent for?" is a question Claude will attempt — but its answer is based on training data, not the current rental market. Use Claude to structure the analysis once you have the rental comparables. Get the comparables from your own database or current portal data.

**Anything requiring real-time data.** Auction results, live listings, days on market figures, today's interest rate decision, current buyer enquiry numbers. Not Claude's territory.

**Verifying facts that weren't in the material you provided.** If you paste in a contract and ask whether a particular special condition is standard in NSW residential sales, Claude can comment on what it knows generally. But "generally" is not "currently in your specific market." For anything with legal or financial consequences, the analysis Claude provides is a starting point, not a conclusion. Your conveyancer signs off, not Claude.
...
**Step 1: Gather your raw material.** This is the part Claude can't do for you. Find the quotes, the buyer feedback, the contract, the proposals, the application emails. If the material is confidential — vendor financials, tenant ledger details — you can summarise or paraphrase it before pasting. Claude doesn't require verbatim text, only enough detail to work with.

**Step 2: Decide what question you need answered.** Before you open Claude, be clear on the decision or output you need. "Which trades quote should I recommend to the owner?" "What are the key risks in this special conditions schedule?" "What patterns appear in this open home buyer feedback?" The question shapes the prompt.
...
**Step 4: Evaluate the output and ask follow-up questions.** Claude's first analysis is a starting point. You may need to push back, ask it to go deeper on one point, or hold one conclusion up to a specific constraint you didn't mention in the first prompt. Treat the output as a draft, not a final answer.

Here's what a step 3 prompt looks like in practice:

```
Below are quotes from three painting contractors for a vacant rental
property our owner wants refreshed before re-leasing. I need to make
a recommendation to the owner. My priorities, in order, are:
reliability (they finish in the agreed window so we don't lose two
weeks of rent), communication (they respond when our PM calls), and
price (cheapest is not the goal — value for money is, on a tenanted
investment property).

For each contractor, summarise what the quote tells me about each of
my three priorities. Then produce a comparison table: rows are
contractors, columns are my three priorities, cells are brief
assessments. Finish with a short paragraph identifying the strongest
option based on this information only.

[Contractor quotes pasted below]
```

That prompt gives Claude the material, the decision context, the evaluation criteria, the output format (summary plus table plus recommendation paragraph), and a scope instruction. Claude has everything it needs.

### Using Claude to compare and evaluate options

Comparison prompts are one of the highest-value uses of Claude in a property context. Here's what makes them work.

**Provide the options as parallel information.** If you're comparing three rental applications, include the same categories of information for each — or note explicitly what's missing. Claude compares what you give it. If Applicant A's reference letters span five pages and Applicant B's covers half a page, the comparison will reflect that asymmetry.

**State your evaluation criteria explicitly.** Don't make Claude guess what matters to you. "I care about rental history, employment stability, and whether their references actually answer the questions we asked" is far more useful than "help me compare these." Claude will weight the criteria you name — so name the right ones.
...
**Common mistake to better approach**

Mistake: "Compare these two trust accounting software options for me." Claude produces two paragraphs of balanced description that don't help you decide anything.

Better approach: "I need to choose between PropertyTree and PropertyMe for a Brisbane property management arm with 180 doors and three PMs. My priorities are: ease of use for a team transitioning from a legacy system, mobile access for routine inspections in the field, and integration with our existing CRM, VaultRE. Compare these two options against those three criteria in a table. Then give me a direct recommendation — not a list of pros and cons, an actual call on which one to choose for this situation."

The second prompt gives Claude the context (Brisbane PM, 180 doors, three PMs), the explicit criteria, the format (comparison table), and a clear instruction about the output type (recommendation, not pros and cons list). Claude responds in kind.

### Turning analysis into a decision

The difference between a summary and a useful analysis is a recommendation.

Claude defaults to balanced. Ask it to compare two contractors and it will tell you what's good and bad about both. This is useful — but often not enough. You need a call. You need to know what to actually recommend to the owner.

Getting a recommendation from Claude requires saying so explicitly. "Don't just summarise — give me your recommendation based on the information provided." "Make a call. If you had to choose one, which one and why?" "Based on everything I've pasted in, what should I recommend?"
...
If the material you need to analyse is sensitive — a vendor's expected sale price tied to their separation, a tenant's centrelink statement, internal commission splits — you have two options.

First, check your agency's policy on pasting confidential material into any AI tool. This is not unique to Claude. If there's no policy, consider making one before you rely on this workflow. Tenant and vendor data carries privacy obligations that don't disappear because the tool is convenient.

Second, know that you can paraphrase or anonymise the material before pasting. Replace vendor names with "Vendor A" and "Vendor B." Replace tenant names with "Applicant 1." Replace specific dollar amounts with ranges. Claude can still do meaningful analysis on paraphrased material — the analytical patterns don't disappear when you remove identifying details.
