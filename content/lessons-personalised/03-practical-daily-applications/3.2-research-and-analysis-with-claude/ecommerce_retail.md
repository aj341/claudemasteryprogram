...
Most retailers hear "research" and think: go out and find information. That's one kind of research. It's not what Claude is for.

Claude is a text processor, not a search engine. It doesn't browse the internet, doesn't check live databases, and doesn't know what happened last week. If you ask Claude to research current freight rates, find today's exchange rate, or tell you what your competitors charged for shipping last quarter — you'll get either a refusal or, worse, a confident-sounding answer that's out of date.

But there's a second kind of research that Claude handles extremely well: analysing material you already have at {{businessName}}.

You have quotes from three freight carriers. You have a wholesale agreement section you don't fully understand. You have fifty rows of customer feedback from a Google Form. You have a supplier proposal that's twenty pages long. You have your notes from a stockist meeting. Any of these can go into Claude, and Claude can work with all of them — compare them, summarise them, extract patterns, flag risks, and tell you what they mean for a decision you need to make.
...
**Synthesising information you provide.** Paste in multiple documents, supplier proposals, or customer-service threads and ask Claude to draw them together into a coherent picture. Claude holds everything in the conversation in working memory and can cross-reference it. This is where its large context window earns its keep.

**Comparing options against criteria.** Give Claude a shortlist — three freight carriers, two POS systems, four candidate replies to a damaged-stock complaint — along with the criteria that matter to you, and ask it to compare them. Claude produces structured comparisons consistently when you give it structured inputs.

**Analysing documents you paste in.** Wholesale agreements, supplier contracts, terms and conditions, returns policies, customer feedback exports. Ask Claude to read and work with the document — extract key terms, flag unusual clauses, summarise the main obligations, note anything missing relative to what you'd expect to see.

**Summarising long material.** A long supplier email thread, a freight company's full price list, a competitor's brand audit you commissioned. Paste it in and ask for a summary shaped around what you need from it — the decisions, the risks, the action items. Claude reads the whole thing and produces what you ask for.

**Asking analytical questions about material you provide.** "Given everything I've pasted in, what's the strongest argument for switching to Sendle?" "What's missing from this supplier proposal relative to what we asked for?" "What does this returns-reasons pattern suggest about our sizing chart?" These are questions Claude handles well — because the material is in front of it and it can reason across it.

### What Claude is not good at for research and analysis

This matters as much as the previous section, so read it carefully.

**Finding live information.** Claude cannot check current freight prices, verify whether a wholesaler is still trading, look up today's exchange rates for an overseas supplier, or confirm that an Australian Consumer Law guidance note is still current. If you ask and Claude answers, it's drawing on training data — which has a cutoff date. Anything time-sensitive needs a current source.

**Knowing your specific market's current pricing or conditions.** "What should a hand-thrown ceramic mug retail for in Australia?" is a question Claude will attempt — but its answer is based on training data, not the current market. Use Claude to structure the analysis once you have the numbers. Get the numbers from a current source — comparable Etsy listings, your own past sales, your stockists' RRPs.

**Anything requiring real-time data.** Today's order count, your live stock-on-hand, this morning's AUD/USD rate, today's parcel-tracking status. Not Claude's territory.

**Verifying facts that weren't in the material you provided.** If you paste in a wholesale agreement and ask whether the exclusivity clause is standard for AU homewares, Claude can comment on what it knows generally. But "generally" is not "currently in your specific market." For anything with legal or financial consequences, the analysis Claude provides is a starting point, not a conclusion.
...
**Step 1: Gather your raw material.** This is the part Claude can't do for you. Find the freight quotes, the customer feedback, the wholesale agreement, the supplier proposals, the emails. If the material is confidential, you can summarise or paraphrase it before pasting — Claude doesn't require verbatim text, only enough detail to work with.

**Step 2: Decide what question you need answered.** Before you open Claude, be clear on the decision or output you need. "Which freight carrier should I switch to?" "What are the key risks in this stockist agreement?" "What patterns appear in our last three months of returns reasons?" The question shapes the prompt.
...
```
Below are quotes from three freight carriers for our Shopify outbound parcels.
We ship about 350 orders a month, average parcel value $95, mostly fragile
homewares (ceramics, glassware). I need to choose one carrier. My priorities,
in order, are: damage rate (we can't afford broken stock arriving), transit
time (customers expect 3–5 business days metro), and price (lowest cost is
not the goal — value for money is).

For each carrier, summarise what the quote tells me about each of my three
priorities. Then produce a comparison table: rows are carriers, columns are
...
Comparison prompts are one of the highest-value uses of Claude in retail. Here's what makes them work.

**Provide the options as parallel information.** If you're comparing three carriers, include the same categories of information for each — or note explicitly what's missing. Claude compares what you give it. If Carrier A's quote covers five pages and Carrier B's covers half a page, the comparison will reflect that asymmetry.

**State your evaluation criteria explicitly.** Don't make Claude guess what matters to you. "I care about per-parcel cost, damage rate on fragile stock, and whether they offer Saturday metro pickups" is far more useful than "help me compare these." Claude will weight the criteria you name — so name the right ones.
...
Mistake: "Compare these two POS systems for me." Claude produces two paragraphs of balanced description that don't help you decide anything.

Better approach: "I need to choose between Lightspeed Retail and Square for our 4-person bricks-and-mortar gift shop in Hobart. We also sell on Shopify and need the POS to keep stock-on-hand in sync. My priorities are: ease of use for casual staff with no POS background, accurate Shopify integration so we don't oversell, and gift-card handling. Compare these two options against those three criteria in a table. Then give me a direct recommendation — not a list of pros and cons, an actual call on which one to choose for this situation."

The second prompt gives Claude the context (4-person Hobart gift shop with Shopify), the explicit criteria (casual-friendly, Shopify integration, gift cards), the format (comparison table), and a clear instruction about the output type (recommendation, not pros and cons list). Claude responds in kind.
...
If the material you need to analyse is commercially sensitive — a wholesale stockist agreement, your monthly Shopify financials, casual staff performance notes — you have two options.

First, check your own policy on pasting confidential material into any AI tool. This is not unique to Claude. If there's no policy, consider making one before you rely on this workflow.

Second, know that you can paraphrase or anonymise the material before pasting. Replace company names with "Stockist A" and "Carrier B." Replace individual names with roles. Replace specific dollar amounts with ranges. Claude can still do meaningful analysis on paraphrased material — the analytical patterns don't disappear when you remove identifying details.
