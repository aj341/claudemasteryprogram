...
Claude is a text processor, not a search engine. It doesn't browse the internet, doesn't check live databases, and doesn't know what happened last week. If you ask Claude to research current copper pricing, find today's diesel rate, or tell you what your competing sparkies charged on a job last quarter — you'll get either a refusal or, worse, a confident-sounding answer that's out of date.

But there's a second kind of research that Claude handles extremely well: analysing material you already have.

You have quotes from three suppliers. You have a head-contractor scope you don't fully understand. You have fifty rows of customer feedback from your last 30 jobs. You have a builder's contract that's forty pages long. You have your notes from a site walk-through. Any of these can go into Claude, and Claude can work with all of them — compare them, summarise them, extract patterns, flag risks, and tell you what they mean for a decision you need to make.
...
**Comparing options against criteria.** Give Claude a shortlist — three suppliers, two job-management tools, four candidate responses to a homeowner complaint — along with the criteria that matter to you, and ask it to compare them. Claude produces structured comparisons consistently when you give it structured inputs.

**Analysing documents you paste in.** Head-contractor agreements, scopes, supplier terms, defect-liability clauses, survey results from past customers. Ask Claude to read and work with the document — extract key terms, flag unusual clauses, summarise the main obligations, note anything missing relative to what you'd expect to see.

**Summarising long material.** A long email thread with a builder, a council inspector's report, a consultant engineer's deliverable. Paste it in and ask for a summary shaped around what you need from it — the decisions, the risks, the action items. Claude reads the whole thing and produces what you ask for.

**Asking analytical questions about material you provide.** "Given everything I've pasted in, what's the strongest argument for choosing Supplier A?" "What's missing from this scope relative to what we discussed on site?" "What does this feedback pattern suggest about our quoting process?" These are questions Claude handles well — because the material is in front of it and it can reason across it.

### What Claude is not good at for research and analysis

This matters as much as the previous section, so read it carefully.

**Finding live information.** Claude cannot check current material prices, verify whether a supplier is still trading, look up today's exchange rates, or confirm that a wiring rule or plumbing standard is still current. If you ask and Claude answers, it's drawing on training data — which has a cutoff date. Anything time-sensitive needs a current source.

**Knowing your specific trade's current pricing or local market conditions.** "What should a residential sparkie charge per hour in Adelaide?" is a question Claude will attempt — but its answer is based on training data, not the current market. Use Claude to structure the analysis once you have the numbers. Get the numbers from a current source.

**Anything requiring real-time data.** Spot prices on copper or PVC, live stock at the wholesaler, today's weather for outdoor work, council fee changes. Not Claude's territory.

**Verifying facts that weren't in the material you provided.** If you paste in a builder's contract and ask whether the retention clause is standard for residential work, Claude can comment on what it knows generally. But "generally" is not "currently in your specific market." For anything with legal or financial consequences, the analysis Claude provides is a starting point, not a conclusion.

The practical rule: if accuracy matters and the information is time-sensitive or highly specific to your trade, use Claude to structure and analyse — but verify the facts from a current, authoritative source.

### The "bring your own material" workflow

This is the most valuable pattern in this lesson. It has four steps.

**Step 1: Gather your raw material.** This is the part Claude can't do for you. Find the quotes, the feedback, the contract, the scopes, the emails. If the material is confidential, you can summarise or paraphrase it before pasting — Claude doesn't require verbatim text, only enough detail to work with.

**Step 2: Decide what question you need answered.** Before you open Claude, be clear on the decision or output you need. "Which supplier should I switch to?" "What are the key risks in this contract?" "What patterns appear in this feedback?" The question shapes the prompt.
...
```
Below are quotes from three electrical wholesalers for our standing supply
account. I need to choose one. My priorities, in order, are: reliability
(stock when we need it on a Monday), back-order communication (they tell
us early when something's coming late), and price (lowest cost is not the
goal — value for money is).

For each wholesaler, summarise what the quote tells me about each of my
three priorities. Then produce a comparison table: rows are wholesalers,
...
[Wholesaler quotes pasted below]
```
...
Comparison prompts are one of the highest-value uses of Claude in a trades business. Here's what makes them work.

**Provide the options as parallel information.** If you're comparing three suppliers, include the same categories of information for each — or note explicitly what's missing. Claude compares what you give it. If Supplier A's quote covers five pages and Supplier B's covers half a page, the comparison will reflect that asymmetry.

**State your evaluation criteria explicitly.** Don't make Claude guess what matters to you. "I care about price, lead time, and whether they deliver to site instead of trade counter only" is far more useful than "help me compare these." Claude will weight the criteria you name — so name the right ones.
...
Mistake: "Compare these two job-management tools for me." Claude produces two paragraphs of balanced description that don't help you decide anything.

Better approach: "I need to choose between simPRO and ServiceM8 for a 6-person residential plumbing business in Queensland. My priorities are: ease of use for plumbers and apprentices with no admin background, mobile access on site, and integration with Xero. Compare these two options against those three criteria in a table. Then give me a direct recommendation — not a list of pros and cons, an actual call on which one to choose for this situation."

The second prompt gives Claude the context (6-person residential plumbing business, Queensland), the explicit criteria (ease of use, mobile access, Xero integration), the format (comparison table), and a clear instruction about the output type (recommendation, not pros and cons list). Claude responds in kind.
...
If the material you need to analyse is commercially sensitive — a contract with a head builder, your job-cost figures, sub-contractor performance notes — you have two options.

First, check what makes sense for {{businessName}} on pasting confidential material into any AI tool. This is not unique to Claude. If you don't have a rule yet, consider making one before you rely on this workflow.

Second, know that you can paraphrase or anonymise the material before pasting. Replace company names with "Builder A" and "Builder B." Replace individual names with roles. Replace specific dollar amounts with ranges. Claude can still do meaningful analysis on paraphrased material — the analytical patterns don't disappear when you remove identifying details.
