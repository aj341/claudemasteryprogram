...
the situation: they're a mid-size private school looking for an after-school
tutoring partner, the contract is worth around $80k over 12 months, but the
scope feels vague and the deputy principal has already changed her brief
three times in discovery. My gut says this is going to be high-maintenance.
But $80k is meaningful for {{businessName}} right now.
...
```
I need to decide between three options for my admin hire at the tutoring
service. Here are the options I'm actually weighing:

Option A: Hire a part-time experienced school-admin person (3 days/week,
         $38/hr, available in 4 weeks)
Option B: Hire a full-time junior office admin (5 days/week, $28/hr,
         would need 6–8 weeks of training before they're useful)
Option C: Use a virtual reception service for 3 months while we reassess
         (higher cost, less commitment)

Constraints I'm working within:
- Budget ceiling: $65,000 for the first 12 months all-in
- We can't have a 6-week gap in front-desk coverage — we have parent
  walk-ins every week
- Option D (offshore/VA) has already been ruled out — not right for our
  parent-facing environment

What matters most to me: reliability, speed to being useful, and keeping
the cash flow manageable in Term 3.
