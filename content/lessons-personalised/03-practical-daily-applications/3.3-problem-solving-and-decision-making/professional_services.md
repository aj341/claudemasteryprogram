...
```
I'm sitting on a decision about whether to take on a new engagement. Here's
...
the main contact has already changed the brief three times in discovery.
My gut says this is going to be high-maintenance. But $80k is meaningful
for {{businessName}} right now.
...
```
I need to decide between three options for the next hire at our 12-person
IT support firm in Geelong. Here are the options I'm actually weighing:

Option A: Hire a part-time experienced engineer (3 days/week, $90/hr,
         available in 4 weeks)
Option B: Hire a full-time junior engineer (5 days/week, $65k base, would
         need 6–8 weeks of training before they can run tickets solo)
Option C: Use a contracting partner for 3 months while we reassess (higher
         cost, less commitment)

Constraints I'm working within:
- Budget ceiling: $130,000 for the first 12 months all-in
- We can't have a 6-week gap in afternoon coverage — clients escalate
  through 4pm–6pm and we need someone on the desk
...
Mistake: "Help me decide whether to hire someone or use a contractor." Claude produces a generic comparison with no relevance to your situation, budget, firm size, or timing.
...
part-time engineer. Before I make this call, argue against Option A as
...
**Risk tolerance.** Claude can describe the risks of an option. It cannot feel the cash flow pressure you're under, or know how much a wrong call would cost you personally and professionally. You carry that context. Claude doesn't.
