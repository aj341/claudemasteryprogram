...
Most agents hit a hard call and do one of two things: they sit with it alone for too long, or they ask the principal who already has an opinion. Both have limits. Sitting alone means no pressure-testing. Asking someone invested means filtered feedback.
...
But Claude is not a decision-maker. It doesn't know your agency the way you do. It can't see the vendor relationship, the cash flow on the rent roll, or the gut feeling you're carrying about a buyer. What it can do is structure messy thinking, surface angles you haven't considered, and challenge the reasoning you've already formed. That's the tool. The decision stays with you, {{firstName}}.

This lesson is about how to use that tool well.

### Beat 1 — Using Claude as a thinking partner

The most underused way to work with Claude on decisions is the simplest: talk through the problem. Not as a formal prompt — as a brain dump. Describe the situation like you'd describe it to a trusted colleague over a coffee after a Saturday auction. What's the problem, what are the stakes, what's making it hard, what options are you circling?

Then — and this is the move that makes it useful — ask Claude to ask you questions.

```
I'm sitting on a decision about whether to take on a new sales listing
at {{businessName}}. Here's the situation: it's a deceased estate
through a solicitor referral, the property would list around $1.6M,
but the executors are interstate and have already changed their mind
twice on whether they want auction or private treaty. My gut says
this is going to be high-maintenance and we'll spend three weeks
chasing decisions. But the GCI is meaningful and the solicitor sends
us 2-3 estates a year.

Before you give me any analysis or recommendations, ask me the
questions you'd need answered to actually help me think through this
properly.
```
...
Why does this work better than just describing the problem and asking for a recommendation straight away? Because when you go straight to "tell me what to do," Claude fills in the gaps it doesn't have. It assumes. It pattern-matches to the most common version of your decision, not your actual decision. Asking for questions first forces it to flag what it doesn't know — and forces you to confront the same gaps.
...
```
I need to decide between three options for our new BDM hire to grow
the rent roll. Here are the options I'm actually weighing:

Option A: Hire an experienced BDM from a competing agency in the
         area (full-time, $85k base + commission, available in 6
         weeks once they serve notice)
Option B: Hire a junior PM internally and promote them into BDM
         (5 days/week, $65k base + commission, would need 3 months
         shadowing before they're winning new managements solo)
Option C: Engage a referral-based growth consultant on a 6-month
         retainer while we keep looking (higher monthly cost, no
         long-term commitment)

Constraints I'm working within:
- Budget ceiling: $120k all-in for the first 12 months
- We can't have a 3-month gap in active growth — we already lost
  two managements last quarter to a competitor
- Option D (offshore VA prospecting) has been ruled out — won't
  work for our owner-facing market

What matters most to me: speed to revenue, retention risk if they
leave in year one, and protecting the team culture in the office.

Output I want: a trade-offs table comparing the three options
across my three criteria. Then a 2–3 sentence summary of which
option you'd lean toward, with the reasoning.
```
...
Mistake: "Help me decide whether to hire a BDM or use an external prospector." Claude produces a generic comparison with no relevance to your agency, rent roll size, market, or timing.
...
```
I've done the analysis and I'm leaning toward Option A — the
experienced BDM from the competing agency. Before I make this call,
argue against Option A as forcefully as you can. I want you to take
the other side — find the real weaknesses in my reasoning, the
risks I might be minimising, and the ways this hire could go badly.
Be direct. Don't soften it.
```

Most agents are surprised how good Claude is at this. It will find the holes — the non-compete clause you haven't checked, the risk that their pipeline is owner contacts the previous principal owns, the cultural friction with your existing PMs. It doesn't have a horse in the race, so it can argue the other side without flinching.
...
Claude will often come back with angles that didn't fit cleanly into the original framework — second-order effects, stakeholder considerations, timing risks, questions about your assumptions. Not all of it will be relevant. Some of it will be obvious. But once in a while it will surface something real you hadn't thought through — like the fact that signing this BDM in February means they're hitting peak listings season with no relationships in your area yet.
...
```
What am I missing specifically about the risk side of this hire? I
feel like I've been focused on cost and ramp-up speed, but I haven't
fully thought through what happens if Option A doesn't work out in
the first 90 days and we need to part ways.
```
...
**Relationship context.** Claude doesn't know what went unsaid in your last conversation with that vendor, or the dynamic you've built with a long-term landlord over five years. Decisions that hinge on relationship nuance require your read — not a framework.

**Values and culture.** What kind of agency you want to run. What you're willing to compromise on and what you won't — over-quoting to win listings, putting tenants into properties you wouldn't live in. These aren't criteria Claude can infer from a prompt. They come from you.

**Risk tolerance.** Claude can describe the risks of an option. It cannot feel the cash flow pressure of carrying a quiet sales month, or know how much a wrong PM hire would cost you in lost managements. You carry that context. Claude doesn't.

**Irreversible decisions.** The higher the stakes and the harder the reversal, the more your judgment needs to lead. Sacking a long-tenured PM, terminating a management agreement, taking on a vendor at a price you don't believe in — use Claude to think clearly, but be honest with yourself that you are the one who has to live with the outcome.
...
One more thing worth naming: if you find yourself using Claude's recommendation as justification for a decision you've already made — "Claude agreed with me, so it must be right" — that's a sign you're not using it as a thinking tool. You're using it as a validation tool. Those are different things. Validation feels good. Thinking is harder and more useful.

The test is whether you'd tell a vendor or a partner the reasons for your decision in your own words, from your own analysis. If the answer is yes, and Claude helped you get there — that's the tool working. If the answer is "Claude said Option A was best," you haven't done the thinking yet.
