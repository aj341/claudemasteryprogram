...
Most accountants hit a hard practice decision and do one of two things: they sit with it alone for too long, or they ask another partner who already has an opinion. Both have limits. Sitting alone means no pressure-testing. Asking someone invested means filtered feedback.
...
But Claude is not a decision-maker, {{firstName}}. It doesn't know your practice the way you do. It can't see the relationship history, the lodgement-cycle pressure, or the gut feeling you're carrying about a client. What it can do is structure messy thinking, surface angles you haven't considered, and challenge the reasoning you've already formed. That's the tool. The decision stays with you.
...
the situation: they're a mid-size construction company, the engagement is
worth around $80k over 12 months (compliance plus quarterly advisory),
but the scope feels vague and the main contact has already changed their
brief three times in discovery. My gut says this is going to be high-
maintenance and we'll be chasing receipts every quarter. But $80k is
meaningful for {{businessName}} right now.
...
- the constraints you're working within (budget, timeline, team capacity, anything ruled out)
...
```
I need to decide between three options for resourcing the BAS overflow
work next quarter. Here are the options I'm actually weighing:

Option A: Hire a part-time experienced bookkeeper (3 days/week, $38/hr,
         available in 4 weeks)
Option B: Hire a full-time junior (5 days/week, $28/hr, would need
         6–8 weeks of training before they're useful on quarterly BAS)
Option C: Use an external bookkeeping firm for one quarter while we reassess
         (higher cost, less commitment, but they're a known shop)

Constraints I'm working within:
- Budget ceiling: $65,000 for the first 12 months all-in
- We can't have a 6-week gap in BAS-prep capacity — Q3 lodgements start
  in 8 weeks
- Option D (offshore VA) has already been ruled out — we don't want client
  data leaving Australian jurisdiction

What matters most to me: reliability for BAS deadlines, speed to being
useful on quarterly cycles, and keeping the cash flow manageable through
end-of-FY.
...
Mistake: "Help me decide whether to hire a junior or use an external bookkeeper." Claude produces a generic comparison with no relevance to your practice's situation, budget, team size, or BAS-cycle timing.
...
part-time bookkeeper. Before I make this call, argue against Option A
as forcefully as you can. I want you to take the other side — find the
real weaknesses in my reasoning, the risks I might be minimising, and
the ways this decision could go badly for the practice through FY26.
Be direct. Don't soften it.
```

Most accountants are surprised how good Claude is at this. It will find the holes. It will surface the risks you've been rationalising. It doesn't have a horse in the race, so it can argue the other side without flinching.
...
Claude will often come back with angles that didn't fit cleanly into the original framework — second-order effects, TPB compliance considerations, lodgement-timing risks, questions about your assumptions. Not all of it will be relevant. Some of it will be obvious. But once in a while it will surface something real that you hadn't thought through.
...
what happens if Option A doesn't work out in the first 90 days — right
in the middle of Q3 BAS season.
```
...
**Relationship context.** Claude doesn't know what went unsaid in your last review meeting with that client, or the dynamic you've built with a staff bookkeeper over two years. Decisions that hinge on relationship nuance require your read — not a framework.

**Values and culture.** What kind of practice you want to run. What you're willing to compromise on and what you won't. These aren't criteria Claude can infer from a prompt. They come from you.

**Risk tolerance.** Claude can describe the risks of an option. It cannot feel the cash-flow pressure you're under, or know how much a wrong hire would cost you personally and through your TPB obligations. You carry that context. Claude doesn't.

**Irreversible decisions.** The higher the stakes and the harder the reversal, the more your judgment needs to lead. Use Claude to think clearly, but be honest with yourself that you are the one who signs the engagement letter or the employment contract.
...
The test is whether you'd tell another partner the reasons for your decision in your own words, from your own analysis. If the answer is yes, and Claude helped you get there — that's the tool working. If the answer is "Claude said Option A was best," you haven't done the thinking yet.
