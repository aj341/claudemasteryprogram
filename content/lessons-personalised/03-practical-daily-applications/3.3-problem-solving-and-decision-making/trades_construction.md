...
Most tradies hit a hard business decision and do one of two things: they sit with it alone for too long while driving between jobs, or they ask another tradie at the supplier counter who already has an opinion. Both have limits. Sitting alone means no pressure-testing. Asking someone in the same position usually means filtered feedback.
...
But Claude is not a decision-maker. It doesn't know {{businessName}} the way you do. It can't see the relationship history with a long-standing builder, the cash-flow squeeze you're carrying, or the gut feeling about a job that doesn't smell right. What it can do is structure messy thinking, surface angles you haven't considered, and challenge the reasoning you've already formed. That's the tool. The decision stays with you.

This lesson is about how to use that tool well.

### Beat 1 — Using Claude as a thinking partner

The most underused way to work with Claude on decisions is the simplest: talk through the problem. Not as a formal prompt — as a brain dump. Describe the situation like you'd describe it to a mate over a beer at the end of the week. What's the problem, what are the stakes, what's making it hard, what options are you circling?

Then — and this is the move that makes it useful — ask Claude to ask you questions.

```
I'm sitting on a decision about whether to take on a new head-contractor
gig. Here's the situation: it's a builder we've never worked with, the
project is worth around $80k of electrical over 12 months across three
townhouse sites, but the scope feels vague and the site supervisor has
already changed the brief three times in pricing. My gut says this is
going to be high-maintenance with messy variations. But $80k is meaningful
for us right now.
...
```
I need to decide between three options for putting a second person on
the books. Here are the options I'm actually weighing:

Option A: Hire an experienced licensed sparkie part-time (3 days/week,
         $52/hr, available in 4 weeks)
Option B: Take on a 3rd-year apprentice (5 days/week, $26/hr, would need
         6–8 weeks of close supervision before I can send him out alone)
Option C: Use a labour-hire mob for 3 months while we reassess (higher
         hourly cost, less commitment, no comp ute or tools issued)

Constraints I'm working within:
- Budget ceiling: $90,000 for the first 12 months all-in including ute
  costs and PPE
- We can't have a 6-week gap in second-pair-of-hands coverage — we have
  a 12-unit townhouse rough-in starting in 7 weeks
- Option D (sub-contracting to another sparkie) has been ruled out — I
  want someone in our shirts on site, not someone else's brand

What matters most to me: reliability on site, speed to being useful, and
keeping the cash flow manageable through the slow winter months.
...
Mistake: "Help me decide whether to put on an apprentice or use a sub-contractor." Claude produces a generic comparison with no relevance to your situation, budget, team size, or timing.
...
part-time sparkie. Before I make this call, argue against Option A as
...
what happens if Option A doesn't work out in the first 90 days on site.
```
...
**Relationship context.** Claude doesn't know what went unsaid in your last site meeting with that builder, or the dynamic you've built with an apprentice over two years. Decisions that hinge on relationship nuance require your read — not a framework.
