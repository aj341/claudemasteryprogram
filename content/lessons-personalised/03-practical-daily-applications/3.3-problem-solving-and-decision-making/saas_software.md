...
Most founders hit a hard product or pricing decision and do one of two things: they sit with it alone for too long, or they ask a co-founder who already has an opinion. Both have limits. Sitting alone means no pressure-testing. Asking someone invested means filtered feedback.
...
But Claude is not a decision-maker. It doesn't know your business the way you do. It can't see the customer history, the runway pressure, or the gut feeling you're carrying. What it can do is structure messy thinking, surface angles you haven't considered, and challenge the reasoning you've already formed. That's the tool. The decision stays with you.

This lesson is about how to use that tool well at {{businessName}}.

### Beat 1 — Using Claude as a thinking partner

The most underused way to work with Claude on decisions is the simplest: talk through the problem. Not as a formal prompt — as a brain dump. Describe the situation like you'd describe it to a trusted technical co-founder over coffee. What's the problem, what are the stakes, what's making it hard, what options are you circling?

Then — and this is the move that makes it useful — ask Claude to ask you questions.

```
I'm sitting on a decision about whether to take on a new customer.
Here's the situation: they're a 22-clinic physio group, the contract is
worth around $34k/year, but the implementation scope feels vague and
their COO has already changed the rollout brief three times in discovery.
My gut says this is going to be high-touch implementation. But $34k ARR
is meaningful for our 9-person SaaS right now.
...
This approach does something important. It slows you down. It surfaces what information is missing. It makes Claude work for what it needs rather than pattern-matching your situation onto a generic SaaS framework. And the questions themselves are often useful — reading them, you'll realise which ones you already know the answer to and which ones you don't.
...
- the constraints you're working within (runway, headcount, capacity, anything ruled out)
...
```
I need to decide between three options for our first customer-success
hire. Here are the options I'm actually weighing:

Option A: Hire a part-time experienced CS person (3 days/week, $60/hr,
         available in 4 weeks)
Option B: Hire a full-time junior CS person (5 days/week, $48/hr, would
         need 6–8 weeks of ramp before they're useful)
Option C: Use a CS-as-a-service vendor for 3 months while we reassess
         (higher cost, less continuity)

Constraints I'm working within:
- Budget ceiling: $90,000 for the first 12 months all-in
- We can't have a 6-week gap in CS coverage — we're onboarding 8–10
  new accounts a month
- Option D (offshore overnight VA) has already been ruled out — we
  have AU/NZ-only customers and the time-zone match matters

What matters most to me: reliability, time to being useful, and keeping
the burn manageable through Q3.
...
Mistake: "Help me decide whether to hire a CS person or use a contractor." Claude produces a generic comparison with no relevance to your situation, budget, team size, or timing.
...
Most founders are surprised how good Claude is at this. It will find the holes. It will surface the risks you've been rationalising. It doesn't have a horse in the race, so it can argue the other side without flinching.
...
I've been focused on cost and ramp speed, but I haven't fully thought
through what happens if Option A doesn't work out in the first 90 days.
```
...
**Relationship context.** Claude doesn't know what went unsaid in your last call with that customer, or the dynamic you've built with your technical co-founder over two years. Decisions that hinge on relationship nuance require your read — not a framework.

**Values and culture.** What kind of company you want to run. What you're willing to compromise on and what you won't. These aren't criteria Claude can infer from a prompt. They come from you.

**Risk tolerance.** Claude can describe the risks of an option. It cannot feel the runway pressure you're under, or know how much a wrong call would cost you personally and professionally. You carry that context. Claude doesn't.
...
The sign of good judgment is knowing when to take Claude's analysis seriously and when to set it aside. That skill develops with practice. By the time you've run a few real product, pricing, or hiring decisions through this process, you'll have a feel for where Claude adds value and where your read of the situation overrides it.
...
The test is whether you'd tell your co-founder the reasons for your decision in your own words, from your own analysis. If the answer is yes, and Claude helped you get there — that's the tool working. If the answer is "Claude said Option A was best," you haven't done the thinking yet.
