...
Most retailers hit a hard business decision and do one of two things: they sit with it alone for too long, or they ask someone close to the situation who already has an opinion. Both have limits. Sitting alone means no pressure-testing. Asking someone invested means filtered feedback.
...
But Claude is not a decision-maker. It doesn't know {{businessName}} the way you do. It can't see the relationship history, the cash flow pressure, or the gut feeling you're carrying. What it can do is structure messy thinking, surface angles you haven't considered, and challenge the reasoning you've already formed. That's the tool. The decision stays with you, {{firstName}}.

This lesson is about how to use that tool well.

### Beat 1 — Using Claude as a thinking partner

The most underused way to work with Claude on retail decisions is the simplest: talk through the problem. Not as a formal prompt — as a brain dump. Describe the situation like you'd describe it to a trusted colleague over coffee. What's the problem, what are the stakes, what's making it hard, what options are you circling?

Then — and this is the move that makes it useful — ask Claude to ask you questions.

```
I'm sitting on a decision about whether to take on a new wholesale stockist.
Here's the situation: they're a mid-size department store group with three
locations, the first order would be around $14k across 8 of our SKUs, but
the buyer has already changed the spec twice during sampling and asked for
a 60% discount off RRP (we sit at 50%). My gut says this is going to be
high-maintenance and erode our wholesale margin model. But $14k is meaningful
for us right now and they'd be our biggest stockist.
...
- the constraints you're working within (budget, stockholding, capacity, anything ruled out)
...
```
I need to decide between three options for a customer-service hire. Here
are the options I'm actually weighing:

Option A: Hire a part-time experienced ecommerce CS person (3 days/week,
         $34/hr, available in 3 weeks)
Option B: Hire a full-time junior person (5 days/week, $26/hr, would
         need 4–6 weeks of training before they're useful on Shopify
         and Gorgias)
Option C: Use a Filipino VA agency for 3 months while we reassess
         (lower cost, less commitment, async only)

Constraints I'm working within:
- Budget ceiling: $58,000 for the first 12 months all-in
- We can't have a 4-week gap in CS coverage — Black Friday is in 8 weeks
  and our reply-time is already slipping
- Option D (chatbot only) has already been ruled out — our customers
  expect a human reply for damaged-stock and "where's my order" issues

What matters most to me: reliability over Black Friday, speed to being
useful, and keeping the cash flow manageable in Q3 before our peak.
...
Mistake: "Help me decide whether to hire a CS person or use a VA." Claude produces a generic comparison with no relevance to your store, your peak season, your tools, or your timing.
...
part-time CS hire. Before I make this call, argue against Option A as
...
Most retailers are surprised how good Claude is at this. It will find the holes. It will surface the risks you've been rationalising — like a part-time person being unavailable on Cyber Monday because they only work three days. It doesn't have a horse in the race, so it can argue the other side without flinching.
...
Claude will often come back with angles that didn't fit cleanly into the original framework — second-order effects on your stockists, customer-perception risks, timing risks, questions about your assumptions. Not all of it will be relevant. Some of it will be obvious. But once in a while it will surface something real that you hadn't thought through.
...
what happens if Option A doesn't work out in the first 90 days — including
the impact on our peak-season reply times.
```
...
Claude is useful for structuring decisions. It is not a substitute for judgment. There are categories of retail decision where you must remain in charge — not because Claude is unhelpful, but because there are things Claude genuinely cannot know.

**Relationship context.** Claude doesn't know what went unsaid in your last call with that wholesale buyer, or the dynamic you've built with a long-time customer who DMs you about every order. Decisions that hinge on relationship nuance require your read — not a framework.

**Values and brand.** What kind of store you want to run. What you're willing to compromise on (free returns, your sustainability standard, your discounting policy) and what you won't. These aren't criteria Claude can infer from a prompt. They come from you.

**Risk tolerance.** Claude can describe the risks of an option. It cannot feel the cash-flow pressure you're under, or know how much a wrong call would cost you personally and in your relationship with your suppliers. You carry that context. Claude doesn't.

**Irreversible decisions.** The higher the stakes and the harder the reversal, the more your judgment needs to lead. Use Claude to think clearly, but be honest with yourself that you are the one who has to live with the outcome — and the customer reviews.
