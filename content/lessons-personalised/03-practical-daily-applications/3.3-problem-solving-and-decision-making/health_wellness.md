...
{{firstName}}, like most practice owners, hits a hard business decision and does one of two things: they sit with it alone for too long, or they ask someone close to the situation who already has an opinion. Both have limits. Sitting alone means no pressure-testing. Asking someone invested means filtered feedback.
...
```
I'm sitting on a decision about whether to take on a new corporate-wellness
contract at {{businessName}}. Here's the situation: they're a mid-size logistics
company, the contract is worth around $80k over 12 months in on-site assessment
days and follow-up sessions, but the scope feels vague and the WHS manager has
already changed their brief three times in discovery. My gut says this is going
to be high-maintenance. But $80k is meaningful for us right now.
...
```
I need to decide between three options for {{businessName}}'s front-desk
hire. Here are the options I'm actually weighing:

Option A: Hire a part-time experienced practice receptionist (3 days/week,
         $38/hr, available in 4 weeks)
Option B: Hire a full-time junior receptionist (5 days/week, $28/hr, would
         need 6–8 weeks of training before they're useful with HICAPS and
         our practice software)
Option C: Use a medical-reception agency for 3 months while we reassess
         (higher cost, less commitment)

Constraints I'm working within:
- Budget ceiling: $65,000 for the first 12 months all-in
- We can't have a 6-week gap in front-desk coverage — we have new-patient
  intakes every day
- Option D (offshore/VA) has already been ruled out — not right for a
  client-facing clinical environment with confidential health information

What matters most to me: reliability, speed to being useful with our
clinical software and HICAPS, and keeping cash flow manageable in Q3.
...
Mistake: "Help me decide whether to hire a clinician or use a contractor." Claude produces a generic comparison with no relevance to {{businessName}}'s situation, budget, team size, or timing.
