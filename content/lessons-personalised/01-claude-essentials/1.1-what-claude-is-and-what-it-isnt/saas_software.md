...
**It reads long documents without losing track.** Claude has a large context window — the amount of text it can process in one go. You can paste in a 30-page customer contract, six months of Intercom transcripts for one churned account, or your full pricing-page copy plus the latest competitor teardown and ask Claude to work with the whole thing. It won't summarise the first page and ignore the rest. This matters when your real tasks involve real artefacts, not short toy examples.

**It tells you when it doesn't know.** Claude will often say "I'm not certain about this" or "you should verify this with a current source." That might feel less impressive than a tool that always sounds authoritative, but in a SaaS business a confident wrong answer — say, the wrong refund-policy clause in a customer reply, or a misstated SLA in an outbound email — is worse than an honest "I'm not sure." You'll find this trait saves you from sending something you later have to retract on a public Slack channel or a status page.

**It doesn't remember previous conversations.** Every new session in Claude.ai starts completely fresh. Claude has no memory of what you talked about yesterday, last week, or five minutes ago in a different tab. This surprises people when they first encounter it. You'll work around it by keeping a short context document — key facts about your product, your ICP, your pricing tiers, your current feature roadmap — that you paste in at the start of important sessions. Later lessons cover this in detail.

**It doesn't browse the internet by default.** Claude's knowledge comes from its training data, which has a cutoff date. It can't pull live information — today's MRR, this morning's churn rate, the support ticket count from the last hour — unless you're using a version that has web access specifically enabled. If you ask about something that happened recently, Claude may not know about it, and should tell you so.
...
Many business tools are adding Claude as a built-in assistant — helpdesk platforms, writing tools, even some product-analytics suites. If a tool you already use has an AI feature, it may be running on Claude.

There's also Claude via API, which developers use to build applications. You don't need this for the course, but knowing it exists explains why Claude sometimes behaves differently inside different products — each integration makes its own choices about what to expose. If you've ever wired a Claude call into a Linear automation or a webhook from Stripe, that's the API in action.

For every lesson in this course, you're working in Claude.ai.

### What Claude is genuinely good at

This is a practical list. Not aspirational — honest about where Claude earns its keep in a small SaaS team.

**Writing and editing.** First drafts of feature announcements, release notes, customer success follow-ups, win-back emails, support macros, and the public-facing changelog. Claude handles all of this well. The catch: the quality of what you get out depends heavily on what you put in. A vague prompt produces generic output. A specific prompt produces something you can paste straight into your Intercom outbound or your Beehiiv newsletter.

**Summarising and extracting.** Paste in a 60-minute Gong transcript and ask Claude to pull out the objections, the must-have feature requests, or the competitor mentions. Paste in a month of churn-survey responses and ask for the three themes by frequency. This is one of the highest-value things you can do with Claude today, with no learning curve.

**Thinking through problems.** This one is underused. Before you change pricing, sunset a feature, or rewrite your activation email, try explaining your situation to Claude and asking it to identify questions you should be asking, or to challenge the weak points in your plan. It's a useful sounding board, especially for early-stage thinking.

**Explaining complex topics.** Ask Claude to explain how Stripe handles SCA on AU cards, what an OWASP recommendation actually means for your auth flow, or how to read a webhook signing-secret error. It handles this well. Give it the right question and a clear sense of your background, and it calibrates the explanation appropriately.

**Drafting communications.** Customer renewal nudges, support escalations, sales outbound, internal post-mortems, the email that announces a price rise. Claude produces a reasonable first draft quickly. You still edit and review. But a solid draft is faster to work from than a blank page on a Friday afternoon when an outage post needs to ship.

### What Claude is not good at

**Real-time information.** Claude doesn't know what your current MRR is, what today's signup count looks like, or how many P1 tickets your support queue is sitting on. Live data needs to come from your dashboards, your warehouse, or whatever tool actually holds it.

**High-stakes decisions without your judgment.** Claude can help you think through a decision — should you offer a discount to retain a churning account, should you launch the half-baked feature now or wait — structure your analysis, draft the announcement. You are the one who knows the customer, the runway, and what's at stake. Use Claude as a thinking tool, not as the decision-maker.

**Tasks where accuracy is non-negotiable.** Claude makes mistakes. It can misread a number in a usage report, miss a nuance in your terms of service, or state an SLA commitment with confidence that isn't accurate. Any output going on a marketing site, into a customer email blast, or onto a renewal contract needs a human review. This is not optional.

**Always knowing what it doesn't know.** Claude is trained to flag uncertainty, and it usually does. But it occasionally gets things wrong without flagging it. The more specific and verifiable the information — exact prices, seat limits, response-time commitments, integration capabilities — the more important it is to cross-check.
...
If you ask Claude to "write something professional," it will produce something that matches its training on what "professional" means — which may not match what professional looks like for a 12-person AU SaaS or an indie B2B tool. If you ask it to "make this shorter," it will shorten it, but won't necessarily know which lines about your free-trial length or your pricing-page guarantee you can't afford to lose.
...
- Name who you are and what your product does
...
You don't have to do all of this every time. For a quick reply to a low-stakes support ticket, a short prompt is fine. But for anything that matters — a launch announcement going to your full list, a customer-success retention email, an outbound to a target account — the extra 30 seconds of context usually produces something you can use on the first attempt rather than the fourth.
...
**Mistake:** "Write me something about our new pricing." Claude produces something generic and useless.

**Better approach:** "I run a 9-person vertical SaaS in Sydney. We sell a job-management tool to AU/NZ commercial cleaners — about 240 paying customers, mostly on our $79/month Pro plan. We're moving from a flat $79 to per-seat pricing ($29/user, three-user minimum) on 1 June. Existing customers are grandfathered for 12 months. I want to email the 240 customers to explain the change. Draft this in plain, direct language — no jargon, no defensiveness. 220 words maximum."
