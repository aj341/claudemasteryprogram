...
Many business tools are adding Claude as a built-in assistant — practice management platforms, writing tools, client portal software. If a tool you already use has an AI feature, it may be running on Claude.
...
**Writing and editing.** First drafts, editing passes, restructuring an argument, adjusting tone, cutting word count. Claude handles all of this well — engagement letters, BAS reminders, scope clarifications, fee proposals. The catch: the quality of what you get out depends heavily on what you put in. A vague prompt produces generic output. A specific prompt produces something you can actually use.

**Summarising and extracting.** Paste in a long document and ask Claude to pull out the key points, list the decisions, find the risk clauses, or extract the action items. For a tax agent, this is gold — chew through ATO bulletins, working papers, or a 30-page client file note in seconds. One of the highest-value things you can do with Claude today, with no learning curve.

**Thinking through problems.** This one is underused. Before writing a difficult client letter or preparing a fee-increase memo, try explaining your situation to Claude and asking it to identify questions you should be asking, or to challenge the weak points in your argument. It's a useful sounding board, especially for early-stage thinking.

**Explaining complex topics.** Ask Claude to explain a Div 7A loan, a CGT discount calculation, a contract clause, or a Single Touch Payroll change in plain language. It handles this well. Give it the right question and a clear sense of your client's background, and it calibrates the explanation appropriately.

**Drafting communications.** BAS reminders, lodgement extension requests, end-of-year client emails, scope notes, fee letters. Claude produces a reasonable first draft quickly. You still edit and review. But a solid draft is faster to work from than a blank page.

### What Claude is not good at

**Real-time information.** Claude doesn't know what happened last week. Today's ATO updates, current super contribution caps that may have just changed, this morning's tax ruling — these require a different tool or a current source.

**High-stakes decisions without your judgment.** Claude can help you think through a position, structure your analysis, draft the advice. You are the one who knows the full client context, the relationship, and what's at stake. Use Claude as a thinking tool, not as the technical decision-maker on a tax return.

**Tasks where accuracy is non-negotiable.** Claude makes mistakes. It can misread a number, miss a nuance in a working paper, or state something with confidence that isn't accurate. Any output going into a client-facing document, a lodgement, or a significant decision needs a human review. This is not optional in a regulated practice.

**Always knowing what it doesn't know.** Claude is trained to flag uncertainty, and it usually does. But it occasionally gets things wrong without flagging it. The more specific and verifiable the information — a section number, a rate, a date — the more important it is to cross-check.
...
You don't have to do all of this every time. For simple tasks, a short prompt is fine. But for anything that matters — a client letter, an important fee proposal, a complex CGT memo — the extra 30 seconds of context usually produces something you can use on the first attempt rather than the fourth.
...
**Mistake:** "Write me something about our scope letter." Claude produces something generic and useless.

**Better approach:** "I run a 6-person accounting firm in regional Victoria with around 180 small business clients. We're updating our standard scope-of-services letter for FY26 because too many clients have been asking for ad-hoc advice that sits outside the agreed scope. The key point we want to get across, without being preachy, is what's in scope versus what triggers a separate fee quote — using BAS, year-end accounts, and tax return work as the worked examples. Draft this in plain, clear language — no jargon, no Big-4 audit tone. 350 words maximum, addressed to the client."
