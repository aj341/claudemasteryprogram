...
Many business tools are adding Claude as a built-in assistant — job management platforms, quoting tools, customer service software. If a tool you already use on the office computer has an AI feature, it may be running on Claude.
...
This is a practical list. Not aspirational — honest about where Claude earns its keep on a trades business.

**Writing and editing.** First drafts, editing passes, restructuring a quote follow-up, adjusting tone, cutting word count. Claude handles all of this well. The catch: the quality of what you get out depends heavily on what you put in. A vague prompt produces generic output. A specific prompt produces something you can actually send.

**Summarising and extracting.** Paste in a long head-contractor scope, builder's email thread, or supplier T&Cs and ask Claude to pull out the key points, list the variations, find the payment-terms clauses, or extract action items. This is one of the highest-value things you can do with Claude today, with no learning curve.

**Thinking through problems.** This one is underused. Before sending a defect-liability response or pricing a tricky job, try explaining your situation to Claude and asking it to identify questions you should be asking, or to challenge the weak points in your approach. It's a useful sounding board, especially when you're working through something on your own at 7pm.

**Explaining complex topics.** Ask Claude to explain a wiring rule, a council requirement, a contract clause, or an Australian Standard reference in plain language. It handles this well. Give it the right question and a clear sense of your background, and it calibrates the explanation appropriately.

**Drafting communications.** Customer updates, quote follow-ups, variation summaries, end-of-job wrap emails. Claude produces a reasonable first draft quickly. You still edit and review. But a solid draft is faster to work from than a blank page on the laptop in the ute.

### What Claude is not good at

**Real-time information.** Claude doesn't know what happened last week. Live material prices, current weather, today's news — these require a different tool or a current source.

**High-stakes decisions without your judgment.** Claude can help you think through a decision, structure your reasoning, draft the message. You are the one who knows the customer, the site, and what's at stake. Use Claude as a thinking tool, not as the decision-maker on whether to proceed without a written variation.

**Tasks where accuracy is non-negotiable.** Claude makes mistakes. It can misread a number, miss a nuance, or state something with confidence that isn't accurate. Any output going into a compliance certificate email, a regulated submission, or a contract response needs your review. This is not optional.

**Always knowing what it doesn't know.** Claude is trained to flag uncertainty, and it usually does. But it occasionally gets things wrong without flagging it. The more specific and verifiable the information — a measurement, a clause, a code reference — the more important it is to cross-check.
...
- Name who you are and what {{businessName}} actually does (residential vs commercial, the trades you cover)
- Describe the audience for the output, not just the output itself — homeowner, builder, strata manager, council
- Specify format (length, structure, tone, what to include and exclude)
- Tell Claude what "good" looks like for this specific task

You don't have to do all of this every time, {{firstName}}. For simple tasks, a short prompt is fine. But for anything that matters — a customer-facing email, an important variation summary, a defect response — the extra 30 seconds of context usually produces something you can use on the first attempt rather than the fourth.
...
**Mistake:** "Write me something about my plumbing business." Claude produces something generic and useless.

**Better approach:** "I run a 4-person residential plumbing business on the Sunshine Coast, mostly handling Queenslander renovations and hot-water replacements. I want a one-page summary of how we work to give to a new admin staffer starting Monday. The key point we want to land is that we win most jobs through repeat customers and referrals — not Google ads — so she should always treat existing-customer enquiries as a priority. Draft this in plain, clear language — no jargon, no marketing fluff. 250 words maximum."
