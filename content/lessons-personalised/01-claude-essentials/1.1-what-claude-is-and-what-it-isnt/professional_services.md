...
**It reads long documents without losing track.** Claude has a large context window — the amount of text it can process in one go. You can paste in a 40-page scope of work, a long discovery document, or a thread of client emails about an in-flight engagement and ask Claude to work with the whole thing. It won't summarise the first page and ignore the rest. This matters when your real tasks involve real documents, not short toy examples.

**It tells you when it doesn't know.** Claude will often say "I'm not certain about this" or "you should verify this with a current source." That might feel less impressive than a tool that always sounds authoritative, but in client work where a confident wrong answer can land in a deliverable, an honest "I'm not sure" is the better default. You'll find this trait saves you from acting on bad information.

**It doesn't remember previous conversations.** Every new session in Claude.ai starts completely fresh. Claude has no memory of what you talked about yesterday, last week, or five minutes ago in a different tab. This surprises people when they first encounter it. You'll work around it by keeping a short context document — key facts about your practice, your active engagements, your current month's priorities — that you paste in at the start of important sessions. Later lessons cover this in detail.

**It doesn't browse the internet by default.** Claude's knowledge comes from its training data, which has a cutoff date. It can't pull live information — current rates, recent news, today's regulatory updates — unless you're using a version that has web access specifically enabled. If you ask about something that happened recently, Claude may not know about it, and should tell you so.
...
Many business tools are adding Claude as a built-in assistant — practice management platforms, time-tracking tools, client portal software. If a tool you already use has an AI feature, it may be running on Claude.
...
**Writing and editing.** First drafts, editing passes, restructuring an argument, adjusting tone, cutting word count. Claude handles all of this well — scope-of-work drafts, status updates, follow-up emails after a discovery call, fee proposals. The catch: the quality of what you get out depends heavily on what you put in. A vague prompt produces generic output. A specific prompt produces something you can actually use.

**Summarising and extracting.** Paste in a long document and ask Claude to pull out the key points, list the decisions, find the risk clauses, or extract the action items. For a small consultancy, this is gold — chew through a 30-page tender, last week's discovery meeting notes, or a long client brief in seconds. One of the highest-value things you can do with Claude today, with no learning curve.

**Thinking through problems.** This one is underused. Before writing a difficult client email or preparing a recommendation, try explaining your situation to Claude and asking it to identify questions you should be asking, or to challenge the weak points in your argument. It's a useful sounding board, especially for early-stage thinking on a new engagement.

**Explaining complex topics.** Ask Claude to explain a regulation, a procurement process, a contract clause, or a technical concept in plain language. It handles this well. Give it the right question and a clear sense of your client's background, and it calibrates the explanation appropriately.

**Drafting communications.** Status updates, scope clarification emails, post-meeting recaps, engagement letters, fee notes. Claude produces a reasonable first draft quickly. You still edit and review. But a solid draft is faster to work from than a blank page.

### What Claude is not good at

**Real-time information.** Claude doesn't know what happened last week. Today's regulatory changes, current pricing benchmarks, this morning's news — these require a different tool or a current source.

**High-stakes decisions without your judgment.** Claude can help you think through an option, structure your analysis, draft the recommendation. You are the one who knows the full client context, the relationship, and what's at stake. Use Claude as a thinking tool, not as the decision-maker on a client engagement.

**Tasks where accuracy is non-negotiable.** Claude makes mistakes. It can misread a number, miss a nuance in a brief, or state something with confidence that isn't accurate. Any output going into a client-facing deliverable, a tender response, or a significant recommendation needs a human review. This is not optional in client work.

**Always knowing what it doesn't know.** Claude is trained to flag uncertainty, and it usually does. But it occasionally gets things wrong without flagging it. The more specific and verifiable the information — a section reference, a rate, a date — the more important it is to cross-check.
...
You don't have to do all of this every time. For simple tasks, a short prompt is fine. But for anything that matters — a client deliverable, an important status update, a complex recommendation — the extra 30 seconds of context usually produces something you can use on the first attempt rather than the fourth.
...
**Mistake:** "Write me a scope of work for the new client." Claude produces something generic and useless.

**Better approach:** "I run a 5-person HR consultancy in Perth. A new client — a 40-person manufacturing business — wants help redesigning their performance review process. We had a 60-minute discovery call last week. Draft a one-page scope of work covering: the discovery and design phase (4 weeks), a pilot with one team (2 weeks), and rollout support (3 weeks). Keep the language plain — no consultant jargon, no 'workstreams', no 'deliverables matrix'. Address it to the GM of People & Culture. 350 words maximum."
