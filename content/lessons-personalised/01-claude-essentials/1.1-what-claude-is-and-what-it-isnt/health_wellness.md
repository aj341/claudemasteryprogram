...
**It reads long documents without losing track.** Claude has a large context window — the amount of text it can process in one go. You can paste in a long set of intake notes, a 40-page treatment-plan template, or a long email thread with a referrer and ask Claude to work with the whole thing. It won't summarise the first page and ignore the rest. This matters when your real tasks involve real documents, not short toy examples.

**It tells you when it doesn't know.** Claude will often say "I'm not certain about this" or "you should verify this with a current source." That might feel less impressive than a tool that always sounds authoritative, but in a clinical practice a confident wrong answer about a Medicare item number or a private health-fund rebate is worse than an honest "I'm not sure." You'll find this trait saves you from acting on bad information.

**It doesn't remember previous conversations.** Every new session in Claude.ai starts completely fresh. Claude has no memory of what you talked about yesterday, last week, or five minutes ago in a different tab. This surprises people when they first encounter it. You'll work around it by keeping a short context document — key facts about your practice, your tone preferences, your service mix — that you paste in at the start of important sessions. Later lessons cover this in detail.

**It doesn't browse the internet by default.** Claude's knowledge comes from its training data, which has a cutoff date. It can't pull live information — today's appointment changes, the current Medicare item-number list, this week's news — unless you're using a version that has web access specifically enabled. If you ask about something that happened recently, Claude may not know about it, and should tell you so.
...
Many business tools are adding Claude as a built-in assistant — practice-management platforms, writing tools, client-communication software. If a tool you already use has an AI feature, it may be running on Claude.
...
**Summarising and extracting.** Paste in a long document and ask Claude to pull out the key points, list the decisions, find the consent clauses, or extract the action items. This is one of the highest-value things you can do with Claude today, with no learning curve.
...
**Drafting communications.** Appointment confirmations, intake summaries, referrer letters, post-session recap notes. Claude produces a reasonable first draft quickly. You still edit and review. But a solid draft is faster to work from than a blank page.

### What Claude is not good at

**Real-time information.** Claude doesn't know what happened last week. Today's appointment slots, the current Medicare schedule, this morning's news — these require a different tool or a current source.
...
**Better approach:** "I'm {{firstName}}, and I run a 3-practitioner physiotherapy clinic on the Gold Coast with around 400 active clients. We're trying to write a one-page summary of our marketing approach to give to a new front-desk hire starting next week. The key point we want to get across is that we grow primarily through GP referrals, not paid online ads. Draft this in plain, clear language — no jargon. 250 words maximum."

The difference is specificity and constraints. Claude meets you at whatever level of detail you bring. Bring more context, get better output — especially in a regulated field like ours. This principle runs through every lesson in this course.
