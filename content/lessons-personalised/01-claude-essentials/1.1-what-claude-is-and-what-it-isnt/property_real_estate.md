...
**It reads long documents without losing track.** Claude has a large context window — the amount of text it can process in one go. You can paste in a full sales contract, a 40-page strata report, or a long email thread between vendor and buyer's solicitor and ask Claude to work with the whole thing. It won't summarise the first page and ignore the rest. This matters when your real tasks involve real documents, not short toy examples.

**It tells you when it doesn't know.** Claude will often say "I'm not certain about this" or "you should verify this with a current source." That might feel less impressive than a tool that always sounds authoritative, but in agency work a confident wrong answer is worse than an honest "I'm not sure." You'll find this trait saves you from sending a vendor update that contains the wrong number.

**It doesn't remember previous conversations.** Every new session in Claude.ai starts completely fresh. Claude has no memory of what you talked about yesterday, last week, or five minutes ago in a different tab. This surprises people when they first encounter it. You'll work around it by keeping a short context document — key facts about your agency, your tone, your current campaigns — that you paste in at the start of important sessions. Later lessons cover this in detail.

**It doesn't browse the internet by default.** Claude's knowledge comes from its training data, which has a cutoff date. It can't pull live information — current median prices, this week's clearance rates, today's RBA announcement — unless you're using a version that has web access specifically enabled. If you ask about something that happened recently, Claude may not know about it, and should tell you so.

### Where you'll access Claude

**Claude.ai** is the web interface and the app. It's where this program happens. Log in, start a conversation, work. No technical setup required.

Many business tools are adding Claude as a built-in assistant — CRM platforms, writing tools, even some property management software. If a tool you already use has an AI feature, it may be running on Claude.

There's also Claude via API, which developers use to build applications. You don't need this for the program, but knowing it exists explains why Claude sometimes behaves differently inside different products — each integration makes its own choices about what to expose.

For every lesson in this program, you're working in Claude.ai.

### What Claude is genuinely good at

This is a practical list. Not aspirational — honest about where Claude earns its keep.

**Writing and editing.** First drafts of listing copy, post-open-home vendor updates, restructuring a CMA narrative, adjusting tone, cutting word count. Claude handles all of this well. The catch: the quality of what you get out depends heavily on what you put in. A vague prompt produces generic output. A specific prompt produces something you can actually send.

**Summarising and extracting.** Paste in a long contract, a strata report, or a building inspection and ask Claude to pull out the key points, list the special conditions, find the defects, or extract the action items. This is one of the highest-value things you can do with Claude today, with no learning curve.

**Thinking through problems.** This one is underused. Before drafting a vendor strategy or preparing a price-reduction conversation, try explaining the situation to Claude and asking it to identify questions you should be asking, or to challenge the weak points in your argument. It's a useful sounding board, especially when you're working through a tricky listing.

**Explaining complex topics.** Ask Claude to explain a strata bylaw, a special condition in a contract, NSW residential tenancy rules, or how an off-the-plan settlement works in plain language. It handles this well. Give it the right question and a clear sense of who you're explaining it to — vendor, tenant, first-home buyer — and it pitches the explanation appropriately.

**Drafting communications.** Vendor updates, owner reports, prospecting emails, tenant notices, EOM property statements. Claude produces a reasonable first draft quickly, {{firstName}}. You still edit and review. But a solid draft is faster to work from than a blank page.

### What Claude is not good at

**Real-time information.** Claude doesn't know what cleared last weekend. Current median prices, this morning's auction results, today's interest rate move — these require a different tool or a current source.

**High-stakes decisions without your judgment.** Claude can help you think through a price-reduction conversation, structure your vendor pitch, draft the talking points. You are the one who knows the vendor, the buyer interest, and what's really at stake. Use Claude as a thinking tool, not as the decision-maker.

**Tasks where accuracy is non-negotiable.** Claude makes mistakes. It can misread a number, miss a clause, or state something with confidence that isn't accurate. Any output going into a contract variation, a 1-form, an 18-form, or a formal owner report needs a human review. This is not optional.

**Always knowing what it doesn't know.** Claude is trained to flag uncertainty, and it usually does. But it occasionally gets things wrong without flagging it. The more specific and verifiable the information — a strata levy figure, a stamp duty calculation, a rental yield — the more important it is to cross-check.
...
- Name who you are and what kind of agency you run
- Describe the audience for the output — vendor, tenant, buyer, owner — not just the output itself
- Specify format (length, structure, tone, what to include and exclude)
- Tell Claude what "good" looks like for this specific task

You don't have to do all of this every time. For simple tasks, a short prompt is fine. But for anything that matters — a vendor report, a prospecting letter, a buyer's-agent brief — the extra 30 seconds of context usually produces something you can use on the first attempt rather than the fourth.
...
**Mistake:** "Write me something about our marketing." Claude produces something generic and useless.

**Better approach:** "I run a 10-person sales and property management agency in regional NSW. We list around 80 sales properties a year and manage a rent roll of 320. We're writing a one-page summary of our prospecting strategy to give to a new BDM starting next week. The key point we want to get across is that we win listings primarily through past-client referrals and door-knocking around recently sold streets, not through portal advertising. Draft this in plain, clear language — no jargon. 250 words maximum."

The difference is specificity and constraints. Claude meets you at whatever level of detail you bring. Bring more context, get better output. This principle runs through every lesson in this program.
