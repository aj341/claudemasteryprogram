...
**Better approach:** "I run {{businessName}}, a tutoring business in Adelaide with six tutors covering Years 5 to 12 maths and English. We enrol around 110 students each term. I want a one-page summary of our marketing strategy to give to a new admin starting on Monday. The key point we want to get across is that we grow primarily through parent referrals after a strong first term, not paid ads. Draft this in plain, clear language — no jargon. 250 words maximum."
