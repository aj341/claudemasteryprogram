...
Not your name. Not your business. Not your customers, your brand voice, your shipping cut-offs, or the campaigns you run every quarter. You're starting from scratch each time. If you want Claude to produce output that fits {{businessName}}, you have to re-explain that context — every single session.

Most people handle this in one of two ways. Either they skip the context entirely and get generic output that needs heavy editing. Or they re-explain it from memory each time, inconsistently, which means Claude gets a slightly different picture of your store every session. Both approaches produce unpredictable results.
...
A context document is a short, structured document — 300 to 500 words — that contains the key facts Claude needs to produce useful output for your specific business. You write it once. At the start of any session where the output needs to actually fit your store, you paste it in before your first prompt.
...
The context document works because Claude reads everything in the current session. When you paste your context document at the start, every response you get in that session is shaped by it. Claude knows who you are, what you sell, who buys from you, and what the guardrails are. You don't need to repeat yourself. You don't need to re-establish your business in every prompt.

One important thing before you write: your context document is about your business, not your customers. It contains your information — your role, your products, your tone, your workflows. It does not contain customer names, order details, payment data, addresses, or anything else you'd find in a confidential customer record. That boundary matters both practically and legally, which the next section covers.

### What to include — the five components

A context document that works covers five things. Not ten. Not twenty. Five.

**1. Who you are and what your business does.** Your name, your role, your retail format (Shopify-only, bricks-and-mortar, multi-channel, Etsy), the size of your business, and a one-sentence description of what you sell. This is the foundation. Without it, Claude defaults to generic assumptions that may not fit you.

**2. Your customers and what they need.** Who do you sell to? What do they typically buy? What's the standard order size and frequency? You don't need to name anyone — describe your customer type. "Mostly women 35–55 buying gifts for friends and family, average basket $85, half are repeat customers" is exactly the right level of detail.

**3. Your tone and communication style.** How do you write? Warm and chatty or sharp and minimal? Australian English, of course. Is there anything you never say in customer comms — fake urgency, shouty caps, "purchase" instead of "buy," specific words you avoid? Claude will match whatever style you specify. If you don't specify, it guesses — and the guess will read like an American big-box retailer.

**4. Your three to five key recurring tasks.** From your work in Lesson 1.4, you mapped your weekly tasks and identified which ones are best suited to Claude. Name those tasks here. "Draft customer-service replies, write product descriptions, summarise weekly returns reasons, draft restock-alert emails, write supplier follow-ups." This tells Claude what you'll be asking it to do regularly, so the output is oriented toward those kinds of tasks.

**5. Your constraints.** This is the section most people skip and later regret. Constraints are the rules Claude needs to follow for your business specifically. What should Claude never produce without your review? What stock or pricing should Claude never invent? Are there topics you don't want Claude to speculate on? Is there information that's confidential and should never appear in outputs? This section is what makes your context document a genuine working document rather than a general introduction.
...
I'm [Name], owner of a small homewares brand based in regional Victoria.
...
Average order value $95. We do about 350 orders a month direct, plus
fortnightly wholesale dispatches.

My customers:
Mostly women 35–55, gift-buyers and self-treaters, with a strong repeat-buy
rate around 40%. They care about provenance and small-batch detail. They
don't respond well to discount-driven marketing. Most of my customer contact
is by email or Instagram DM, with occasional phone calls about damaged
deliveries.

Tone and communication style:
Warm and direct. Plain language — no marketing fluff. Australian English.
Sentences that are easy to scan. I never write "exclusive offer" or "shop
now" — just say what we're doing and why. No emojis in customer emails.

Key recurring tasks I'll use Claude for:
- Drafting customer-service replies (where's my order, returns, damaged stock)
- Writing first drafts of product descriptions for new SKUs
- Drafting fortnightly restock-alert and new-arrival emails
- Summarising the past month of returns reasons for stock decisions
- Writing supplier follow-up emails when shipments are late

Constraints:
- Never invent stock-on-hand numbers, prices, or dispatch dates — I'll provide
  these or you ask me first.
- Don't promise specific shipping windows in customer replies — say "we'll
  confirm with the freight company and come back to you within 24 hours."
- Confidentiality: do not reference any customer name, order number, or
  email address I share during a session in a way that could appear in
  a public document or marketing piece.
- When in doubt about an Australian Consumer Law obligation around refunds
  or replacements, flag it clearly and recommend I verify with my own source.
```

That document is 320 words. It takes about 10 minutes to write. It will save you hours of context-repeating over the course of this program and well beyond it.
...
The first: sensitive customer information. Customer names, order numbers, addresses, payment details, anything about a specific buyer that they gave you in confidence. Your context document lives on your device, in your clipboard, potentially in Claude sessions. It should contain zero customer-identifying data.

The second: operational detail Claude doesn't need upfront. Your full SKU list with cost prices, supplier pricing, full staff list, detailed campaign archive, every brief you've ever written. These can be shared with Claude during specific sessions when they're relevant. They don't belong in your context document, which needs to stay short enough to paste and scan in under 30 seconds.
...
At the start of any session where the output needs to fit your store specifically — a customer email, a campaign, a product description, {{firstName}} — paste your context document in as the first message. You don't need to say anything else. Just paste it. Claude reads it and uses it for every response in that session.
...
Draft an email to a customer whose pre-ordered linen bedding is now four weeks
late from the factory. They paid in full at order. Honest, warm, no corporate
hedge. Under 150 words. End with a 15% credit on their next order.
```
...
**Mistake:** Writing a context document that's a general business description — something that reads like the "About Us" page on your Shopify store. "We are a customer-obsessed homewares brand committed to bringing beautiful, considered objects into Australian homes." This is marketing copy. It tells Claude nothing about what you actually need.

**Better approach:** Write the context document for Claude specifically, not for an audience. Think about what a highly capable casual assistant would need to know on their first shift working with you. What tasks will they do? What rules must they follow? How should they write a customer email? What's the one thing they should never get wrong? That's your context document. Concrete, operational, specific.
