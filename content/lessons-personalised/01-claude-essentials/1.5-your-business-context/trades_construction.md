...
Not your name. Not {{businessName}}. Not your customers, your usual tone, the trades you cover, or the tasks you run every week. You're starting from scratch each time. If you want Claude to produce output that fits your actual business, you have to re-explain that context — every single session.

Most tradies handle this in one of two ways. Either they skip the context entirely and get generic output that needs heavy editing before it's customer-ready. Or they re-explain it from memory each time, inconsistently, which means Claude gets a slightly different picture of the business every session. Both approaches produce unpredictable results.
...
A context document is a short, structured document — 300 to 500 words — that contains the key facts Claude needs to produce useful output for your specific business. You write it once. At the start of any session where the output needs to actually fit your trade and your customers, you paste it in before your first prompt.

That's it. It's not technical. It doesn't require any special formatting or software. It's a document you write today, save somewhere accessible (a phone note, a Google Doc, the desktop on the office laptop), and use for the rest of the course — and beyond it.

The context document works because Claude reads everything in the current session. When you paste your context document at the start, every response you get in that session is shaped by it. Claude knows who you are, what you do, who your customers are, and what the guardrails are. You don't need to repeat yourself. You don't need to re-establish your business in every prompt.

One important thing before you write: your context document is about your business, not your customers. It contains your information — your role, your services, your tone, your workflows. It does not contain customer names, addresses, job financials, or anything else you'd find in a confidential customer file. That boundary matters both practically and legally, which the next section covers.

### What to include — the five components

A context document that works covers five things. Not ten. Not twenty. Five.

**1. Who you are and what your business does.** Your name, your role, your trade(s), the size of {{businessName}}, and a one-sentence description of what you do. This is the foundation. Without it, Claude defaults to generic assumptions that may not fit you.

**2. Your customers and what they need.** Who do you work with? What do they typically come to you for? What's the standard scope of a job? You don't need to name anyone — describe your customer type. "Homeowners in older Queenslanders, usually doing kitchen or bathroom renos, needing licensed plumbing work" is exactly the right level of detail.

**3. Your tone and communication style.** How do you write and talk to a homeowner versus a builder? Direct or chatty? Plain language, no jargon? Australian English? Is there anything you never say in customer comms — corporate fluff, overly casual language, specific words you avoid? Claude will match whatever style you specify. If you don't specify, it guesses.

**4. Your three to five key recurring tasks.** From your work in Lesson 1.4, you mapped your weekly tasks and identified which ones are best suited to Claude. Name those tasks here. "Draft quote follow-ups, write variation summaries, create end-of-job wrap emails, summarise builder email threads, draft scope-of-works documents." This tells Claude what you'll be asking it to do regularly, so the output is oriented toward those kinds of tasks.

**5. Your constraints.** This is the section most tradies skip and later regret. Constraints are the rules Claude needs to follow for your business specifically. What should Claude never produce without your review? What licensing, compliance, or insurance requirements apply to your work? Are there topics you don't want Claude to speculate on? Is there information that's confidential and should never appear in outputs? This section is what makes your context document a genuine working document rather than a general introduction.
...
I'm [Name], owner of a 4-person residential electrical business based in
outer Brisbane. We work exclusively on homes — switchboard upgrades, full
rewires on older Queenslanders, EV charger installs, and standard service
work. We use ServiceM8 for jobs and Xero for invoicing.

My customers:
Mostly homeowners — owner-occupiers, often older or doing a renovation.
They're not electrical-trained and rely on me to translate the work into
plain English. They prefer email for written confirmations and phone calls
for anything urgent. Repeat customers and referrals make up most of our work.

Tone and communication style:
Direct, plain, no jargon. Australian English. Sentences that are easy to
scan on a phone. I never write "please don't hesitate to contact me" — just
"give me a call if you've got questions." No marketing fluff.

Key recurring tasks I'll use Claude for:
- Drafting quote follow-ups (homeowners who haven't replied in 1–2 weeks)
- Writing first drafts of variation orders for renovation jobs
- Summarising builder email threads to extract action items
- Drafting compliance certificate emails after switchboard upgrades
- Writing internal job notes for my apprentice to follow on site

Constraints:
- I'm a licensed electrician. Never produce anything that looks like
  formal electrical advice for a customer to act on without me — frame
  outputs as drafts for my review.
- Do not include specific compliance certificate numbers, addresses, or
  customer names unless I provide them first.
- Confidentiality: do not reference any specific customer name or job
  detail I share during a session in a way that could appear in a document.
- When in doubt about wiring rules or AS/NZS 3000 references, flag it
  clearly and recommend I verify before sending.
```

That document is around 290 words. It takes about 10 minutes to write. It will save you hours of context-repeating over the course of this program and well beyond it.
...
The first: sensitive customer information. Customer names, addresses, job financials, personal phone numbers, anything specific to a particular homeowner or builder that they gave you in confidence. Your context document lives on your device, in your clipboard, potentially in Claude sessions. It should contain zero customer-identifying data.

The second: operational detail Claude doesn't need upfront. Your internal pricing, full crew list, detailed job history, long tender documents, everything you've ever written. These can be shared with Claude during specific sessions when they're relevant. They don't belong in your context document, which needs to stay short enough to paste and scan in under 30 seconds.
...
At the start of any session where the output needs to fit your business specifically — a customer email, a quote, a variation summary — paste your context document in as the first message. You don't need to say anything else. Just paste it. Claude reads it and uses it for every response in that session.
...
Draft an email to a homeowner who hasn't paid the deposit invoice for
a switchboard upgrade. The invoice was due 14 days ago. Polite but
clear. Under 120 words.
```
...
**Mistake:** Writing a context document that's a general business description — something that reads like the "About Us" page on your website. "We are a customer-focused electrical contractor committed to delivering exceptional results for homeowners across South-East Queensland." This is marketing copy. It tells Claude nothing about what you actually need.

**Better approach:** Write the context document for Claude specifically, not for an audience. Think about what a sharp new admin staffer would need to know on their first day at {{businessName}}. What tasks will they do? What rules must they follow? How should they write? What's the one thing they should never get wrong on a customer email? That's your context document. Concrete, operational, specific.
