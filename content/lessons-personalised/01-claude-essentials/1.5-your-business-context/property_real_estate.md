...
You've done four lessons. You've sent real prompts, seen what Claude produces, and formed a view on where it's useful. But there's a friction point that shows up quickly once you try to use Claude consistently across a real week of agency work: every time you open a new session, Claude knows nothing about you.

Not your name. Not your agency. Not your vendors, your usual tone, your compliance constraints, or the tasks you run every week. You're starting from scratch each time. If you want Claude to produce a vendor update or owner report that fits your actual context, you have to re-explain that context — every single session.

Most agency principals handle this in one of two ways. Either they skip the context entirely and get generic output that needs heavy editing. Or they re-explain it from memory each time, inconsistently, which means Claude gets a slightly different picture of your business every session. Both approaches produce unpredictable results.
...
A context document is a short, structured document — 300 to 500 words — that contains the key facts Claude needs to produce useful output for your specific agency. You write it once. At the start of any session where the output needs to actually fit your business, you paste it in before your first prompt.

That's it. It's not technical. It doesn't require any special formatting or software. It's a document you write today, save somewhere accessible, and use for the rest of the program — and beyond it.

The context document works because Claude reads everything in the current session. When you paste your context document at the start, every response you get in that session is shaped by it. Claude knows who you are, what your agency does, who your vendors and owners are, and what the guardrails are. You don't need to repeat yourself. You don't need to re-establish your business in every prompt.

One important thing before you write: your context document is about your agency, not your vendors, owners, tenants, or buyers. It contains your information — your role, your services, your tone, your workflows. It does not contain vendor names, sale prices on private sales, tenant details, owner financials, or anything else you'd find in a confidential client file. That boundary matters both practically and legally, which the next section covers.

### What to include — the five components

A context document that works covers five things. Not ten. Not twenty. Five.

**1. Who you are and what your agency does.** Your name, your role, your patch, the size of your business, and a one-sentence description of what you do. This is the foundation. Without it, Claude defaults to generic assumptions that may not fit you.

**2. Your clients and what they need.** Who do you work with? Vendors, landlords, tenants, buyers, strata committees? What do they typically come to you for? What's the standard scope of an engagement? You don't need to name anyone — describe your client type. "Owner-occupier vendors in a coastal market, average sale price $1.2M, mostly upgraders moving into bigger family homes" is exactly the right level of detail.

**3. Your tone and communication style.** How do you write and talk? Formal or conversational? Technical or plain language? Do you use Australian English (settlement, exchange, vendor, lease, bond — not closing, escrow, realtor)? Is there anything you never say in vendor or owner communications — jargon, overly casual language, specific words you avoid? Claude will match whatever style you specify. If you don't specify, it guesses.

**4. Your three to five key recurring tasks.** From your work in Lesson 1.4, you mapped your weekly tasks and identified which ones are best suited to Claude. Name those tasks here. "Draft post-open-home vendor updates, write monthly owner reports, create first-draft listing copy, summarise condition reports, review contracts for special conditions." This tells Claude what you'll be asking it to do regularly, so the output is oriented toward those kinds of tasks.

**5. Your constraints.** This is the section most people skip and later regret. Constraints are the rules Claude needs to follow for your agency specifically. What should Claude never produce without your review? What regulations or compliance requirements apply to your work — Fair Trading, the Property and Stock Agents Act, your trust account rules? Are there topics you don't want Claude to speculate on — sale prices, rental yields, market direction? Is there information that's confidential and should never appear in outputs? This section is what makes your context document a genuine working document rather than a general introduction.
...
I'm [Name], principal of an 8-person sales and property management agency on
the NSW Central Coast. We list around 90 sales properties a year and manage
a rent roll of 360. Two sales reps, three PMs, one BDM, one admin, and me.
Average sale price is around $850K.

My clients:
Vendors are mostly owner-occupiers — upgraders, downsizers, deceased estates.
Landlords are mostly mum-and-dad investors with one or two properties.
Tenants are a mix of long-term locals and Sydney commuters.
I never use client names in any draft.

Tone and communication style:
Warm, plain-language, no real-estate cliches. Australian English. I never write
"please don't hesitate to contact me" — just "let me know if you have questions."
No "stunning," "must-see," "won't last," or "rare opportunity" in listing copy.

Key recurring tasks I'll use Claude for:
- Drafting post-open-home vendor updates
- Writing first-draft listing copy from inspection notes
- Summarising condition reports for owners
- Reviewing contracts for unusual special conditions
- Drafting EOM commentary in owner statements

Constraints:
- I'm a licensed agent in a regulated environment. Never produce anything that
  reads like formal legal advice — frame outputs as drafts for my review.
- Do not invent sale prices, rental figures, or market statistics. If I don't
  give you the numbers, leave a placeholder.
- Confidentiality: do not reference any specific vendor, landlord, tenant,
  or buyer name I share during a session in a way that could appear in a
  document.
- When in doubt about Fair Trading or NSW tenancy rules, flag it and recommend
  I verify.
```

That document is around 280 words. It takes about 10 minutes to write. It will save you hours of context-repeating over the course of this program and well beyond it.

### What NOT to include

A context document is not a brain dump. It's not everything about your agency. It's the minimum Claude needs to produce useful output — and nothing more.

There are two kinds of things to keep out.

The first: sensitive client information. Vendor names, sale prices on private sales, tenant details, landlord financials, addresses of off-market properties, anything about a specific individual that they gave you in confidence. Your context document lives on your device, in your clipboard, potentially in Claude sessions. It should contain zero client-identifying data.

The second: operational detail Claude doesn't need upfront. Your full commission schedule, complete staff list, detailed property history, long franchise documents, everything you've ever written. These can be shared with Claude during specific sessions when they're relevant. They don't belong in your context document, which needs to stay short enough to paste and scan in under 30 seconds.
...
At the start of any session where the output needs to fit your agency specifically — a vendor email, a CMA narrative, an owner report — paste your context document in as the first message, {{firstName}}. You don't need to say anything else. Just paste it. Claude reads it and uses it for every response in that session.
...
Draft an email to a landlord whose tenant has missed their fortnightly rent
payment. The rent is 8 days overdue. Polite but clear, and outlining the next
steps under NSW tenancy rules. Under 120 words.
```
...
**Mistake:** Writing a context document that's a general agency description — something that reads like the "About Us" page on your website. "We are a client-focused agency committed to delivering exceptional results for vendors and landlords across the region." This is marketing copy. It tells Claude nothing about what you actually need.

**Better approach:** Write the context document for Claude specifically, not for an audience. Think about what a sharp new BDM or PM would need to know on their first day with you. What tasks will they do? What rules must they follow? How should they write to vendors? What's the one thing they should never get wrong? That's your context document. Concrete, operational, specific.
