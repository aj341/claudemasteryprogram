...
Not your name. Not your firm. Not your client mix, your usual tone, your engagement constraints, or the tasks you run every week. You're starting from scratch each time. If you want Claude to produce output that fits your actual context, you have to re-explain that context — every single session.

Most consultants and advisers handle this in one of two ways. Either they skip the context entirely and get generic output that needs heavy editing before it could go anywhere near a client deliverable. Or they re-explain it from memory each time, inconsistently, which means Claude gets a slightly different picture of the practice every session. Both approaches produce unpredictable results.
...
I'm [Name], principal of a solo management consultancy based in Brisbane.
I work exclusively with owner-operated trades and manufacturing businesses
under 60 staff. My core services are operations reviews, quoting and handoff
redesigns, and pre-GM transition planning. Member of CMC since 2019.

My clients:
Owner-operators or working directors. They're time-poor, not consulting-trained,
and rely on me to translate observations into specific actions. They need clear,
jargon-free communication. Most of my client contact is by email and weekly
status calls, with a fortnightly site visit during active engagements.

Tone and communication style:
Warm and direct. Plain language — no consulting jargon unless I specifically
ask for it. Australian English (programme, organisation, behaviour, etc.).
Sentences that are easy to scan. I never write "please don't hesitate to
contact me" — just "let me know if you have questions."

Key recurring tasks I'll use Claude for:
- Drafting status updates (weekly progress notes, scope clarification emails, fortnightly check-ins)
- Writing first drafts of post-discovery recap memos for clients
- Summarising meeting notes from workshops and stakeholder interviews
- Reviewing engagement letters to flag payment terms and scope creep
- Writing internal process documentation for my part-time delivery associate

Constraints:
- I work to professional standards under CMC. Never produce anything that
  reads like a final recommendation — frame outputs as drafts for my review,
  not finished advice.
- Do not invent specific industry benchmarks or regulatory references unless
  I provide them first.
- Confidentiality: do not reference any specific client name or business
  detail I share during a session in a way that could appear in a document.
- When in doubt about regulatory content (Fair Work, WHS, Modern Awards),
  flag it clearly and recommend I verify with the current source.
```
...
At the start of any session where the output needs to fit your practice specifically — a client email, a scope of work, a discovery summary — paste your context document in as the first message. You don't need to say anything else. Just paste it. Claude reads it and uses it for every response in that session.
...
Draft an email to a client who has missed their monthly retainer payment.
...
**Mistake:** Writing a context document that's a general business description — something that reads like the "About Us" page on your firm's website. "We are a client-focused consultancy committed to delivering exceptional results for businesses across Australia." This is marketing copy. It tells Claude nothing about what you actually need.

**Better approach:** Write the context document for Claude specifically, not for an audience. Think about what a highly capable junior consultant would need to know on their first day at the firm. What tasks will they do? What rules must they follow? How should they write? What's the one thing they should never get wrong on a status update or scope letter? That's your context document. Concrete, operational, specific.
