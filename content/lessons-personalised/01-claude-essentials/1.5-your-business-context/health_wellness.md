...
Not your name. Not {{businessName}}. Not your clients, your usual tone, your compliance constraints, or the tasks you run every week. You're starting from scratch each time. If you want Claude to produce output that fits your actual context, you have to re-explain that context — every single session.
...
**2. Your clients and what they need.** Who do you work with? What do they typically come to you for? What's the standard scope of a client engagement? You don't need to name anyone — describe your client type. "Adults aged 35–65 with persistent musculoskeletal pain, mostly referred by local GPs, needing 4–8 sessions of physiotherapy with home exercise programs" is exactly the right level of detail.
...
**4. Your three to five key recurring tasks.** From your work in Lesson 1.4, you mapped your weekly tasks and identified which ones are best suited to Claude. Name those tasks here. "Draft client emails, write monthly referrer updates, create first-draft treatment-plan summaries, summarise intake notes, review supplier contracts for key clauses." This tells Claude what you'll be asking it to do regularly, so the output is oriented toward those kinds of tasks.
...
```
BUSINESS CONTEXT — {{firstName}}

Who I am and what I do:
I'm {{firstName}}, principal of a two-practitioner physiotherapy clinic in Adelaide
called {{businessName}}. We work mainly with adults aged 35–70 with persistent neck,
back, and shoulder pain. Our core services are 1:1 assessment and treatment sessions,
home exercise programs, and short post-discharge reviews. We bill privately and via
Medicare EPC referrals; many clients also claim through their private health fund.

My clients:
Working adults and retirees referred by their GP or returning under self-funded care.
They're time-poor, not clinically trained, and rely on me to translate scan reports
and treatment plans into clear actions. They need plain, jargon-free communication.
Most of my client contact is by email and SMS reminders, with brief in-person reviews.

Tone and communication style:
Warm and direct. Plain language — no clinical jargon unless I specifically ask for it.
Australian English. Sentences that are easy to scan. I never write "please don't
hesitate to contact me" — just "let me know if you have questions."

Key recurring tasks I'll use Claude for:
- Drafting client emails (appointment reminders, intake follow-ups, late-payment notes)
- Writing first drafts of quarterly referrer-update letters
- Summarising notes from clinical case-review meetings
- Reviewing supplier contracts to flag payment terms and renewal clauses
- Writing internal process documentation for my part-time front-desk admin

Constraints:
- I work in a regulated clinical environment. Never produce anything that looks like
  formal medical advice — frame outputs as drafts for my review, not finished advice.
- Do not include specific dosages, scan findings, or rebate amounts unless I provide
  them first.
- Confidentiality: do not reference any specific client name or clinical detail
  I share during a session in a way that could appear in an outgoing document.
- When in doubt about clinical or regulatory content, flag it clearly and recommend
  I verify with the relevant body (AHPRA, Medicare, the client's GP).
```
...
The first: sensitive client information. Client names, client financials, personal addresses, clinical history, treatment details, anything about a specific individual that they gave you in confidence. Your context document lives on your device, in your clipboard, potentially in Claude sessions. It should contain zero client-identifying data.
...
Draft an email to a client who has an outstanding gap fee from a session two weeks ago.
...
**Mistake:** Writing a context document that's a general business description — something that reads like the "About Us" page on your website. "We are a client-focused physiotherapy clinic committed to delivering exceptional results for patients across Australia." This is marketing copy. It tells Claude nothing about what you actually need.
