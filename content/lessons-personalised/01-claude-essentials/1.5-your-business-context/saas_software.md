...
Not your name. Not your product. Not your customers, your usual tone, your security constraints, or the tasks you run every week. You're starting from scratch each time. If you want Claude to produce output that fits your actual context, you have to re-explain that context — every single session.

Most founders and operators handle this in one of two ways. Either they skip the context entirely and get generic output that needs heavy editing. Or they re-explain it from memory each time, inconsistently, which means Claude gets a slightly different picture of your business every session. Both approaches produce unpredictable results.
...
A context document is a short, structured document — 300 to 500 words — that contains the key facts Claude needs to produce useful output for your specific SaaS. You write it once. At the start of any session where the output needs to actually fit your business, you paste it in before your first prompt.

That's it. It's not technical. It doesn't require any special formatting or software. It's a document you write today, save somewhere accessible — a Notion page, a pinned Slack message to yourself, a TextExpander snippet — and use for the rest of the course and beyond it.

The context document works because Claude reads everything in the current session. When you paste your context document at the start, every response you get in that session is shaped by it. Claude knows who you are, what you sell, who your customers are, and what the guardrails are. You don't need to repeat yourself. You don't need to re-establish your business in every prompt.

One important thing before you write, {{firstName}}: your context document is about your business, not your customers. It contains your information — your role, your product, your tone, your workflows. It does not contain customer names, customer revenue figures, support-ticket details, personal data, or anything else you'd find in a confidential customer record. That boundary matters both practically and legally, which the next section covers.

### What to include — the five components

A context document that works covers five things. Not ten. Not twenty. Five.

**1. Who you are and what your business does.** Your name, your role, your category, the size of your team, and a one-sentence description of what you build. This is the foundation. Without it, Claude defaults to generic SaaS assumptions that may not fit you.

**2. Your customers and what they need.** Who do you sell to? What do they typically come to {{businessName}} for? What's the standard scope of a customer relationship — monthly subscription, annual prepay, usage-based? You don't need to name accounts — describe your customer type. "AU/NZ allied-health clinics, 5–25 practitioners, needing rostering and timesheet exports for payroll" is exactly the right level of detail.

**3. Your tone and communication style.** How do you write and talk? Formal or conversational? Technical or plain language? Do you use Australian English? Is there anything you never say in customer communications — corporate jargon, overly casual language, specific words you avoid? Claude will match whatever style you specify. If you don't specify, it guesses.

**4. Your three to five key recurring tasks.** From your work in Lesson 1.4, you mapped your weekly tasks and identified which ones are best suited to Claude. Name those tasks here. "Draft customer success emails, write release notes, create first-draft outbound sequences, summarise Gong calls, review feature requests for shared themes." This tells Claude what you'll be asking it to do regularly, so the output is oriented toward those kinds of tasks.

**5. Your constraints.** This is the section most people skip and later regret. Constraints are the rules Claude needs to follow for your business specifically. What should Claude never produce without your review? What security or compliance requirements apply to your work? Are there topics you don't want Claude to speculate on? Is there information that's confidential and should never appear in outputs? This section is what makes your context document a genuine working document rather than a general introduction.
...
I'm [Name], non-technical co-founder of an 8-person vertical SaaS based
in Sydney. We sell job-management software to AU/NZ commercial cleaners
— around 220 paying customers on a $79/month Pro plan. Stripe for billing,
Intercom for support, Linear for product, Pipedrive for sales.

My customers:
Small commercial-cleaning operators — typically owner-operators or ops
managers running 4–30 staff. They're time-poor, not technical, and rely
on us to make scheduling and invoicing simpler than spreadsheets. Most
of our customer contact is via Intercom and quarterly success calls.

Tone and communication style:
Warm and direct. Plain language — no SaaS jargon unless the customer
brings it up first. Australian English. Sentences that are easy to scan
on a phone in a cleaning van. I never write "we're excited to announce"
or "transform your business" — just "here's what's new and why it matters."

Key recurring tasks I'll use Claude for:
- Drafting customer-success emails (renewal nudges, churn-risk follow-ups)
- Writing first drafts of monthly release notes
- Summarising Gong call transcripts after demos and discovery calls
- Reviewing churn-survey responses to flag the recurring themes
- Writing internal Loom-script outlines for our two new support hires

Constraints:
- We handle PII for our customers' employees (names, hours, pay rates).
  Never reference specific customer data I share during a session in a
  way that could appear in a public-facing output.
- Do not invent feature commitments, pricing, or SLA numbers. Frame
  outputs as drafts for my review.
- When in doubt about a security or privacy claim, flag it clearly and
  recommend I verify with our security policy.
```
...
The first: sensitive customer information. Customer names, customer revenue, personal addresses, individual usage data, support-ticket content tied to a person, anything about a specific account that they shared with you in confidence. Your context document lives on your device, in your clipboard, potentially in Claude sessions. It should contain zero customer-identifying data.

The second: operational detail Claude doesn't need upfront. Your internal pricing models, full team list, detailed product roadmap, long strategy memos, everything you've ever written. These can be shared with Claude during specific sessions when they're relevant. They don't belong in your context document, which needs to stay short enough to paste and scan in under 30 seconds.
...
At the start of any session where the output needs to fit your business specifically — a customer-success email, a launch announcement, a release note — paste your context document in as the first message. You don't need to say anything else. Just paste it. Claude reads it and uses it for every response in that session.

For quick, low-stakes tasks — a one-line question, a quick fact-check, a syntax lookup — you don't need the context document. Reserve it for sessions where the output matters.
...
Draft an email to a customer whose monthly subscription failed to charge
last week and our automated dunning hasn't recovered it yet. Polite but
clear, two-line apology max, give them the self-service link to update
the card. Under 120 words.
```
...
**Mistake:** Writing a context document that's a general business description — something that reads like the "About Us" page on your marketing site. "We are a customer-obsessed SaaS committed to delivering exceptional outcomes for clinics across Australia." This is marketing copy. It tells Claude nothing about what you actually need.

**Better approach:** Write the context document for Claude specifically, not for an audience. Think about what a highly capable new hire would need to know on their first day working with you. What tasks will they do? What rules must they follow? How should they write? What's the one thing they should never get wrong? That's your context document. Concrete, operational, specific.
