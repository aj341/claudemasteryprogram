...
I run a small executive coaching practice in Melbourne called Anchor Coaching.
We work with mid-career managers stepping into their first GM or director role.
Most clients are in professional services and tech. I work solo, with one
contracted operations manager.

My ideal clients invest in a 6-month engagement, want a structured framework
not just a chat, and value direct feedback over flattery. We don't pitch on
price. Our language is warm, considered, and direct — not corporate.

Current focus: growing the practice in Melbourne and Sydney. I have four
active engagements and two in the proposal stage.

---

Message 2 — your task prompt:

Draft an outreach email to a Melbourne professional services firm whose
new GM was just announced internally. The email should introduce Anchor
Coaching, reference the appointment specifically, and ask for a 20-minute
conversation — not a full meeting. Tone: warm, curious, not salesy.
Under 180 words.
```
...
Notice what the context document in Message 1 does that the task prompt in Message 2 doesn't have to, {{firstName}}. It establishes the voice ("warm, considered, direct — not corporate"). It names the ideal client type. It states a current business focus. When Message 2 arrives asking for an outreach email with a "warm, curious, not salesy" tone, Claude isn't guessing at what that means for this particular practice — it already has the frame. That's the practical value of the two-message structure: the context message does the briefing work, the task message does the directing work, and neither has to carry both at once.
...
from any coach. Rewrite just the opening two sentences to make them
specific to Anchor Coaching's focus on first-time GMs in professional
services. Keep everything else the same.
```
