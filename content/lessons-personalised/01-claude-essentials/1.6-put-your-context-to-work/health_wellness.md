...
You're not practising here. You're producing an output you can actually use. By the end of this lesson, {{firstName}}, you'll have run a complete Claude session on a meaningful task from your task map, and you'll have something tangible to show for it — not a worked example, not a sample, but your own work.
...
I'm {{firstName}}, and I run a small allied health clinic in Melbourne called
{{businessName}}. We're a 3-practitioner physiotherapy and exercise physiology
practice working mainly with adults aged 35–70 on persistent musculoskeletal
issues and post-surgical rehab. We have 3 clinicians and 1 part-time front-desk
admin.

Our ideal clients want a longer 4-to-8-session course of care rather than a
one-off treatment, value clear home exercise programs, and trust GP referrals.
We don't compete on rebate price. Our language is calm, warm, and direct —
not clinical-textbook, not "wellness" fluff.

Current focus: building stronger referral relationships with two local GP
clinics and a sports medicine specialist. We have ten active rehab cases and
three new referrals this week.

---

Message 2 — your task prompt:

Draft an outreach email to a Melbourne GP practice that has recently
added a fourth doctor. The email should introduce {{businessName}},
reference their expansion specifically, and ask for a 20-minute
conversation — not a full meeting — to talk about referral pathways for
musculoskeletal cases. Tone: confident, curious, not salesy.
Under 180 words.
```
...
from any allied health clinic. Rewrite just the opening two sentences to
make them specific to {{businessName}}'s focus on persistent musculoskeletal
issues and rehab. Keep everything else the same.
```
