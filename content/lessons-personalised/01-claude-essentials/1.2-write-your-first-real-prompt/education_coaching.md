...
"Write a parent update email."

With them:
"I run a 6-tutor maths and English service in Adelaide. I need to send a
mid-term update email to a parent whose Year 9 son has been with us for
two terms. This term he's lifted from a low C to a solid B in maths and
his confidence has noticeably picked up — we'd like to flag the next
step is preparing for his end-of-year exam. The tone should be warm but
professional — parents here are time-poor. Keep it under 200 words. End
with a brief note on what we'll cover next term."
```
...
- "The third paragraph isn't accurate — Term 2 enrolments aren't open yet, only expressions of interest. Update that section."
...
**Better approach:** "I run {{businessName}}, an executive coaching practice in Geelong working with mid-career managers stepping into their first GM role. I want to write a LinkedIn post about a real situation: a client came to me three weeks before her first board presentation in a quiet panic — she'd been over-rehearsing the deck and lost the thread of her own argument. We rebuilt it in one session by stripping back to three claims. I want managers who see this to think 'that could be me.' Conversational tone, not formal. Around 150 words. No hashtags — I want it to read like a story, not a marketing post."
