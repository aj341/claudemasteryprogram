...
**Context.** Who you are, what your practice does, and any relevant background about the specific situation. Claude doesn't know you. The context is what separates an output that could have been written for any bookkeeper from one that's actually useful for {{businessName}}.
...
**Format.** What the output should look like. A bulleted list. A client email. A 3-paragraph file note. A table with two columns. A one-page fee proposal. If you don't specify, Claude picks a format — and it may not be the one that's useful to you.
...
With them:
"I run a sole-practitioner bookkeeping practice in Adelaide. I need to send
a monthly update email to one of our long-term clients — a 12-staff cafe
group. This month we completed their FY25 BAS reconciliation ahead of
the lodgement deadline, and we've flagged a small discrepancy in their
PAYG that we're resolving with their payroll software vendor next week.
The tone should be professional but warm — we've worked with them for
4 years. Keep it under 200 words. End with a brief note on what's coming
next month."
```
...
**Step 2: Add the context.** Who are you? What does your practice do? What's the specific situation this task relates to? Write this as if you're briefing someone who is smart but knows nothing about your client base. One or two sentences is usually enough.

**Step 3: Describe the output you need.** What does done look like? A 200-word client email? A bulleted list? A formal one-page fee proposal? A casual internal note? Tell Claude what shape the answer should take.
...
This isn't a rigid formula — some steps aren't needed for simple tasks. But for anything going to a client, the ATO, or another firm, that minute upfront saves five minutes of editing later.
...
This matters more than it seems. If you don't specify a format, Claude will choose one — and it will usually choose something reasonable. But "reasonable" and "what you actually need" are different things. A list when you needed a paragraph. A formal memo when you needed a casual file note. Three pages when you needed one.

Format instructions can be short. "Bulleted list, no more than ten points." "Client email, under 200 words." "Three short paragraphs, plain language." "A table with two columns: task and estimated lodgement time." One sentence on format can save five minutes of reformatting the output into the shape you needed.
...
"Be specific" is easy advice and hard to act on when you're staring at a blank text box. Here's a question that helps: if you were briefing a capable junior bookkeeper on this task, what would you need to tell them to make sure they got it right?
...
- "That's close, but the tone is too formal for this client — they're a small family business. Rewrite it to sound more like a trusted adviser, not a Big-4 partner."
- "The structure is good but it's too long. Cut it to 150 words, keeping the three main points about the lodgement extension."
- "The second paragraph isn't accurate — we haven't lodged the BAS yet, only finalised the working papers. Update that section."
