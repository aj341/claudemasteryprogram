...
Most people's first Claude prompt is a test. "Write me a summary of AI in real estate." "Give me some ideas for a prospecting email." These are reasonable ways to check what the tool can do. They are not useful for work.

A real prompt has a real task behind it. Something you actually need done — a vendor update after Saturday's open home, a tenant notice that needs to go out today, a CMA narrative for a listing pitch — with a specific audience, a specific context, and a specific idea of what "good" looks like. When you write a prompt like that, you stop testing Claude and start using it.

That's what this lesson is for. By the end you'll have written and submitted a real prompt for an actual task in your agency, seen what comes back, and understood why it worked or didn't.
...
**Context.** Who you are, what your agency does, and any relevant background about the specific situation — the vendor, the property, the campaign stage. Claude doesn't know you. The context is what separates an output that could have been written for any agent from one that's actually useful for {{businessName}}.
...
**Format.** What the output should look like. A bulleted list. A vendor email. A 3-paragraph CMA narrative. A table with two columns. A one-page owner report. If you don't specify, Claude picks a format — and it may not be the one that's useful to you.
...
"Write a vendor update email."

With them:
"I run a 6-person agency in suburban Melbourne. I need to send a post-open-home
update to a vendor whose 3-bed townhouse has been on market for 3 weeks. We had
9 groups through on Saturday, two contract requests, but no offers yet. The vendor
is anxious — they're already in their next contract elsewhere. Tone should be calm
and confident, not defensive. We've worked with them once before, on the sale
that funded this purchase. Keep it under 200 words. End with a clear next step
for the coming week."
```
...
**Step 2: Add the context.** Who are you? What does your agency do? What's the specific situation — which vendor, which listing, which tenant? Write this as if you're briefing someone who is sharp but new to your business. One or two sentences is usually enough.

**Step 3: Describe the output you need.** What does done look like? A 200-word vendor update? A bulleted list of contract special conditions? A formal one-page owner report? A casual internal note for your PM team? Tell Claude what shape the answer should take.
...
This isn't a rigid formula — some steps aren't needed for simple tasks. But for anything going to a vendor, a tenant, an owner, or out in public, that minute upfront saves five minutes of editing later.
...
This matters more than it seems. If you don't specify a format, Claude will choose one — and it will usually choose something reasonable. But "reasonable" and "what you actually need" are different things. A list when you needed a paragraph for the listing copy. A formal letter when you needed a quick text-style note. Three pages when you needed one.

Format instructions can be short. "Bulleted list, no more than ten points." "Vendor email, under 200 words." "Three short paragraphs, plain language." "A table with two columns: feature and CMA comparable." One sentence on format can save five minutes of reformatting the output into the shape you needed.

If you're submitting something straight to a vendor, an owner, or onto a portal listing without major editing, be explicit about format before Claude writes a word. It's the fastest way to get something usable on the first attempt.

### Why "be more specific" is hard — and what to do about it

"Be specific" is easy advice and hard to act on when you're staring at a blank text box. Here's a question that helps: if you were briefing a sharp new sales rep on this task, what would you need to tell them to make sure they got it right?

The answer to that question is your prompt. The context you'd give a capable new hire is exactly what Claude needs. Claude is not a mind-reader. It is, however, very good at following clear instructions — because it doesn't get tired, distracted, or reluctant to ask clarifying questions.
...
- "That's close, but the tone is too formal for this vendor. Rewrite it to sound more like an agent who's been working with them for years."
- "The structure is good but it's too long. Cut it to 150 words, keeping the three main points about buyer feedback."
- "The third paragraph isn't accurate — we haven't received a written offer yet, only verbal interest. Update that section."
...
**Mistake:** "Write me a LinkedIn post about my agency."

Claude produces something generic — a paragraph with hashtags about "your local property experts," maybe a sign-off about "making your dream home a reality." It's technically publishable. It's also something no one will read twice.

**Better approach:** "I run a 4-person buyer's agency in inner-west Sydney. I want to write a LinkedIn post about a real situation: a young couple came to me after losing four auctions in a row. We took them out of the auction circuit, found an off-market townhouse through a vendor relationship, and they exchanged at $40k under their last failed bid. I want first-home buyers who see this to think 'that could be me.' Conversational tone, not formal, {{firstName}}. Around 150 words. No hashtags — I want it to read like a story, not a marketing post."
