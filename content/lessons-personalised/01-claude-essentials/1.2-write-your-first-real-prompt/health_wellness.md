...
Most people's first Claude prompt is a test. "Write me a summary of AI in healthcare." "Give me some ideas for a patient newsletter." These are reasonable ways to check what the tool can do. They are not useful for work.
...
With them:
"I'm {{firstName}}, and I run a 3-practitioner physiotherapy clinic in Brisbane called {{businessName}}. I need to send a monthly
referrer update to one of our local GP clinics — a 6-doctor practice that
refers around 8 patients to us each month. This month we completed early
reviews on three workplace-injury cases ahead of schedule, and we've flagged
one rehabilitation case where we'd appreciate a quick chat about return-to-work
timing. The tone should be professional but warm — we've worked with them
for 4 years. Keep it under 200 words. End with a brief note on what's coming
next month."
```
...
Where {{firstName}} or anyone else goes wrong in revision is making the instruction too vague. "Make it better" gives Claude nothing to work with. Better in what way — tone, structure, length, accuracy? Name the specific thing that isn't working.
...
**Mistake:** "Write me a LinkedIn post about my practice."
...
**Better approach:** "I'm {{firstName}}, an osteopath running a small clinic in Geelong called {{businessName}} that sees a lot of office workers with persistent neck and shoulder pain. I want to write a LinkedIn post about a real situation: a client came in convinced she needed a scan for chronic headaches, and after a careful assessment we traced it back to a poorly set-up home desk — three sessions and one ergonomic tweak later, the headaches were gone. I want desk-bound workers who see this to think 'that could be me.' Conversational tone, not formal. Around 150 words. No hashtags — I want it to read like a story, not a marketing post."
