...
**Context.** Who you are, what your product does, and any relevant background about the specific situation. Claude doesn't know you. The context is what separates an output that could have been written for any SaaS from one that's actually useful for {{businessName}}.
...
**Format.** What the output should look like. A bulleted list. A customer-facing email. A 3-paragraph internal note. A table with two columns. A one-page changelog entry. If you don't specify, Claude picks a format — and it may not be the one that's useful to you.
...
"Write a customer update email."

With them:
"I run a 14-person vertical SaaS in Melbourne — we sell rostering
software to AU/NZ allied-health clinics. I need to send a monthly
update email to one of our anchor accounts — a 22-clinic physio group
who've been with us for 18 months. This month we shipped their two
top feature requests (bulk-shift import, custom payroll exports), and
we've flagged one outstanding bug in the leave-balance calculation
that we're patching next week. Tone: warm but direct — their ops
manager hates corporate fluff. Keep it under 200 words. End with what
they'll see in the next release."
```
...
**Step 2: Add the context.** Who are you? What does your product do? What's the specific situation this task relates to? Write this as if you're briefing a new hire who is smart but knows nothing about your business. One or two sentences is usually enough.

**Step 3: Describe the output you need.** What does done look like? A 200-word email? A bulleted list of churn drivers? A formal one-page release note? A casual internal Slack message? Tell Claude what shape the answer should take.

**Step 4: Add your constraints.** Tone, length, what to include, what to leave out, the audience who'll read it — a CS lead, a trial user, a long-time customer. At least one constraint makes the output usable. Two or three makes it close to right on the first attempt.
...
This isn't a rigid formula — some steps aren't needed for simple tasks. But for anything going to a customer, a teammate, or out in public, that minute upfront saves five minutes of editing later.
...
This matters more than it seems. If you don't specify a format, Claude will choose one — and it will usually choose something reasonable. But "reasonable" and "what you actually need" are different things. A list when you needed a paragraph. A formal memo when you needed a casual Slack note. Three pages when you needed one.

Format instructions can be short. "Bulleted list, no more than ten points." "Customer-facing email, under 200 words." "Three short paragraphs, plain language." "A table with two columns: theme and quote count." One sentence on format can save five minutes of reformatting the output into the shape you needed.

If you're sending something directly to a customer or pasting it straight into Intercom or Beehiiv, be explicit about format before Claude writes a word. It's the fastest way to get something usable on the first attempt.

### Why "be more specific" is hard — and what to do about it

"Be specific" is easy advice and hard to act on when you're staring at a blank text box. Here's a question that helps: if you were briefing a capable new hire on this task, what would you need to tell them to make sure they got it right?

The answer to that question is your prompt. The context you'd give a competent new joiner is exactly what Claude needs. Claude is not a mind-reader. It is, however, very good at following clear instructions — because it doesn't get tired, distracted, or reluctant to ask clarifying questions.
...
- "That's close, but the tone is too formal for this customer. Rewrite it to sound more like a founder talking to an ops manager who already knows us."
- "The structure is good but it's too long. Cut it to 150 words, keeping the three main points."
- "The second paragraph isn't accurate — we haven't shipped the bulk import yet, only the design spec. Update that section."
...
**Mistake:** "Write me a LinkedIn post about my product."

Claude produces something generic — a paragraph with hashtags, maybe an aspirational sign-off about "transforming the way teams work." It's technically publishable. It's also something no one will read twice.

**Better approach:** "I'm {{firstName}}, technical co-founder of a 6-person micro-SaaS that sells a Stripe-billing helper to AU indie makers. I want to write a LinkedIn post about a real situation: a customer DM'd us last week saying our automated dunning emails saved a $2,400/year account that would have churned to a failed-card error. Their previous tool just sent the customer to a 'subscription cancelled' page after one retry. I want indie makers who see this to think 'that could save my MRR.' Conversational tone, not formal. Around 150 words. No hashtags — I want it to read like a story, not a marketing post."
