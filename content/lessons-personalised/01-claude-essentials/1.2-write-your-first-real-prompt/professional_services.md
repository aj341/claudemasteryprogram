...
Most people's first Claude prompt is a test. "Write me a summary of AI in business." "Give me some ideas for a marketing email." These are reasonable ways to check what the tool can do. They are not useful for client work.
...
That's what this lesson is for, {{firstName}}. By the end you'll have written and submitted a real prompt for an actual task in your practice, seen what comes back, and understood why it worked or didn't.
...
**Context.** Who you are, what your firm does, and any relevant background about the specific engagement. Claude doesn't know you. The context is what separates an output that could have been written for any consultant from one that's actually useful for {{businessName}}.
...
**Format.** What the output should look like. A bulleted list. A status update. A 3-paragraph engagement summary. A table with two columns. A one-page scope of work. If you don't specify, Claude picks a format — and it may not be the one that's useful to you.
...
With them:
"I run a 5-person HR consultancy in Perth. I need to send a monthly
update email to one of our long-term clients — a 40-staff manufacturing
business. This month we completed their performance review framework
ahead of schedule, and we've flagged one outstanding issue with their
grievance policy that we're resolving next fortnight. The tone should
be professional but warm — we've worked with them for 4 years. Keep it
under 200 words. End with a brief note on what's coming next month."
```
...
**Step 2: Add the context.** Who are you? What does your practice do? What's the specific engagement this task relates to? Write this as if you're briefing someone who is smart but knows nothing about your client base. One or two sentences is usually enough.

**Step 3: Describe the output you need.** What does done look like? A 200-word client email? A bulleted list? A formal one-page scope of work? A casual internal note? Tell Claude what shape the answer should take.
...
This isn't a rigid formula — some steps aren't needed for simple tasks. But for anything going to a client, a prospect, or out in public, that minute upfront saves five minutes of editing later.
...
Format instructions can be short. "Bulleted list, no more than ten points." "Client status update, under 200 words." "Three short paragraphs, plain language." "A table with two columns: deliverable and estimated hours." One sentence on format can save five minutes of reformatting the output into the shape you needed.

If you're sending something directly to a client or using the output without major editing, be explicit about format before Claude writes a word. It's the fastest way to get something usable on the first attempt.

### Why "be more specific" is hard — and what to do about it

"Be specific" is easy advice and hard to act on when you're staring at a blank text box. Here's a question that helps: if you were briefing a capable junior consultant on this task, what would you need to tell them to make sure they got it right?
...
- "That's close, but the tone is too formal for this client — they're an owner-operator. Rewrite it to sound more like a trusted adviser, not a Big-4 partner."
- "The structure is good but it's too long. Cut it to 150 words, keeping the three main points about the discovery findings."
- "The second paragraph isn't accurate — we haven't finished the workshops yet, only the stakeholder interviews. Update that section."
...
**Mistake:** "Write me a LinkedIn post about my consultancy."
...
**Better approach:** "I run a solo management consultancy in Brisbane that helps owner-operated trades businesses untangle ops bottlenecks before they hire a GM. I want to write a LinkedIn post about a real situation: a client came to me convinced they needed another estimator, and after a half-day discovery we found the real problem was their quoting handoff — two days lost between estimating and admin every week. We fixed the handoff in a fortnight; no new hire needed. I want owner-operators who see this to think 'that could be me.' Conversational tone, not formal. Around 150 words. No hashtags — I want it to read like a story, not a marketing post."
