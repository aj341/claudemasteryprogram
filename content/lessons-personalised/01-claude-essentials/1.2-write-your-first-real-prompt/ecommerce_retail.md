...
**Context.** Who you are, what {{businessName}} sells, and any relevant background about the specific situation. Claude doesn't know you. The context is what separates an output that could have been written for any retailer from one that's actually useful for your store.
...
**Format.** What the output should look like. A bulleted list. A customer email. A 3-paragraph product description. A table with two columns. A one-page brief. If you don't specify, Claude picks a format — and it may not be the one that's useful to you.
...
With them:
"I run a Shopify homewares store doing about $400k a year. I need to send
a single email to the 230 customers who pre-ordered our linen bedding range
in February. The factory has confirmed dispatch is now four weeks late —
shipping mid-May instead of mid-April. The tone should be honest and warm,
not corporate damage-control. Keep it under 200 words. End with what we're
doing for them — a 15% credit on their next order."
```
...
**Step 2: Add the context.** Who are you? What does your business sell? What's the specific situation this task relates to? Write this as if you're briefing someone who is smart but knows nothing about {{businessName}}. One or two sentences is usually enough.

**Step 3: Describe the output you need.** What does done look like? A 200-word email? A bulleted list? A formal one-page summary? A casual SMS to a wholesale stockist? Tell Claude what shape the answer should take.

**Step 4: Add your constraints.** Tone, length, what to include, what to leave out, the customer who'll read it. At least one constraint makes the output usable. Two or three makes it close to right on the first attempt.
...
This isn't a rigid formula — some steps aren't needed for simple tasks. But for anything going to a customer, a supplier, or out on your store, that minute upfront saves five minutes of editing later.
...
This matters more than it seems. If you don't specify a format, Claude will choose one — and it will usually choose something reasonable. But "reasonable" and "what you actually need" are different things. A list when you needed a paragraph. A formal memo when you needed a chatty post-purchase note. Three pages when you needed one.

Format instructions can be short. "Bulleted list, no more than ten points." "Customer email, under 200 words." "Three short paragraphs, plain language." "A table with two columns: SKU and reorder quantity." One sentence on format can save five minutes of reformatting the output into the shape you needed.

If you're sending something directly to a customer or using the output without major editing, be explicit about format before Claude writes a word. It's the fastest way to get something usable on the first attempt.

### Why "be more specific" is hard — and what to do about it

"Be specific" is easy advice and hard to act on when you're staring at a blank text box. Here's a question that helps: if you were briefing a new shop assistant on this task, what would you need to tell them to make sure they got it right?
...
- "That's close, but the tone is too formal for our brand. Rewrite it to sound more like a friend at the markets, not a department store."
- "The structure is good but it's too long. Cut it to 150 words, keeping the three main points."
- "The third paragraph isn't accurate — the linen range hasn't shipped yet, only the velvet cushions. Update that section."
...
**Mistake:** "Write me an Instagram caption about my new product."

Claude produces something generic — a paragraph with hashtags, maybe an aspirational sign-off. It's technically postable. It's also something no one will read twice.

**Better approach:** "I run a small homewares brand on Shopify. I'm launching a new range of hand-thrown ceramic mugs — 6 colours, $42 each, made in a small studio in regional Victoria. I want to write an Instagram caption for the launch post. The angle: every mug has small variations because they're hand-thrown — that's the feature, not a flaw. I want existing customers to read it and feel like they're getting something special, not a mass-produced product. Conversational tone. Around 90 words. No emojis. One soft call-to-action at the end pointing to the link in bio."

That caption produces something worth posting. The extra specificity — the real product, the real angle, the specific tone instruction, the format constraint, the explicit no-emojis — does the work that editing would otherwise have to do.
