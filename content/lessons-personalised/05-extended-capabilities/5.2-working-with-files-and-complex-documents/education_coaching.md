...
```
This is Section 3 of a tender response from a corporate training provider —
Methodology and Approach. It runs from pages 18 to 34. Please do two things:
1. Summarise the methodology in plain language — no more than 150 words.
2. List any specific commitments the provider makes in this section — exact
...
```
Below is an invoice from our workbook and resources supplier. The line items
are described in running prose, not a table. Please extract every line item
