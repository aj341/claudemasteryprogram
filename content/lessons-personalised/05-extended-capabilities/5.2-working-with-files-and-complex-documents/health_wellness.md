...
Claude can work with a range of file types for {{firstName}} and {{businessName}} — but they are not all equal. Understanding the hierarchy saves you a lot of frustration.
...
```
This is Section 3 of a corporate-wellness tender response — Methodology and Approach.
It runs from pages 18 to 34. Please do two things:
1. Summarise the methodology in plain language — no more than 150 words.
2. List any specific commitments {{businessName}} would be making in this section — exact
...
```
Below is an invoice from a clinical-supplies wholesaler. The line items are
...
**Summarising a long report.** Your professional association (e.g. APA or AHPRA) releases a 60-page sector outlook report. {{firstName}} has 10 minutes. Paste the executive summary and the conclusions section into Claude and ask it to produce: (1) a three-sentence overview, (2) the five most relevant findings for a business of your type and size, (3) any actions or recommendations aimed at businesses like yours. You get what you need without reading the whole document.

**Reviewing a tender or proposal.** A corporate-wellness manager sends {{businessName}} a 25-page tender brief. You need to understand what they're offering, what they've committed to, and what's vague. Use the section-by-section pass approach from earlier. Or, if it's short enough, upload the whole thing and ask Claude to: (1) summarise what's included in scope, (2) list explicit commitments, (3) list anything described vaguely that you'd need to clarify before signing.
