...
That structure — describe what you're sending, then state what you need — applies to every vision task. A receipt: "This is a supplier receipt from our last workbook order. Extract the vendor name, date, line items, and GST total." A scanned letter: "This is a letter from our landlord about the lease renewal on our tutoring centre. Summarise the key dates and any requests they are making." A design file: "This is a draft of our new term flyer for parents. Tell me if the hierarchy is clear — can someone find the new Year 9 group session quickly, or does the layout make it hard?"
...
```
I've uploaded a screenshot of our Google Analytics dashboard for March. This is for our tutoring service website. We sell nationally but most enquiries come from VIC and NSW parents.

I need you to:
1. Pull out the three or four headline numbers visible in the screenshot (sessions, contact-form rate, enquiry volume, or whatever is shown)
