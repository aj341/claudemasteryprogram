...
The single biggest mistake tradies make when setting up their first Claude Project is trying to build the most complete one possible. They pick the broadest, most ambitious use case — "a Project for everything customer-facing" or "a Project for all my admin" — and then spend so long trying to configure it that they never actually use it.
...
Here's how to identify it. Look at your task list from Lesson 1.4 — the map of your recurring weekly admin. Find the task that has all three of these qualities: you do it often, it's frustrating to do from scratch each time at 8pm at the kitchen table, and it requires consistent context that you're currently re-explaining manually. That's your first Project.

For most {{businessName}}-sized trades businesses, one of these three candidates usually wins:

**Customer communication.** You write quote follow-ups, customer updates, and end-of-job emails constantly, and Claude doesn't know your tone, your business name, your typical relationship with the homeowner, or any of the recurring topics. A Customer Communication Project changes that. Every message Claude helps you draft already knows who you are.

**Quote and variation drafting.** You write similar quotes regularly, but each one needs your specific service structure, rate card, and language. A Quote Project makes every draft start from your actual offering — not a blank page in Tradify or simPRO.

**Internal documentation.** You create SWMS, JSAs, induction notes, and apprentice training docs but they never quite sound like your business. A Documentation Project gives Claude your terminology, your standards, and your format preferences so the output is ready to use, not ready to rewrite.
...
**Part 1 — Who you are.** Your name, your role, your business name, what your trade actually covers, how many people work there, and what state or region you're in. Claude needs to know the actual facts — not a general category. "I'm a sole trader" is almost useless. "I'm Sarah Park, sole-trader sparkie in Hobart, doing residential rewires and switchboard upgrades for 60 or so homeowners a year" gives Claude what it needs to calibrate everything that follows.

**Part 2 — What this Project is for.** State the specific purpose of this Project in one or two sentences. This sets the scope. If the Project is for customer-facing quotes, say so. Claude should understand, from this section alone, what kinds of tasks to expect. It should also understand what's out of scope — don't ask Claude to guess the boundaries.

**Part 3 — What Claude should always do.** List the consistent behaviours you want in every response. Use Australian English. Match the tone of the voice you've described. Start every quote with the homeowner's name and our business name in the header. Always flag anything that looks like a compliance issue. These are the standing instructions that apply to every single interaction in this Project.

**Part 4 — What Claude should never do.** This is the section most tradies skip, and it's where a lot of Projects fail. "Never do" instructions need to be specific and operational — not generic. "Never be rude" is not useful. Claude isn't going to be rude. Useful "never do" instructions sound like this: "Never suggest jobs that need more than two of us on site." "Never include a price — I work that out manually after Claude drafts the scope." "Never use the words 'leverage' or 'synergy' in any output." "Never recommend the homeowner ring another sparkie for any part of our core work." These are constraints that have real consequences if violated.

**Part 5 — The default output format.** What does a typical output from this Project look like? Bullet lists? Short paragraphs? A structured quote with headings? A specific word count range? State it here. If most of your outputs are emails under 200 words, say so. If most are structured variations with three sections, describe those sections. Format defaults save you the effort of specifying format in every prompt.
...
builder in southeast Queensland. We build new homes and major renos, typically
8–12 active sites at any time. I manage four site supervisors and handle all
sub-contractor and homeowner communication. I report to my old man, who's the
director.

WHAT THIS PROJECT IS FOR
This Project is for drafting and reviewing customer-facing communications:
progress updates, variation notices, delay messages, and replies to homeowner
questions. This Project is NOT for internal job-management, financial documents,
or anything legal.

WHAT CLAUDE SHOULD ALWAYS DO
- Write in plain, direct Australian English — no construction jargon unless I
  use it first
- Keep emails to three paragraphs or fewer unless I specifically request more
- When a message involves a scope or cost change, structure it as: (1) what
  changed, (2) why it changed, (3) what happens next
- Flag any draft that involves a dispute, complaint, or potential claim with
  the note "REVIEW BEFORE SENDING — possible dispute territory"

WHAT CLAUDE SHOULD NEVER DO
- Make any commitment about final handover dates — I'll add those manually
- Suggest the homeowner speak to a competing builder or third-party consultant
- Use apologetic language that implies the company is at fault before I've
  confirmed that — write "we're looking into this" not "we're sorry for the
  problem"
- Include specific dollar figures in any draft — I always insert those after
  review

DEFAULT OUTPUT FORMAT
Email format: subject line, then three short paragraphs of plain prose. No
bullet lists in homeowner emails. Professional but conversational tone — not
corporate. Under 200 words unless I request otherwise.
```

That is 281 words. It takes 20 minutes to write once. It saves you time and inconsistency across every session you use this Project.
...
**Better approach:** Write "never do" instructions that reflect the specific risks and standards of your business. Ask yourself: what's the one thing Claude could produce in this Project that would cause me a real problem? A commitment I didn't authorise? A tone that damages a homeowner relationship? A suggestion that conflicts with my service model? That's your "never do." It should be specific enough that you can picture the exact output it prevents.
...
Knowledge documents are the reference material Claude draws on when you're working. For a Customer Communication Project, that might be your service agreement template, your standard terms, or a one-page description of each service you offer. For a Quote Project, it might be your rate card, your scope inclusions, and a set of example quotes that represent the quality and format you're aiming for.

The rule for selecting documents is: include what Claude genuinely needs to know to produce a better output than it could without it. That sounds obvious, but most tradies violate it by treating their Project like a filing cabinet. They upload everything that feels relevant and end up with a cluttered, unfocused Project where Claude has to wade through documents to find what it needs.
...
What not to include: confidential customer records, anything containing personal data about individuals, financial statements, documents that change frequently enough that Claude's version will be out of date within weeks, and long strategic documents that contain only a small amount of information Claude actually needs. If a document is 50 pages but only 5 pages are relevant, extract those 5 pages and upload that version.

Prepare your documents before uploading. Remove customer names if they appear. Check that the document actually represents your current way of working — don't upload an SWMS from 2022 if it's been superseded. Give each file a clear filename so you can tell at a glance what it contains.
...
**Test 2: Task test.** Send a realistic task — the kind of thing you'll actually use this Project for. If it's a Customer Communication Project, draft a message about a common scenario: a quote follow-up, a reply to a query, a variation notice. Review the output against your expectations. Does it match your tone? Does it apply the format defaults? Does it avoid the things you told it to avoid? This is where you catch the gaps in your instructions before they matter.

**Test 3: Constraint test.** Send a prompt that deliberately triggers one of your "never do" rules. If you told Claude never to include prices, ask it to draft a quote and see if it includes pricing. If you told it to flag dispute-related content, send a message that describes a homeowner complaint and check that the flag appears. If your constraints are working, Claude should either comply with the rule or tell you why it can't. If it ignores the constraint entirely, rewrite that instruction to be more specific.

Once all three tests produce results that look right, your Project is ready. Use it for real.

### The maintenance cycle

A Claude Project is not a one-time setup. It's a working document that should evolve as {{businessName}} does.

You need to update your Project when any of the following happen: your services change, your standard terms change, your team structure changes (apprentice on, sub-contractor off), you find Claude consistently getting something wrong (that's a sign a rule is missing or unclear), or a worked example you uploaded is no longer representative of what you want.

The maintenance interval for most trades businesses is every one to three months. Set a calendar reminder. Open your Project, read the custom instructions, and ask yourself: does this still describe how my business works? Does the "never do" list still cover the risks I actually face? Are the knowledge documents still current?
