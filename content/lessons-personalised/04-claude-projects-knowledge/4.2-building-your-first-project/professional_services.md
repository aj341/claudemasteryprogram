...
For most consultants and advisors, one of these three candidates usually wins:

**Client communication.** You write emails and post-meeting recaps to clients constantly, and Claude doesn't know your tone, your firm name, your typical relationship style, or any of the recurring topics. A Client Communication Project changes that. Every message Claude helps you draft already knows who you are.

**Scope or fee proposal drafting.** You write similar scopes and fee proposals regularly, but each one needs your specific service structure, deliverable framework, and language. A Proposal Project makes every draft start from your actual offering, not a blank page.

**Internal documentation.** You create method notes, engagement playbooks, and process guides but they never quite sound like your practice. A Documentation Project gives Claude your terminology, your standards, and your format preferences so the output is ready to use, not ready to rewrite.
...
**Part 1 — Who you are.** Your name, your role, your firm name, what your practice does, how many people work there, and what state or region you're in. Claude needs to know the actual facts — not a general category. "I'm a sole consultant" is almost useless. "I'm Sarah Park, sole-practitioner management consultant in Brisbane, working with 8–10 active SME clients on operating model and growth strategy" gives Claude what it needs to calibrate everything that follows.
...
**Part 3 — What Claude should always do.** List the consistent behaviours you want in every response. Use Australian English. Match the tone of the voice you've described. Start every scope of work with the client's name and our firm name in the header. Always flag anything that looks like a scope-creep risk. These are the standing instructions that apply to every single interaction in this Project.

**Part 4 — What Claude should never do.** This is the section most people skip, and it's where a lot of Projects fail. "Never do" instructions need to be specific and operational — not generic. "Never be rude" is not useful. Claude isn't going to be rude. Useful "never do" instructions sound like this: "Never suggest deliverables that require more than two consultants to execute." "Never include fee estimates — I provide those manually after Claude drafts the scope." "Never use the words 'leverage' or 'synergy' in any output." "Never recommend the client engage another firm for any part of our core service." These are constraints that have real consequences if violated.

**Part 5 — The default output format.** What does a typical output from this Project look like? Bullet lists? Short paragraphs? A structured document with headings? A specific word count range? State it here. If most of your outputs are emails under 200 words, say so. If most are structured scopes with four sections, describe those sections. Format defaults save you the effort of specifying format in every prompt.

Here's what a complete set of custom instructions looks like in practice:

```
WHO I AM
I'm Marcus Webb, principal of Webb HR Advisory — a 5-person HR consultancy in
Perth. We work with AU/NZ businesses (15–80 staff) on award compliance, restructure
support, and people strategy. I lead all client work and review every deliverable.
We typically run 6–10 active engagements at a time. I report to no one — I own
the firm.

WHAT THIS PROJECT IS FOR
This Project is for drafting and reviewing client-facing communications: status
updates, scope variation notices, timeline changes, and responses to client questions.
This Project is NOT for internal operations, fee negotiations, or legal correspondence.

WHAT CLAUDE SHOULD ALWAYS DO
- Write in plain, direct Australian English — no HR jargon unless I use
  it first
...
- Flag any draft that involves a complaint, grievance, or potential claim with the
...
- Suggest the client engage a competing consultancy or third-party advisor
...
Knowledge documents are the reference material Claude draws on when you're working. For a Client Communication Project, that might be your engagement letter template, your standard terms, or a one-page description of each service you offer. For a Proposal Project, it might be your fee tiers, your scope definitions, and a set of example proposals that represent the quality and format you're aiming for.
...
Keep it focused. A good first Project has two to four documents, not twenty. Each document should answer one of these questions: What do we actually offer? What does a finished deliverable look like? What rules apply to this type of work?
...
Prepare your documents before uploading. Remove client names if they appear. Check that the document actually represents your current practice — don't upload a method note from 2022 if it's been superseded. Give each file a clear filename so you can tell at a glance what it contains.
...
**Test 2: Task test.** Send a realistic task — the kind of thing you'll actually use this Project for. If it's a Client Communication Project, draft a message about a common scenario: a status update, a response to a query, a scope variation notice. Review the output against your expectations. Does it match your tone? Does it apply the format defaults? Does it avoid the things you told it to avoid? This is where you catch the gaps in your instructions before they matter.

**Test 3: Constraint test.** Send a prompt that deliberately triggers one of your "never do" rules. If you told Claude never to include fee estimates, ask it to draft a scope and see if it includes fees. If you told it to flag dispute-related content, send a message that describes a client complaint and check that the flag appears. If your constraints are working, Claude should either comply with the rule or tell you why it can't. If it ignores the constraint entirely, rewrite that instruction to be more specific.
...
The maintenance interval for most small firms is every one to three months. Set a calendar reminder. Open your Project, read the custom instructions, and ask yourself: does this still describe how the practice works? Does the "never do" list still cover the risks I actually face? Are the knowledge documents still current?
