...
The single biggest mistake founders make when setting up their first Claude Project is trying to build the most complete one possible. They pick the broadest, most ambitious use case — "a Project for everything marketing" or "a Project for all customer communications" — and then spend so long trying to configure it that they never actually use it.

Don't do that.

Your first Project should solve one specific problem you have this week at {{businessName}}. Not next month. This week. The test is simple: could this Project save you a meaningful chunk of time or produce a clearly better output before Friday? If yes, it's the right starting point. If you're thinking months ahead, you've picked the wrong one.
...
For most small SaaS founders, one of these three candidates usually wins:

**Customer communication.** You write emails, in-app messages, and Intercom replies to customers constantly, and Claude doesn't know your tone, your product name, your typical relationship style, or any of the recurring topics. A Customer Communication Project changes that. Every message Claude helps you draft already knows who you are.

**Release notes or feature announcements.** You publish similar release notes regularly, but each one needs your specific format, audience definition, and product language. A Release Note Project makes every draft start from your actual fortnightly release rhythm, not a blank page.

**Internal documentation.** You create help-centre articles, training notes, and SOPs but they never quite sound like your product. A Documentation Project gives Claude your terminology, your standards, and your format preferences so the output is ready to use, not ready to rewrite.
...
**Part 1 — Who you are.** Your name, your role, your product name, what your product does, how many people work there, and what city or region you're in. Claude needs to know the actual facts — not a general category. "I run a SaaS" is almost useless. "I'm Sarah Park, non-technical co-founder of Pacework, an 11-person project-billing SaaS in Hobart, with 380 paying customers" gives Claude what it needs to calibrate everything that follows.

**Part 2 — What this Project is for.** State the specific purpose of this Project in one or two sentences. This sets the scope. If the Project is for customer-success emails, say so. Claude should understand, from this section alone, what kinds of tasks to expect. It should also understand what's out of scope — don't ask Claude to guess the boundaries.

**Part 3 — What Claude should always do.** List the consistent behaviours you want in every response. Use Australian English. Match the tone of the voice you've described. Start every release note with the version and a one-line summary. Always flag anything that looks like a feature commitment or SLA claim. These are the standing instructions that apply to every single interaction in this Project.

**Part 4 — What Claude should never do.** This is the section most people skip, and it's where a lot of Projects fail. "Never do" instructions need to be specific and operational — not generic. "Never be rude" is not useful. Claude isn't going to be rude. Useful "never do" instructions sound like this: "Never invent a feature commitment — if I haven't told you it shipped, don't claim it's live." "Never include uptime or SLA numbers — I provide those manually after Claude drafts the surrounding copy." "Never use the words 'transform' or 'best-in-class' in any output." "Never recommend the customer use a competing product for any part of our core jobs-to-be-done." These are constraints that have real consequences if violated.

**Part 5 — The default output format.** What does a typical output from this Project look like? Bullet lists? Short paragraphs? A structured release note with headings? A specific word count range? State it here. If most of your outputs are customer emails under 200 words, say so. If most are release notes with four sections, describe those sections. Format defaults save you the effort of specifying format in every prompt.

Here's what a complete set of custom instructions looks like in practice:

```
WHO I AM
I'm Marcus Webb, technical co-founder of QuoteRail — a 6-person micro-SaaS in
southeast Queensland. We sell a quoting tool to AU plumbers and electricians,
about 540 paying customers on a $79/month plan. I handle product, engineering,
and most customer-facing comms. My co-founder runs sales and marketing.

WHAT THIS PROJECT IS FOR
This Project is for drafting and reviewing customer-facing communications:
release notes, feature announcements, change notifications, and replies to
common support questions. This Project is NOT for sales outbound, internal
operations, or legal correspondence.

WHAT CLAUDE SHOULD ALWAYS DO
- Write in plain, direct Australian English — no SaaS jargon unless I use it first
- Keep release notes to four short sections or fewer unless I specifically request more
- When a message involves a feature change or deprecation, structure it as: (1) what
  changed, (2) why it changed, (3) what the customer needs to do
- Flag any draft that involves a refund request, dispute, or potential claim with
  the note "REVIEW BEFORE SENDING — possible dispute territory"

WHAT CLAUDE SHOULD NEVER DO
- Make any commitment about future ship dates — I'll add those manually
- Suggest the customer use a competing tool for any part of their quoting workflow
- Use apologetic language that implies the company is at fault before I've confirmed
  that — write "we're looking into this" not "we're sorry for the issue"
- Include specific SLA numbers or uptime percentages in any draft — I always insert
  those after review

DEFAULT OUTPUT FORMAT
Email format: subject line, then three short paragraphs of plain prose. No bullet
lists in customer emails. Direct but warm tone — not corporate. Under 200 words
...
**Better approach:** Write "never do" instructions that reflect the specific risks and standards of your SaaS. Ask yourself: what's the one thing Claude could produce in this Project that would cause me a real problem? A feature commitment I didn't authorise? A tone that damages a strategic account? A suggestion that conflicts with our pricing or roadmap? That's your "never do." It should be specific enough that you can picture the exact output it prevents.
...
Knowledge documents are the reference material Claude draws on when you're working. For a Customer Communication Project, that might be your terms of service, your pricing tiers, or a one-page description of each plan. For a Release Note Project, it might be your changelog format, your audience definition, and a set of example release notes that represent the quality and format you're aiming for.

The rule for selecting documents is: include what Claude genuinely needs to know to produce a better output than it could without it. That sounds obvious, but most founders violate it by treating their Project like a filing cabinet. They upload everything that feels relevant and end up with a cluttered, unfocused Project where Claude has to wade through documents to find what it needs.

Keep it focused. A good first Project has two to four documents, not twenty. Each document should answer one of these questions: What does our product actually do? What does a finished output look like? What rules apply to this type of work?

What not to include: confidential customer records, anything containing personal data about individual users, internal financial dashboards, documents that change frequently enough that Claude's version will be out of date within weeks, and long strategic documents that contain only a small amount of information Claude actually needs. If a doc is 50 pages but only 5 pages are relevant, extract those 5 pages and upload that version.

Prepare your documents before uploading. Remove customer names if they appear. Check that the document actually represents your current product — don't upload an FAQ from 2022 if a feature has been deprecated since. Give each file a clear filename so you can tell at a glance what it contains.
...
**Test 1: Context check.** Ask Claude to summarise what it knows about you and this Project. You're checking that the custom instructions have been read and understood. The response should name your product, describe the Project's purpose, and be able to list the key "always do" and "never do" instructions. If Claude gives you a generic response or seems to be missing key facts, your custom instructions need revision.

**Test 2: Task test.** Send a realistic task — the kind of thing you'll actually use this Project for. If it's a Customer Communication Project, draft a message about a common scenario: a feature update, a reply to a billing query, a deprecation notice. Review the output against your expectations. Does it match your tone? Does it apply the format defaults? Does it avoid the things you told it to avoid? This is where you catch the gaps in your instructions before they matter.

**Test 3: Constraint test.** Send a prompt that deliberately triggers one of your "never do" rules. If you told Claude never to include SLA numbers, ask it to draft a customer-facing reliability update and see if it includes them. If you told it to flag dispute-related content, send a message that describes a customer refund request and check that the flag appears. If your constraints are working, Claude should either comply with the rule or tell you why it can't. If it ignores the constraint entirely, rewrite that instruction to be more specific.

Once all three tests produce results that look right, your Project is ready. Use it for real.

### The maintenance cycle

A Claude Project is not a one-time setup. It's a working document that should evolve as your product does.

You need to update your Project when any of the following happen: your features change, your pricing changes, your team structure changes, you find Claude consistently getting something wrong (that's a sign a rule is missing or unclear), or a worked example you uploaded is no longer representative of what you want.

The maintenance interval for most small SaaS teams is every one to three months. Set a calendar reminder. Open your Project, read the custom instructions, and ask yourself: does this still describe how the product works? Does the "never do" list still cover the risks I actually face? Are the knowledge documents still current?
