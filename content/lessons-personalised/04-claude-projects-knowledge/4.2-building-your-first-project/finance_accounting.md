...
The single biggest mistake accountants make when setting up their first Claude Project is trying to build the most complete one possible. They pick the broadest, most ambitious use case — "a Project for everything tax" or "a Project for all client communications" — and then spend so long trying to configure it that they never actually use it.

Don't do that, {{firstName}}.
...
For most accountants and bookkeepers, one of these three candidates usually wins:

**Client communication.** You write emails and messages to clients constantly — BAS reminders, lodgement-due nudges, scope clarifications — and Claude doesn't know your tone, your firm name, your typical relationship style, or any of the recurring topics. A Client Communication Project changes that. Every message Claude helps you draft already knows who you are.

**Fee proposal drafting.** You write similar fee proposals regularly, but each one needs your specific service structure, fee framework, and language. A Fee Proposal Project makes every draft start from your actual offering, not a blank page.

**Internal practice documentation.** You create SOPs, training notes, and process guides for staff — how we onboard a new client, our BAS prep checklist, our review-meeting workflow — but they never quite sound like {{businessName}}. A Documentation Project gives Claude your terminology, your standards, and your format preferences so the output is ready to use, not ready to rewrite.
...
**Part 1 — Who you are.** Your name, your role, your firm name, what your practice does, how many people work there, and what state or region you're in. Claude needs to know the actual facts — not a general category. "I'm a sole trader" is almost useless. "I'm Sarah Park, sole-trader registered tax agent in Hobart, servicing 22 small business clients in hospitality and retail" gives Claude what it needs to calibrate everything that follows.

**Part 2 — What this Project is for.** State the specific purpose of this Project in one or two sentences. This sets the scope. If the Project is for client fee proposals, say so. Claude should understand, from this section alone, what kinds of tasks to expect. It should also understand what's out of scope — don't ask Claude to guess the boundaries.

**Part 3 — What Claude should always do.** List the consistent behaviours you want in every response. Use Australian English (lodgement, organisation, behaviour, programme). Match the tone you've described. Start every fee proposal with the client's name and our firm name in the header. Always flag anything that looks like a TPB or compliance risk. These are the standing instructions that apply to every single interaction in this Project.

**Part 4 — What Claude should never do.** This is the section most accountants skip, and it's where a lot of Projects fail. "Never do" instructions need to be specific and operational — not generic. "Never be rude" is not useful. Claude isn't going to be rude. Useful "never do" instructions sound like this: "Never frame outputs as finished tax advice — frame as drafts for my review." "Never include specific ATO rates or section numbers — I provide those manually after Claude drafts the explanation." "Never use US tax terminology (no IRS, 1099, 401(k))." "Never recommend the client use a different accountant for any part of our core service." These are constraints that have real consequences if violated.

**Part 5 — The default output format.** What does a typical output from this Project look like? Bullet lists? Short paragraphs? A structured document with headings? A specific word count range? State it here. If most of your outputs are client emails under 200 words, say so. If most are structured fee proposals with four sections, describe those sections. Format defaults save you the effort of specifying format in every prompt.

Here's what a complete set of custom instructions looks like in practice:

```
WHO I AM
I'm Marcus Webb, principal of Webb Accounting Partners — a 4-person family-run
practice in southeast Queensland. We do compliance and advisory work for around
70 small business clients, typically owner-operators in trades, hospitality, and
allied health. I'm a registered tax agent and CPA. I manage three staff and handle
all client-facing partner-level work.

WHAT THIS PROJECT IS FOR
This Project is for drafting and reviewing client-facing communications: BAS
and lodgement reminders, scope clarifications, fee-related notices, and responses
to client questions. This Project is NOT for internal operations, technical tax
research, or formal letters of advice.

WHAT CLAUDE SHOULD ALWAYS DO
- Write in plain, direct Australian English — no audit jargon unless I use it first
- Keep emails to three paragraphs or fewer unless I specifically request more
- When a message involves a scope or fee change, structure it as: (1) what changed,
  (2) why it changed, (3) what happens next
- Flag any draft that involves a complaint, dispute, or possible TPB issue with
  the note "REVIEW BEFORE SENDING — possible dispute territory"

WHAT CLAUDE SHOULD NEVER DO
- Make any commitment about lodgement dates or refund amounts — I'll add those manually
- Suggest the client speak to a competing accountant or unrelated third party
- Use apologetic language that implies the firm is at fault before I've confirmed
  that — write "we're looking into this" not "we're sorry for the problem"
- Include specific dollar figures, ATO rates, or section numbers in any draft —
  I always insert those after review

DEFAULT OUTPUT FORMAT
Email format: subject line, then three short paragraphs of plain prose. No bullet
lists in client emails. Professional but conversational tone — not Big-4 audit.
Under 200 words unless I request otherwise.
```

That is 295 words. It takes 20 minutes to write once. It saves you time and inconsistency across every session you use this Project.

### Common mistake → better approach

**Mistake:** Writing "never do" instructions that describe generic AI behaviour — things like "never make things up" or "always be accurate." These are baseline expectations for any Claude interaction. They don't actually constrain the Project's behaviour in ways that matter for your specific practice.

**Better approach:** Write "never do" instructions that reflect the specific risks and standards of your practice. Ask yourself: what's the one thing Claude could produce in this Project that would cause me a real problem with the TPB or with a client? A commitment I didn't authorise? A tone that damages a long-term client relationship? A suggestion that conflicts with our scope letter? That's your "never do." It should be specific enough that you can picture the exact output it prevents.
...
Knowledge documents are the reference material Claude draws on when you're working. For a Client Communication Project, that might be your standard engagement letter template, your terms of engagement, or a one-page description of each service you offer. For a Fee Proposal Project, it might be your fee tiers, your scope definitions, and a set of example proposals that represent the quality and format you're aiming for.

The rule for selecting documents is: include what Claude genuinely needs to know to produce a better output than it could without it. That sounds obvious, but most accountants violate it by treating their Project like a filing cabinet. They upload everything that feels relevant and end up with a cluttered, unfocused Project where Claude has to wade through documents to find what it needs.
...
What not to include: confidential client records, anything containing TFNs or ABNs of specific clients, financial statements, documents that change frequently enough that Claude's version will be out of date within weeks (the latest super caps), and long strategic documents that contain only a small amount of information Claude actually needs. If a practice manual is 50 pages but only 5 pages are relevant to this Project, extract those 5 pages and upload that version.

Prepare your documents before uploading. Remove client names if they appear. Check that the document actually represents your current practice — don't upload an SOP from 2022 if your software stack has changed. Give each file a clear filename so you can tell at a glance what it contains.
...
**Test 1: Context check.** Ask Claude to summarise what it knows about you and this Project. You're checking that the custom instructions have been read and understood. The response should name your firm, describe the Project's purpose, and be able to list the key "always do" and "never do" instructions. If Claude gives you a generic response or seems to be missing key facts, your custom instructions need revision.

**Test 2: Task test.** Send a realistic task — the kind of thing you'll actually use this Project for. If it's a Client Communication Project, draft a message about a common scenario: a quarterly BAS reminder, a response to a fee query, a scope clarification. Review the output against your expectations. Does it match your tone? Does it apply the format defaults? Does it avoid the things you told it to avoid? This is where you catch the gaps in your instructions before they matter.

**Test 3: Constraint test.** Send a prompt that deliberately triggers one of your "never do" rules. If you told Claude never to include specific ATO rates, ask it to draft a super contributions explanation and see if it includes a rate. If you told it to flag dispute-related content, send a message that describes a client complaint and check that the flag appears. If your constraints are working, Claude should either comply with the rule or tell you why it can't. If it ignores the constraint entirely, rewrite that instruction to be more specific.

Once all three tests produce results that look right, your Project is ready. Use it for real.

### The maintenance cycle

A Claude Project is not a one-time setup. It's a working document that should evolve as your practice does.

You need to update your Project when any of the following happen: your services change, your terms change, your team structure changes (a new partner, a junior leaves), you find Claude consistently getting something wrong (that's a sign a rule is missing or unclear), or a worked example you uploaded is no longer representative of what you want.

The maintenance interval for most AU practices is every one to three months. Set a calendar reminder — perhaps tied to the start of each BAS quarter, or the start of each FY. Open your Project, read the custom instructions, and ask yourself: does this still describe how my practice works? Does the "never do" list still cover the risks I actually face? Are the knowledge documents still current?
