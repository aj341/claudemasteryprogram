...
Here's something that trips up a lot of consultants once they've been using Claude for a while. You've put in real effort to get Claude working well for your practice. You've written a good prompt, given it your context, taught it your tone. The response is exactly what you wanted for that client status update. You close the tab.

Next day, you open Claude and start a new conversation. Claude has no idea who you are. No memory of {{businessName}}, your active engagements, your preferences, the tone you spent three prompts calibrating. Every new conversation starts from scratch. You're back to the beginning.
...
The practical effect: every time you start a fresh conversation, you either paste in your practice context again, or you accept a more generic output. Most consultants do one of two things — they paste the same context block over and over, or they don't bother and get frustrated when Claude doesn't know what it should already know. Neither is a good solution.
...
Think of it as a standing brief. In a regular Claude conversation, you're briefing Claude fresh each time — like emailing a subcontractor with all the background every time you need a piece of work done. A Project is like giving that same subcontractor a proper onboarding document they can refer to whenever you work together. The brief is always there. The context is persistent.
...
```
You are a practice assistant for Northbridge Advisory, a 4-person
management consulting firm based in Brisbane. We work with mid-sized
AU/NZ businesses (15–80 staff) on operating model reviews, strategy
offsites, and post-merger integration. Engagements run 6–16 weeks.

My name is Sarah. I'm the principal and handle all client relationships,
scoping, and final deliverables.

Communication style: Direct, plain-spoken, never management-speak.
Australian English always (organise, programme, behaviour, recognise).

What I'll ask you about: scope of work drafts, status updates,
post-meeting recaps, fee proposals, deliverable structures, internal
team briefs, client emails.

What you should not do: Use Big-4 framing (no "workstream owner",
"practice leadership", "thought leadership"); don't write outputs as
if from a 200-person firm — we're a small practice; don't invent
client names or quote billable rates we haven't agreed.
```
...
**Knowledge documents** are files you upload into the Project. These can be a master engagement letter template, a fee schedule, a one-page brand voice guide, FAQs you've drafted for common client questions, example status updates, scopes of work, or anything else Claude should be able to reference. When you ask Claude a question inside the Project, it can draw on these documents. You don't need to paste them into every conversation. They're available.
...
**Conversation history** is the ongoing record of everything you've discussed inside the Project. Unlike regular conversations that disappear when you close the tab, conversations inside a Project accumulate. Claude can see what you've discussed before within the same Project. If you briefed it on a client's restructure last month, it still has that context this month — inside the same Project.

### The three types of Projects worth building

Most consultants get maximum value from three categories of Projects. You don't need to build all three on day one. But understanding the categories helps you decide where to start.

**The practice context Project.** This is your "always on" assistant. It holds your complete practice brief — firm name and overview, your role, your typical client mix, your communication style, your core service lines, and the tools you use. Any task that doesn't belong to a specific engagement or recurring workflow goes here. It's your general-purpose Claude, already configured for your practice. Most consultants build this one first, and it immediately makes every interaction faster.

**The client Project.** One Project per major active engagement. The custom instructions hold that client's background — their business, the engagement scope, their preferences, their history with the firm. Knowledge documents hold any relevant files: the signed scope of work, the discovery brief, notes from steering meetings. Over the course of an engagement, the conversation history builds up a record of what you've worked on. When you need to pick up a client task, you open their Project. Everything is there.

**The task Project.** For recurring work that follows a consistent pattern — a weekly client status update, a fortnightly internal team brief, a monthly LinkedIn post. The custom instructions define the format, the tone, and the constraints of that specific task. Knowledge documents hold any fixed content: the content pillars, the template, the voice rules. Each time you run the task, you're starting from a pre-configured environment. The Project doesn't just remember your practice — it remembers the specific requirements of this particular output.

You can build more than three. Some firms run a separate Project for each service line (strategy, operations, change), or keep a Project specifically for internal documents like staff onboarding or partner reviews. The category structure is a starting point, not a limit.
...
**Projects does not search the web.** When Claude works in a Project, it draws on its training data plus whatever you've put in the Project. It doesn't go out and look up current Fair Work changes or this morning's RBA announcement. If you need Claude to work with current data — today's news, live rates, updated industry stats — you need to paste that information into the conversation yourself. The Project holds what you've given it. It doesn't update itself.

**Projects does not update itself.** If your fee schedule changes, your service list changes, or your practice context shifts (a new associate, a rebrand), your Project custom instructions and documents stay the same until you change them. Claude will continue to reference outdated information if you don't update it. Set a reminder to review your Project documents whenever something meaningful changes — at minimum, every quarter.

**Projects does not replace a proper knowledge base for large volumes of information.** The knowledge document system works well for a practice of your size with a focused set of documents. If you're trying to load in hundreds of pages of past engagement decks across dozens of files and expect Claude to search and retrieve perfectly, you'll hit limits. Projects is not a search system. It reads documents you've uploaded, but it works best when those documents are concise, relevant, and well-organised. If your information needs are genuinely large and complex, a dedicated knowledge tool is a better fit.
...
**Better approach:** Curate the Project. Add documents that Claude will actually need to reference when doing the specific work you do in that Project. A client Project doesn't need your firm's full marketing collateral — it needs the signed scope of work and any agreed deliverables. A task Project for your weekly status update doesn't need your full practice business plan — it needs the standing format, the audience definition, and a few strong example updates. Relevance over volume. Claude reads documents, not just stores them. The more focused the documents are, the more usable the outputs.
