...
Next day, you open Claude and start a new conversation. Claude has no idea who you are. No memory of your product name, your customers, your preferences, the tone you spent three prompts calibrating. Every new conversation starts from scratch. You're back to the beginning.
...
The practical effect: every time you start a fresh conversation, you either paste in your business context again, or you accept a more generic output. Most founders do one of two things — they paste the same context block over and over, or they don't bother and get frustrated when Claude doesn't know what it should already know. Neither is a good solution.
...
**Custom instructions** are the most important. This is where you tell Claude: who it is for this Project, what business or product it's working in, what it should and shouldn't do, how it should communicate, and what assumptions it can make. Custom instructions live at the Project level. Every conversation you start inside the Project reads them. They're your standing brief.

Here's an example of custom instructions for a business context Project:

```
You are a SaaS assistant for Pacework, a Brisbane-based project-billing tool with 11 staff. Our customers are AU/NZ indie consultancies and 2–10 person agencies. We sell monthly subscriptions ranging from $19 to $99, with about 380 paying accounts on Stripe.

My name is Sarah. I'm the non-technical co-founder and handle marketing, customer success, and most outbound communications.

Communication style: Direct, warm, never corporate. We're an indie SaaS — write like one. Plain English, no "transform your business" filler.

What I'll ask you about: marketing copy, customer-success emails, support replies, release notes, churn-save outreach, and small social posts.

What you should not do: Assume we have a sales team, large budget, or enterprise-grade tooling. We use Stripe, Linear, Pipedrive, and Intercom. Keep recommendations practical and proportionate to our size.
```
...
**Knowledge documents** are files you upload into the Project. These can be feature lists, pricing tiers, brand guidelines, help-centre FAQs, security one-pagers, example emails, customer briefs, or anything else Claude should be able to reference. When you ask Claude a question inside the Project, it can draw on these documents. You don't need to paste them into every conversation. They're available.

Keep documents focused and up to date. A 20-page brand-and-voice guide works better than a single massive doc containing everything — Claude can reference the relevant parts more reliably when documents are separated by topic.

**Conversation history** is the ongoing record of everything you've discussed inside the Project. Unlike regular conversations that disappear when you close the tab, conversations inside a Project accumulate. Claude can see what you've discussed before within the same Project. If you briefed it on a customer situation last week, it still has that context this week — inside the same Project.

### The three types of Projects worth building

Most founders get maximum value from three categories of Projects. You don't need to build all three on day one. But understanding the categories helps you decide where to start.

**The business context Project.** This is your "always on" assistant. It holds your complete business brief — company name and overview, your role, your customers, your communication style, your core products or pricing tiers, and the tools you use. Any task that doesn't belong to a specific account or recurring workflow goes here. It's your general-purpose Claude, already configured for your SaaS. Most founders build this one first, and it immediately makes every interaction faster.

**The customer Project.** One Project per strategic account or annual contract. The custom instructions hold that customer's background — their business, their brief, their preferences, their history with you. Knowledge documents hold any relevant files: their security questionnaire, previous proposals, notes from QBRs. Over the course of the engagement, the conversation history builds up a record of what you've worked on. When you need to pick up a customer task, you open their Project. Everything is there.

**The task Project.** For recurring work that follows a consistent pattern — a fortnightly release note, a weekly customer-success digest, a monthly investor update. The custom instructions define the format, the tone, and the constraints of that specific task. Knowledge documents hold any fixed content: the format template, audience definition, the style rules. Each time you run the task, you're starting from a pre-configured environment. The Project doesn't just remember your product — it remembers the specific requirements of this particular output.

You can build more than three. Some founders run a separate Project for each pricing tier, or keep a Project specifically for internal documents like security policies or team handbooks. The category structure is a starting point, not a limit.
...
**Projects does not search the web.** When Claude works in a Project, it draws on its training data plus whatever you've put in the Project. It doesn't go out and look up current information. If you need Claude to work with current data — today's signups, live status-page incidents, updated industry stats — you need to paste that information into the conversation yourself. The Project holds what you've given it. It doesn't update itself.

**Projects does not update itself.** If your pricing changes, your feature list changes, or your customer ICP shifts, your Project custom instructions and documents stay the same until you change them. Claude will continue to reference outdated information if you don't update it. Set a reminder to review your Project documents whenever something meaningful changes in your product or business.

**Projects does not replace a proper knowledge base for large volumes of information.** The knowledge document system works well for a SaaS of your size with a focused set of documents. If you're trying to load in hundreds of pages across dozens of files and expect Claude to search and retrieve perfectly, you'll hit limits. Projects is not a search system. It reads documents you've uploaded, but it works best when those documents are concise, relevant, and well-organised. If your information needs are genuinely large and complex, a dedicated knowledge base tool is a better fit.
...
**Better approach:** Curate the Project, {{firstName}}. Add documents that Claude will actually need to reference when doing the specific work you do in that Project. A customer Project doesn't need your full company handbook — it needs the customer's contract and any agreed deliverables. A task Project for your fortnightly release note doesn't need your full product roadmap — it needs the format template, the audience definition, and a few strong example issues. Relevance over volume. Claude reads documents, not just stores them. The more focused the documents are, the more usable the outputs.
