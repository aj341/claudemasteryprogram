...
By this point in Module 4 you've built at least one working Project, {{firstName}}. You know how to set it up, populate a knowledge base, write instructions that hold, and maintain it as your practice work changes. That's a meaningful achievement. Most accountants who use Claude never get there.

But a single Project has a ceiling. It covers one domain of your work — one role Claude plays for you, one set of context and instructions. Your practice doesn't run in one domain. You have clients to serve, internal operations to manage, marketing and referral work to maintain, maybe a team to communicate with. One Project, configured for one of those domains, leaves the others back where you started: no persistent context, no tailored instructions, starting from scratch each conversation.

A Project System changes that. Not one Project — a small set of 2–3 Projects, each covering a different domain of your work, each configured precisely for that domain. Together they give Claude structured context across the parts of your practice that matter most. Separately, each one is specific enough to be genuinely useful rather than generic.

This lesson is about building that system. Not in theory. In your actual practice, this week.
...
Think about how your practice work actually divides. Most accountants and bookkeepers operate across three broad areas: client-facing work (BAS reminders, fee proposals, scope letters), internal operations (planning, fees, team), and growth or marketing (content for LinkedIn, referral partner outreach, positioning). Those three areas have different audiences, different tones, different context Claude needs to do useful work. One Project trying to cover all three produces instructions so broad they're almost useless.

A Project System gives each domain its own configuration. Your client-facing Project at {{businessName}} has your client communication tone, your service descriptions, your fee proposal structure. Your operations Project has your internal processes, your team norms, your fee context. Your marketing Project has your brand voice, your target audience (small AU SMBs), your content formats. When you open the right Project, Claude is already calibrated. You spend your time on the task, not on re-explaining who you are and what you need.

Two Projects is enough for many practices. Three is a practical ceiling for this stage. More than three, and the system starts to require maintenance overhead that eats the time you were trying to save. Start with two if you're unsure. You can always add a third once the first two are running well.
...
**Name** — Short and specific. Not "Work" or "Practice Claude" — something that tells you what it's for at a glance. "Client Comms," "Operations," "Marketing Content." The name is the first thing you see when you open Claude. Make it work for you.

**Purpose** — One or two sentences on what this Project handles. Not a list of every possible task — the core function. "All written communication with current clients: fee proposals, BAS reminders, scope change emails, and end-of-FY wrap-ups." That's a purpose. "Client stuff" is not.

**Knowledge base** — What you've uploaded or written into the Project's knowledge. The documents, the reference materials, the context Claude needs to do useful work here. Your architecture doesn't need to list every file — just the categories. "Our service menu, three fee-proposal examples, tone guide, and current client roster (anonymised)."
...
Written out, your architecture for a small AU practice might look like this:

```
Project: Client Comms
Purpose: All written communication with current and prospective clients.
Knowledge: Service descriptions, fee tiers, past fee-proposal examples, client tone guide.
When to use: Drafting fee proposals, BAS reminders, scope clarifications, quarterly check-ins.

Project: Operations
Purpose: Internal planning, team communication, and practice tracking.
Knowledge: Team roster, internal processes doc, weekly update format, fee/profitability context.
...
One more thing worth naming: the fact that you have a working Project System after Module 4 puts you ahead of the vast majority of Claude users — including plenty of accountants who have been using it far longer than you. Most practitioners use Claude in default conversations. They get useful outputs sometimes, inconsistent results often, and they never quite understand why. You now know why: no persistent context, no calibrated instructions, no architecture. A Project System solves all three. That's what you've built here. Everything in Module 5 is an extension of it.
