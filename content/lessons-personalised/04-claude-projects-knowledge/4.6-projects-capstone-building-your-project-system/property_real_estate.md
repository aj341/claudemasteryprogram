...
By this point in Module 4 you've built at least one working Project. You know how to set it up, populate a knowledge base, write instructions that hold, and maintain it as the agency's work changes. That's a meaningful achievement. Most agents who use Claude never get there.

But a single Project has a ceiling. It covers one domain of your work — one role Claude plays for you, one set of context and instructions. {{businessName}} doesn't run in one domain. You have vendors and buyers to manage, a rent roll to look after, a team to communicate with, prospecting and marketing to maintain. One Project, configured for one of those domains, leaves the others back where you started: no persistent context, no tailored instructions, starting from scratch each conversation.

A Project System changes that. Not one Project — a small set of 2–3 Projects, each covering a different domain of the agency, each configured precisely for that domain. Together they give Claude structured context across the parts of the agency that matter most. Separately, each one is specific enough to be genuinely useful rather than generic.

This lesson is about building that system. Not in theory. In your actual agency, this week.
...
Here's what makes it a system rather than a collection: the Projects don't overlap. Each one has a clear answer to the question "what is this Project for?" If {{firstName}} has to think for more than five seconds about which Project to open for a given task, the system needs clarifying. The right Project should be obvious.

Think about how the agency's work actually divides. Most independent agencies operate across three broad areas: sales-side work (vendor communications, listing copy, CMAs, campaign management), property management (lease renewals, owner reports, tenant correspondence, inspection follow-ups), and growth or marketing (prospecting letters, area newsletters, social content). Those three areas have different audiences, different tones, different context Claude needs to do useful work. One Project trying to cover all three produces instructions so broad they're almost useless.

A Project System gives each domain its own configuration. Your sales-side Project has your vendor communication tone, your listing inclusions, your campaign templates. Your property management Project has your lease pack, your owner-report format, your tenancy-law guardrails. Your marketing Project has your brand voice, your target sellers, your prospecting copy patterns. When you open the right Project, Claude is already calibrated. You spend your time on the task — the vendor update, the lease renewal, the prospecting letter — not on re-explaining who the agency is.

Two Projects is enough for many agencies. Three is a practical ceiling for this stage. More than three, and the system starts to require maintenance overhead that eats the time you were trying to save. Start with two if you're unsure. You can always add a third once the first two are running well.
...
**Name** — Short and specific. Not "Work" or "Agency Claude" — something that tells you what it's for at a glance. "Vendor Comms," "PM Operations," "Marketing." The name is the first thing you see when you open Claude. Make it work for you.

**Purpose** — One or two sentences on what this Project handles. Not a list of every possible task — the core function. "All written communication with current and prospective vendors: listing presentations, campaign updates, recommended-adjustment letters, and end-of-campaign wrap-ups." That's a purpose. "Sales stuff" is not.

**Knowledge base** — What you've uploaded or written into the Project's knowledge. The documents, the reference materials, the context Claude needs to do useful work here. Your architecture doesn't need to list every file — just the categories. "Our service inclusions, three sample listing presentations, tone guide, and current vendor list."
...
Written out, the architecture for an agency might look like this:

```
Project: Vendor Comms
Purpose: All written communication with current and prospective vendors.
Knowledge: Service inclusions, fee schedule, past listing presentations,
           sample vendor updates, agency tone guide.
When to use: Listing presentations, campaign updates, recommended-adjustment
             letters, vendor questions during a campaign.

Project: PM Operations
Purpose: Property management correspondence and rent roll workflows.
Knowledge: Lease pack, owner report template, routine inspection format,
           management fee structure, supplier list.
When to use: Lease renewals, monthly owner reports, tenant correspondence,
             arrears and maintenance follow-up.
```
...
Your architecture document doesn't need to be elaborate. A table in Notion, a note in your CRM, even a sticky note on your monitor — whatever you'll actually refer to. The format is irrelevant. The discipline of writing it out is what matters. It forces the clarity that makes the system work.

### Beat 3 — From Project builder to Project maintainer

Building a Project System is one job. Maintaining it is a different, ongoing job. Most principals do the first and neglect the second. The system slowly drifts out of alignment with the agency's actual work, and six months later it's no longer useful.

The maintenance job is not hard. It requires three habits, each of which takes about five minutes when you do it.

**Habit 1: Quarterly knowledge audit.** Every three months, open each Project and read through what's in the knowledge base. Ask: is this still accurate? Has anything in the agency changed that this document doesn't reflect? Service inclusions change, fees change, team members come and go, the rent roll grows. If the knowledge base still describes the agency you ran six months ago — when you were charging 2.5% and not yet running auctions — it's giving Claude the wrong foundation. Update the documents, remove what's stale, add what's new.

**Habit 2: Instruction check when something goes wrong.** When Claude produces an output that's off — wrong tone for a vendor, wrong structure for an owner report, wrong level of detail in a CMA — don't just send a correction. Read the Project instructions and ask why the instruction didn't prevent the problem. Usually either the instruction is missing that specific case, or it exists but is too vague to be actionable. Fix the instruction, not just the output. This is how instructions improve over time rather than accumulating workarounds.

**Habit 3: Semi-annual architecture review.** Every six months, look at your Project architecture as a whole. Has the agency changed enough that the domains don't carve up the same way anymore? Did you add buyer's-agent work that doesn't fit neatly into the Projects you have? Did one Project become so dominant that it's doing work two different Projects should be doing? This review is the moment to restructure — not because restructuring is always necessary, but because catching a misalignment early prevents months of friction.

**Common mistake → Better approach**

Mistake: Treating the Project setup as a one-time task. You spend an afternoon building two well-configured Projects, then leave them untouched for a year while the agency changes around them. The knowledge base describes services you no longer offer. The instructions don't account for the new strata management arm you launched in October. The outputs drift in quality and you can't work out why — you start reverting to general Claude conversations instead.

Better approach: Add the quarterly knowledge audit to your calendar as a recurring event. 20 minutes, once a quarter, for each Project. Open the knowledge base documents, scan for what's outdated, update or replace. Then open the instructions and confirm they still describe how you actually want Claude to behave. This is maintenance, not rework. It keeps the system aligned with an agency that is always changing.
...
One more thing worth naming: the fact that you have a working Project System after Module 4 puts you ahead of the vast majority of agencies using Claude — including plenty who have been using it far longer than you. Most use Claude in default conversations. They get useful outputs sometimes, inconsistent results often, and they never quite understand why. You now know why: no persistent context, no calibrated instructions, no architecture. A Project System solves all three. That's what you've built here. Everything in Module 5 is an extension of it.
