...
**Better approach:** Write a separate Claude-facing version of that document. Keep it short, plain, and specific. Write it the way you'd brief a smart new team member on their first day — factual, direct, structured. "We are a four-tutor maths and English service in Hobart. We work exclusively with Year 5 to Year 12 students. Our families are typically professional households with 1–3 kids. We use Cliniko for bookings. We do not do exam invigilation — we refer those families to Eduplus Assessments. Our standard turnaround for end-of-term reports is five business days." That briefing is more useful to Claude than a six-page brochure.
