...
**Business context.** This is who you are, how you operate, and what makes {{businessName}} distinct. It answers the background questions Claude would otherwise ask or guess at. Your business name, location, what trades you cover, who your customers are, how you communicate, what you don't do. The tone document from Lesson 1.5 belongs here. So does a one-page "about us" written for Claude — not for customers, but as a plain-English briefing on your business that a new apprentice would need on day one.

Business context documents don't change often. Once they're written and in the Project, they're mostly stable. You'll update them when something material changes — a new trade added, a different customer base, a rebrand — but you're not touching them weekly.

**Process knowledge.** This covers how you do things. Your quoting process. How you handle a defect callback. The steps you follow when onboarding a new homeowner. How you structure a variation. What happens after a job's signed off. These documents exist so Claude understands your workflow and can help you at each stage of it — not just generate generic output, but output that fits how {{businessName}} actually operates.
...
**Client and project knowledge.** This is the context specific to a current job — a homeowner brief, a head contractor's scope, notes from a site walk, a builder's brand guide for hoarding signage, the agreed deliverables for a contract you're delivering right now. This category is different from the other two: it changes with every new job and isn't useful once the job is done.

Most tradies have one Project per active major job, and the client/project knowledge documents in that Project are specific to that work. When the job ends and defects liability is closed out, the Project is archived. The business context and process documents stay in your main Projects; the job-specific material goes with the job's Project.

Keep these three categories distinct. If you find yourself wondering where a document belongs, ask: does this describe my business permanently, does it describe how I do something, or does it describe a specific current job? That question usually resolves it.
...
**Structured PDF** (text-based, not scanned) works well when the document is logically formatted. A quote template or a rate card in a clean PDF is fine. Claude can read it accurately if the text is selectable — i.e., not a scan or an image of a document.

**Image-based PDFs and photos of documents** are the least reliable. Claude can read them using vision, but accuracy drops when the layout is complex, when there's a lot of small text, or when the image quality is low. If an important document only exists as a scanned PDF or a photo from your phone on site, transcribe the relevant parts into plain text before adding it to a Project.
...
A homeowner-facing brochure written to win quotes is not a useful knowledge document for Claude. It's written in marketing language, it omits operational detail, it prioritises persuasion over accuracy, and it buries the information Claude actually needs (what you do, for whom, at what rate, with what constraints) inside copy designed for a different purpose.

**Better approach:** Write a separate Claude-facing version of that document. Keep it short, plain, and specific. Write it the way you'd brief a new apprentice on their first day — factual, direct, structured. "We are a four-person residential plumbing business in Hobart. We work on existing homes only — no new builds. Our customers are typically homeowners 35–65. We use Tradify and Xero. We do not do gas — we refer those jobs to our partner gasfitter, Hobart Gas Co. Our standard turnaround for a quote after a site visit is two business days." That briefing is more useful to Claude than a six-page marketing brochure.

### The update problem

Knowledge documents go stale. This is the most common reason a Project that worked well three months ago is producing weaker output now. The business changed. The rate card changed. A new service was added. A long job finished. The knowledge documents didn't change with them, and now Claude is working from an outdated picture of {{businessName}}.
