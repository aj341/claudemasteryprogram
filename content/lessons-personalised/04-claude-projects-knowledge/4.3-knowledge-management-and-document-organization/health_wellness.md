...
**Better approach:** Write a separate Claude-facing version of that document. Keep it short, plain, and specific. Write it the way you'd brief a smart new team member on their first day — factual, direct, structured. "We are a four-clinician physiotherapy practice in Hobart called {{businessName}}. We work mainly with adults 35–70 with persistent musculoskeletal pain. Our clients are typically self-funded or referred under EPC plans. We use Cliniko. We do not provide medical-grade dry needling for jaw or face — we refer those to our colleague at South Hobart Sports Medicine. Our standard turnaround for treatment-plan summaries is two business days." That briefing is more useful to Claude than a six-page brochure.
