...
Session fill rate: 87% (target: 85%, up from 83% in March)
Workbook and resource sales: $2,100 (target: $3,500 — second month below target)
...
the workbook underperformance and connect it to the tutor incentive plan
starting in May.
```
