...
A practical naming habit helps here. Give each conversation a clear title as soon as you start it. Most Claude interfaces let you rename conversations. "Baker Street Logistics — corporate-wellness quote August" is easier to find and continue than "New conversation 14." Ten seconds of naming saves five minutes of scrolling.
...
```
I'm continuing work on the Northside Logistics corporate-wellness agreement.
We've agreed on: 12-month term, monthly billing, 30-day termination notice.
Still to complete: the scope of services section and the payment terms clause.
Please draft the scope of services section next, using {{businessName}}'s standard
on-site assessment-day descriptions from the Project knowledge.
```
...
**From your practice software to Claude and back.** Copy a client record or a set of intake notes from Cliniko, paste into Claude ("Based on these intake notes, draft a follow-up email and a list of three next actions"). Take Claude's follow-up email and paste it into your email. Take the three next actions and paste them into your CRM or task manager. The Project's client communications context does the heavy lifting. Your copy-paste moves the information between systems.
