...
That is the core value of a shared Project. Not convenience. Not fewer logins. It's the fact that when your admin opens the Parent Communications Project, they're working with the same context as when you open it. Claude knows your tutor list, your term dates, your standard fees, the way you phrase things to families. You don't have to brief Claude separately for each person. The Project does the briefing for everyone who has access.
...
If you're writing an enrolment proposal, you need Claude to know your fee card, your program inclusions, and your standard terms. That points to a Proposals or Enrolment Project.
