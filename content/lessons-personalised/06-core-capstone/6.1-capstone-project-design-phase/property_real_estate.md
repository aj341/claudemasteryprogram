...
Module 6 is different. {{firstName}}, you decide what you work on.

The capstone is a four-part project, spread across Lessons 6.1 through 6.4. You pick one real challenge inside {{businessName}} and build a complete Claude-assisted solution for it. Not a lesson exercise — an actual piece of work that matters to your agency, your rent roll, or your buyer's agent practice. This lesson, 6.1, is the design phase. You map the problem, define the solution approach, name the tools you will use, and plan the implementation before touching Claude.
...
Most students arrive at Lesson 6.1 with one of two problems. The first is choosing something too vague: "I want to improve my vendor communications" or "I want to use Claude more across the agency." These are directions, not challenges. You cannot build a solution for a direction. You cannot measure whether it worked.

The second is choosing something too large: "I want to automate my entire new tenancy onboarding" or "I want Claude to handle every weekly campaign report and every owner statement." These are projects that would take months with a team. A capstone that cannot be completed in the time you have is a capstone that will fail.

The right challenge sits in a specific middle ground. It is concrete enough to describe in two or three sentences. It is significant enough that solving it produces a real result for the business — not a nice-to-have, but a genuine improvement in time, quality, or consistency. And it is achievable with the Foundation tier toolkit: prompts, Projects, and extended capabilities. No APIs, no external automations, no developer dependencies.

Here is the test to apply to any challenge you are considering. Answer all three:

**Is it specific?** Can you name exactly what is broken or slow or inconsistent? Not "my post-OFI follow-up is inefficient" but "after every Saturday open home I spend 90 minutes writing personalised vendor updates and buyer follow-up emails — across three active campaigns that is nearly five hours every weekend." The second version names the task, the time cost, the frequency, and the friction point. That is specific.

**Is it significant?** Would solving this make a real difference — in time saved, quality improved, or consistency increased? A challenge that saves five minutes once a month is not worth a four-lesson capstone. A challenge that saves two hours a week, or removes a task you have been avoiding, or produces a consistently sharper monthly owner report — that is worth the work.

**Is it achievable with your current toolkit?** The Foundation tier is prompts, Projects, file processing, and vision. If your solution requires the Claude API, third-party automation, or a developer to wire it into your CRM or trust account software, it is outside scope for this capstone. That does not mean those things are impossible — it means they belong in a future project, after this course. Keep the scope inside what you have built.
...
- Vendor campaign report drafting time reduced from 60 minutes to under 20 minutes
- Post-OFI buyer follow-up emails score 4 out of 5 or higher in a self-review against the checklist I defined
- All monthly owner reports produced with a consistent structure — arrears, maintenance, lease status, market commentary — zero missing sections — across an entire month of statements

Poor success criteria:
- Vendors are happier (not measurable without a survey or system)
- Claude produces better listing copy (compared to what, measured how?)
...
More importantly, the capability map should explain the logic. Not "I will use a Project from Module 4" but "I will use a Project from Module 4 to hold the agency style guide, our preferred suburb descriptors, and the standard listing-copy structure that Claude needs to reference for every new listing — without it, I would have to re-paste this context each time a new property goes to market." The capability is justified by the problem, not just listed.
...
Use: Upload listing documents

GOOD ENTRY:
Capability: File uploads — Module 5, Lesson 5.2
Use: Upload the vendor's signed agency agreement, the building and pest
report, and any strata documents at the start of each new listing
session. Claude reads them and extracts the facts I need (land size,
strata levy, special by-laws, recent inclusions) before I write the
listing copy prompt. This replaces the manual reading and note-taking
step that currently takes 20-30 minutes per listing.
```
...
Step 1: Create a Project for listings
Step 2: Add prompts
Step 3: Test with a real listing
Step 4: Refine

SPECIFIC PLAN (aim for this):
Step 1: Create a Listing Copy Project in Claude. Upload the agency
  style guide, three of our strongest listing descriptions from the
  past quarter, and a one-page suburb profile for our two core
  postcodes. Write the Project instructions to define Claude's role
  as a listing copywriter who knows our private treaty tone and
  standard structure. (~15 mins)

Step 2: Write the property-fact extraction prompt — the prompt I
  will use to pull verified facts from the agency agreement,
  contract of sale, and strata report at the start of each new
  listing session. (~20 mins)

Step 3: Write the listing-copy drafting prompt — the prompt that
  takes the extracted facts plus the campaign brief and produces
  a portal-ready listing description in our standard structure. (~20 mins)

Step 4: Run the full workflow on a real listing going to market
  this week. Document what works and what needs adjustment. (~30 mins)
...
The strongest capstone projects in this course share one characteristic: specificity from the start. The students who produce the sharpest 6.3 evaluations are the ones who wrote the sharpest design documents in 6.1. The challenge is named precisely. The success criteria are measurable. The capability map explains why, not just what. The implementation plan is specific enough to follow.
