...
For example: if your criterion was "reduce first-draft time for parent update emails from 25 minutes to under 10," you can time yourself. Do it three times. Average the result. That's a measurement.
...
**Better approach:** "Criterion: reduce drafting time for end-of-term progress reports from 90 minutes to under 30 minutes per student. Actual result: 45 minutes average across 4 students (timing confirmed). Criterion partially met — 50% reduction achieved, not the 67% targeted. The remaining time is spent reviewing and adjusting Claude's structure, which I hadn't accounted for in the original design."
