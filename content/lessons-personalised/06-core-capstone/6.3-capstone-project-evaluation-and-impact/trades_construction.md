...
You designed something in 6.1, {{firstName}}. You built it in 6.2. Now comes the part most people skip.
...
Here's the distinction worth carrying forward: there is a difference between someone who uses Claude well and someone who uses Claude a lot. Frequency is easy to measure. Effectiveness is harder. The tradies who get the most from this kind of tool are not the ones who open it most often — they're the ones who ask "did that actually save me time on the tools or in the office?" and stay honest about the answer.
...
This is the most important step, and it's also the one most people skip. The temptation is to evaluate the solution you built against how you feel about it now. That's not evaluation — that's making excuses for it. Real evaluation goes back to the criteria you wrote before you built anything, when your expectations hadn't been shaped by the experience of building.
...
If you wrote "save at least 30 minutes per week on quote follow-ups," then the evaluation question is: did you save at least 30 minutes per week on quote follow-ups? Not "did it help with follow-ups?" or "did it seem faster?" The specific criterion you set is the one you measure against.

This constraint is intentional. It teaches something important about working with AI tools: the criteria you set before you build are more reliable than the criteria you construct afterwards to fit what you got. Talking yourself into it after the fact is how people convince themselves that a mediocre result was actually fine, and it's also how they miss the signal that tells them what to fix.

### How to measure — quantitative and qualitative

Some of your success criteria will be countable. Time saved. Emails sent. Documents processed. Quotes drafted. If a criterion names a number, the measurement method is straightforward: count the thing before the solution, count it after, and compare. Even an approximate count is more useful than a description.

For example: if your criterion was "reduce first-draft time for end-of-job wrap-ups from 25 minutes to under 10," you can time yourself. Do it three times. Average the result. That's a measurement.

Other criteria won't be countable. "Better quality" is real, but you can't weigh it. "Less stressful at the end of the day" is real, but there's no unit. These qualitative outcomes need a different approach — not a count, but a specific observation that gives a reader enough information to judge whether the outcome occurred.
...
Most real builds work partially. Not completely. Not at all badly — just not at the level the designer hoped for when they were planning.
...
Second, look for the reason behind the gap. If you wrote "reduce homeowner query response time to under two hours" and you actually got it to four hours, the evaluation isn't "partially met — aim was ambitious." The evaluation is "criterion partially met — response time reduced from 6 hours to 4 hours (33% improvement), but still above the 2-hour target. The bottleneck turned out to be [specific issue], not the drafting step I'd targeted." That tells you something useful. The vague version tells you nothing.
...
Two or three specific observations, each grounded in something that actually happened. Not "Claude was really helpful with the tone" — that's a feeling, not an observation. Instead: "The system prompt instruction to match the tone of our existing homeowner emails worked well. Every draft came back in the right register without manual editing — in previous attempts without that instruction, I was rewriting about 40% of the output."
...
Specificity in this section does two things. It gives you something to act on — vague observations produce vague improvements. And it demonstrates to the grading engine that you actually ran the solution on real jobs, not just tested it once and extrapolated.

### Will you actually keep using this?

The sustainability question is the one most evaluation frameworks ignore. They ask whether the solution worked. They don't ask whether it will keep working — or whether it will quietly get abandoned in three weeks when {{businessName}} is flat out on a busy run of jobs.
...
A concrete sustainability plan sounds like this: "Every Monday morning when I open ServiceM8 to plan the week, I'll run the weekly homeowner update prompt before doing anything else — it takes four minutes and produces the draft I used to spend 30 minutes on after dinner." The trigger is Monday morning ServiceM8. The action is specific. The time cost is known.
