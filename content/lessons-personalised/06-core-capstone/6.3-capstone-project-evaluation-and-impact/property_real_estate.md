...
Here's the distinction worth carrying forward, {{firstName}}: there is a difference between someone who uses Claude well and someone who uses Claude a lot. Frequency is easy to measure. Effectiveness is harder. The agents and property managers who get the most from this kind of tool are not the ones who open it most often — they're the ones who ask "did that actually shorten my campaign reporting?" and stay honest about the answer.
...
If you wrote "save at least 30 minutes per week on post-OFI vendor updates," then the evaluation question is: did you save at least 30 minutes per week on post-OFI vendor updates? Not "did it help with the campaign?" or "did it seem faster?" The specific criterion you set is the one you measure against.
...
Some of your success criteria will be countable. Time saved on weekly reporting. Vendor updates sent. Listing descriptions drafted. Owner statements generated. If a criterion names a number, the measurement method is straightforward: count the thing before the solution, count it after, and compare. Even an approximate count is more useful than a description.

For example: if your criterion was "reduce first-draft time for listing descriptions from 25 minutes to under 10," you can time yourself. Do it three times — three real listings going to market this week. Average the result. That's a measurement.

Other criteria won't be countable. "Better quality vendor communication" is real, but you can't weigh it. "Less stressful Saturday afternoons" is real, but there's no unit. These qualitative outcomes need a different approach — not a count, but a specific observation that gives a reader enough information to judge whether the outcome occurred.
...
e.g. weekly campaign reporting]. Before I built the solution, the
problem looked like this: [describe the before state in detail —
how long it took, what got skipped, what vendors complained about].
After using the solution for [time period, e.g. three weeks across
four active campaigns], here's what I observed: [describe the after
state in detail]. Help me identify whether this constitutes a
meaningful improvement, and what evidence I should cite in my
evaluation report.
```

The goal is specificity, not certainty. You don't need to prove a causal link between your solution and the outcome. You need to describe what you observed with enough detail that another agent or principal could assess it independently.
...
Second, look for the reason behind the gap. If you wrote "reduce vendor query response time to under two hours" and you actually got it to four hours, the evaluation isn't "partially met — aim was ambitious." The evaluation is "criterion partially met — response time reduced from six hours to four hours (33% improvement), but still above the two-hour target. The bottleneck turned out to be waiting on the conveyancer's confirmation of the exchange date, not the drafting step I'd optimised." That tells you something useful. The vague version tells you nothing.
...
**Common mistake:** Writing "the solution was helpful and I think it improved my reporting workflow overall."

**Better approach:** "Criterion: reduce drafting time for weekly campaign reports from 90 minutes to under 30 minutes. Actual result: 45 minutes average across four campaigns over three weeks at {{businessName}} (timing confirmed). Criterion partially met — 50% reduction achieved, not the 67% targeted. The remaining time is spent reviewing and adjusting the buyer-feedback section, which I hadn't accounted for in the original design — Claude needs more raw OFI notes than I was capturing on the day."
...
Two or three specific observations, each grounded in something that actually happened. Not "Claude was really helpful with the tone" — that's a feeling, not an observation. Instead: "The Project instruction to match the tone of our vendor letters worked well. Every campaign update came back at the right register — warm but factual — without manual editing. In previous attempts without that instruction, I was rewriting about 40% of the output, mostly stripping out portal-style adjectives like 'stunning' and 'must inspect'."

The same specificity applies to what didn't work. Not "it was a bit slow to set up" but "the initial setup of the Claude Project knowledge base took three hours, not the one hour I'd estimated, because I had to rewrite our standard owner statement template — the existing version was three years old and still referenced the old water-usage charging arrangement."

Specificity in this section does two things. It gives you something to act on — vague observations produce vague improvements. And it demonstrates to the grading engine that you actually ran the solution in real conditions, on real campaigns or real owner statements, not just tested it once and extrapolated.

### Will you actually keep using this?

The sustainability question is the one most evaluation frameworks ignore. They ask whether the solution worked. They don't ask whether it will keep working — or whether it will quietly get abandoned in three weeks when the next listing surge hits and you fall back to old habits.

Be honest with yourself here. A solution that requires significant ongoing effort to maintain tends not to survive contact with a busy listing week or end-of-month rent roll reconciliation. A solution built into a trigger — something that already happens on a regular schedule — tends to stick.
...
A concrete sustainability plan sounds like this: "Every Monday morning when I sit down to write the weekly campaign updates, I'll run the vendor-update prompt in the Claude Project before opening my CRM. It takes four minutes per campaign and produces the draft I used to spend 25 minutes on." The trigger is Monday morning campaign-update writing. The action is specific. The time cost is known.

Or: "This solution lives in a pinned Claude Project on my desktop, so it's the first thing I see when I open Claude. I don't need to remember it — I just need to keep the Project pinned and actually open Claude instead of starting a fresh chat from a generic ChatGPT tab."
...
Collect your evidence before you write. If you can get actual numbers, get them first. Time yourself drafting one report. Count the OFI follow-ups you got out the door this week. Screenshot a before-and-after listing description if it helps. Qualitative observations are legitimate measurement, but they should describe something specific you observed — not a general impression formed at the end.
