...
{{firstName}}, you designed something in 6.1 for {{businessName}}. You built it in 6.2. Now comes the part most people skip.
...
A concrete sustainability plan sounds like this: "Every Monday morning when I open {{businessName}}'s inbox to plan the week, I'll run the weekly referrer-update prompt before doing anything else — it takes four minutes and produces the draft I used to spend 30 minutes on." The trigger is Monday morning email. The action is specific. The time cost is known.
