...
You designed something in 6.1. You built it in 6.2. Now comes the part most retailers skip.
...
Here's the distinction worth carrying forward, {{firstName}}: there is a difference between someone who uses Claude well and someone who uses Claude a lot. Frequency is easy to measure. Effectiveness is harder. The retailers who get the most from this kind of tool are not the ones who open it most often — they're the ones who ask "did that actually work?" and stay honest about the answer.
...
This is the most important step, and it's also the one most retailers skip. The temptation is to evaluate the solution you built against how you feel about it now. That's not evaluation — that's rationalisation. Real evaluation goes back to the criteria you wrote before you built anything, when your expectations hadn't been shaped by the experience of building.
...
If you wrote "save at least 30 minutes per week on customer-service drafting," then the evaluation question is: did you save at least 30 minutes per week on customer-service drafting? Not "did it help with customer service?" or "did it seem faster?" The specific criterion you set is the one you measure against.

This constraint is intentional. It teaches something important about working with AI tools at {{businessName}}: the criteria you set before you build are more reliable than the criteria you construct afterwards to fit what you got. Post-hoc rationalisation is how retailers convince themselves that a mediocre result was actually fine, and it's also how they miss the signal that tells them what to fix.

### How to measure — quantitative and qualitative

Some of your success criteria will be countable. Time saved. Customer tickets handled. Product descriptions drafted. Restock alerts sent. If a criterion names a number, the measurement method is straightforward: count the thing before the solution, count it after, and compare. Even an approximate count is more useful than a description.

For example: if your criterion was "reduce first-draft time for restock-alert emails from 25 minutes to under 10," you can time yourself. Do it three times. Average the result. That's a measurement.

Other criteria won't be countable. "Better quality" is real, but you can't weigh it. "Less stressful at peak" is real, but there's no unit. These qualitative outcomes need a different approach — not a count, but a specific observation that gives a reader enough information to judge whether the outcome occurred.
...
The goal is specificity, not certainty. You don't need to prove a causal link between your solution and the outcome. You need to describe what you observed with enough detail that another retailer could assess it independently.
...
Second, look for the reason behind the gap. If you wrote "reduce customer-service reply time to under two hours" and you actually got it to four hours, the evaluation isn't "partially met — aim was ambitious." The evaluation is "criterion partially met — reply time reduced from 6 hours to 4 hours (33% improvement), but still above the 2-hour target. The bottleneck turned out to be the freight-tracking lookup step (we still chase Sendle manually for ETA confirmation), not the drafting step I'd optimised." That tells you something useful. The vague version tells you nothing.
...
Two or three specific observations, each grounded in something that actually happened. Not "Claude was really helpful with the brand voice" — that's a feeling, not an observation. Instead: "The system prompt instruction to match the warm-but-direct tone of our existing customer-service replies worked well. Every draft came back in the right register without manual editing — in previous attempts without that instruction, I was rewriting about 40% of the output."

The same specificity applies to what didn't work. Not "it was a bit slow to set up" but "the initial setup of the Claude Project knowledge base took three hours, not the one hour I'd estimated, because I had to reformat my returns policy and shipping FAQ before uploading them — they were in marketing-style PDFs not Claude-readable structure."
...
The sustainability question is the one most evaluation frameworks ignore. They ask whether the solution worked. They don't ask whether it will keep working — or whether it will quietly get abandoned in three weeks when the novelty wears off and the next campaign launch eats your attention.

Be honest with yourself here. A solution that requires significant ongoing effort to maintain tends not to survive contact with a busy trading week. A solution built into a trigger — something that already happens on a regular schedule — tends to stick.
...
A concrete sustainability plan sounds like this: "Every Monday morning when I open the customer-service inbox to clear weekend tickets, I'll run the CS reply prompt before doing anything else — it takes four minutes and produces the drafts I used to spend 30 minutes on." The trigger is Monday morning inbox clearance. The action is specific. The time cost is known.

Or: "This solution lives in a pinned Claude Project, so it's the first thing I see when I open Claude. I don't need to remember it — I just need to keep the Project pinned and actually open Claude instead of starting from scratch in Gmail."
