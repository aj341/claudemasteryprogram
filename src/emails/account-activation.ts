...
export function accountActivationHtml({ firstName, activationUrl, cohortStartDate = "1 June 2026" }: AccountActivationProps): string {
  const inner = `
    ...
    ${p("Your enrolment in Claude Mastery Core is confirmed.")}
    ...
    <ul style="margin:0;padding-left:20px;color:#374151;font-size:14px;line-height:1.7;font-family:&lsquo;Poppins&lsquo;,sans-serif;">
      <li>34 lessons across 6 modules &mdash; released weekly through the course</li>
      ...
      <li>One chance to repeat the course if you don&lsquo;t pass the capstone</li>
    </ul>
...
Your enrolment in Claude Mastery Core is confirmed.
...
- One chance to repeat the course if you don't pass the capstone
